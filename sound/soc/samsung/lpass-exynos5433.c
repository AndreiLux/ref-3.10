/* sound/soc/samsung/lpass-exynos5433.c
 *
...
{
	writel(0x00003FFD, EXYNOS5430_ENABLE_PCLK_AUD);
	writel(0x00000007, EXYNOS5430_ENABLE_SCLK_AUD0);
	writel(0x0000007F, EXYNOS5430_ENABLE_SCLK_AUD1);
	writel(0x0003FFFF, EXYNOS5430_ENABLE_IP_AUD0);
	writel(0x000003FF, EXYNOS5430_ENABLE_IP_AUD1);
}
