...
struct rt5671_priv {
	...
	int alc_drc_mode;
	int aif3_srate;
	int dsp_dev_param; /* recognize same dsp type with 1mic, 2mic device */
	int dsp_depoping_in_dsp;
	...
	bool dac2_playback_mute_l;
	bool dac2_playback_mute_r;
	int suspend;
