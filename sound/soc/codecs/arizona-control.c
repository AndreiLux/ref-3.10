...
#define MIXER(s, r, n)						\
	_ctl( s "_input"#n"_source", CTL_INERT,			\
	 ARIZONA_##r##_INPUT_##n##_SOURCE, 0xff, 0, __simple), 	\
	_ctl( s "_input"#n"_volume", CTL_INERT, 		\
	 ARIZONA_##r##_INPUT_##n##_VOLUME, 0xff, 0, __simple)
