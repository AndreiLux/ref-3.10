                                     ...
                                     struct snd_pcm_hw_params *hw_params)
{
    ...
    printk("mtk_io2_awb_pcm_hw_params dma_bytes = %d dma_area = %p dma_addr = 0x%x\n",
...
static u64 io2_awb_pcm_dmamask = DMA_BIT_MASK(32);
...
static int mtk_asoc_io2_awb_pcm_new(struct snd_soc_pcm_runtime *rtd)
{
    ...
    {
        card->dev->dma_mask = &io2_awb_pcm_dmamask;
    }
