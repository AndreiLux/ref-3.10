                                     ...
                                     struct snd_pcm_hw_params *hw_params)
{
    ...
    printk("mtk_adc2_adci2s2_pcm_hw_params dma_bytes = %d dma_area = %p dma_addr = 0x%x\n",
                                ...
                                void __user *dst, snd_pcm_uframes_t count)
{
    ...
    if (DMA_Read_Ptr + read_size < Vul_Block->u4BufferSize)
    {
        ...
        {
            printk("mtk_adc2_adci2s2_pcm_copy 1, read_size:%x, DataRemained:%x, DMA_Read_Ptr:0x%x, DMAReadIdx:%x \r\n",
        ...
        if (copy_to_user((void __user *)Read_Data_Ptr, (Vul_Block->pucVirtBufAddr + DMA_Read_Ptr), read_size))
        {
            ...
            printk("mtk_adc2_adci2s2_pcm_copy Fail 1 copy to user Read_Data_Ptr:%p, pucVirtBufAddr:%p, u4DMAReadIdx:0x%x, DMA_Read_Ptr:0x%x,read_size:%x", Read_Data_Ptr, Vul_Block->pucVirtBufAddr, Vul_Block->u4DMAReadIdx, DMA_Read_Ptr, read_size);
            return 0;
        }
    ...
    else
    {
        ...
        if (DMA_Read_Ptr != Vul_Block->u4DMAReadIdx)
        {
            ...
            printk("mtk_adc2_adci2s2_pcm_copy 2, read_size1:%x, DataRemained:%x, DMA_Read_Ptr:0x%x, DMAReadIdx:%x \r\n",
        ...
        if (copy_to_user((void __user *)Read_Data_Ptr, (Vul_Block->pucVirtBufAddr + DMA_Read_Ptr), size_1))
        {
            ...
            printk("mtk_adc2_adci2s2_pcm_copy Fail 2 copy to user Read_Data_Ptr:%p, pucVirtBufAddr:%p, u4DMAReadIdx:0x%x, DMA_Read_Ptr:0x%x,read_size:%x",
        ...
        if (DMA_Read_Ptr != Vul_Block->u4DMAReadIdx)
        {
            ...
            printk("mtk_adc2_adci2s2_pcm_copy 3, read_size2:%x, DataRemained:%x, DMA_Read_Ptr:0x%x, DMAReadIdx:%x \r\n",
        ...
        if (copy_to_user((void __user *)(Read_Data_Ptr + size_1), (Vul_Block->pucVirtBufAddr + DMA_Read_Ptr), size_2))
        {
            ...
            printk("mtk_adc2_adci2s2_pcm_copy Fail 3 copy to user Read_Data_Ptr:%p, pucVirtBufAddr:%p, u4DMAReadIdx:0x%x , DMA_Read_Ptr:0x%x, read_size:%x", Read_Data_Ptr, Vul_Block->pucVirtBufAddr, Vul_Block->u4DMAReadIdx, DMA_Read_Ptr, read_size);
            return read_count << 2;
        }
