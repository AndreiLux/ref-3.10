                                     ...
                                     struct snd_pcm_hw_params *hw_params)
{
    ...
    // -------------------------------------------------------
    printk("1 dma_bytes = %d dma_area = %p dma_addr = 0x%x\n",
...
static int mtk_pcm_I2S0dl1_open(struct snd_pcm_substream *substream)
{
    ...
    else if ((GetSramState() & SRAM_STATE_SPH_SPK_MNTR_CAPTURE_DL) != 0)
    {
        mtk_I2S0dl1_hardware.buffer_bytes_max = 0x1000;
    ...
    printk("mtk_I2S0dl1_hardware.buffer_bytes_max = %d mPlaybackSramState = %d\n", mtk_I2S0dl1_hardware.buffer_bytes_max, mPlaybackSramState);
