...
TRACE_EVENT(mmc_multi_read_start,

		TP_PROTO(unsigned int blksz, unsigned int blocks),

		TP_ARGS(blksz, blocks),
		...
		TP_printk("Start : Block Size[%d], Block Count[%d]", __entry->blksz, __entry->blocks)
		);

TRACE_EVENT(mmc_multi_read_done,

		TP_PROTO(unsigned int blksz, unsigned int blocks, int diff),

		TP_ARGS(blksz, blocks, diff),
		...
		TP_printk("End : Block Size[%d], Block Count[%d], Time Stamp[%d]", __entry->blksz, __entry->blocks, __entry->diff)
		);
