...
#define CREATE_PROC_ENTRY_I(proc, x, y, z, m) proc = proc_create(x, y, z, m)

#else

#define CREATE_PROC_ENTRY_I(proc, x, y, z, m)
...
#define DumpIOTrace(timeoffset) \
	dump_trace_log(__func__, timeoffset);
