...
static hw_dec_struct hw_dec_device_array[] =
{
    ...
    { DEV_I2C_MAX,"NULL" },// id : 23    order number 24
    { DEV_CONNECTIVITY_WIFI,"wifi" },// id : 24    order number 25
    { DEV_CONNECTIVITY_BT,"bt" },// id : 25    order number 26
    { DEV_CONNECTIVITY_FM,"fm" },// id : 26    order number 27
    { DEV_CONNECTIVITY_GPS,"gps" },// id : 27    order number 28
};
