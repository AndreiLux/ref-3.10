 ...
 */
	typedef enum _VDEC_DRV_VIDEO_FORMAT_T {
		...
		VDEC_DRV_VIDEO_FORMAT_H264HP = (1 << 24),	/* /< H264 High Profile */
		VDEC_DRV_VIDEO_FORMAT_H264SEC = (1 << 25)	/* /< H264 Security */
	} VDEC_DRV_VIDEO_FORMAT_T;
 ...
 */
	typedef struct __VDEC_DRV_SEQINFO_T {
		...
		VAL_UINT32_T u4ReferenceFrameNumber;	/* /< [OUT] Sequence reference frame number */
	} VDEC_DRV_SEQINFO_T;
