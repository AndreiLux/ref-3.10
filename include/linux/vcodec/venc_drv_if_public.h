...
#ifdef MTK_SEC_WFD_VIDEO_PATH_SUPPORT
		VENC_DRV_VIDEO_FORMAT_H264SEC,	/* /< H.264 video format in Security */
#endif
...
*/
	typedef enum __VENC_DRV_SCENARIO_T {
		...
		VENC_DRV_SCENARIO_VIDEO_CONFRENCE = 8,	/* / LivePhoto effect transcoding */
	} VENC_DRV_SCENARIO_T;
...
#ifdef MTK_SEC_WFD_VIDEO_PATH_SUPPORT
#define FRM_BUF_FLAG_NORMAL 0
#define FRM_BUF_FLAG_SECURE 1
#endif
...
#ifdef MTK_SEC_WFD_VIDEO_PATH_SUPPORT
		VAL_UINT32_T u4Flags;	/* /<[IN]  buffer specific flags */
#endif
	} VENC_DRV_PARAM_FRM_BUF_T;
 ...
 *   VENC_DRV_MRESULT_T     [OUT] VENC_DRV_MRESULT_OK for success, VENC_DRV_MRESULT_FAIL for fail
 */
	VENC_DRV_MRESULT_T eVEncDrvCreate(VAL_HANDLE_T *a_phHandle,
 ...
 *   VENC_DRV_MRESULT_T     [OUT] VENC_DRV_MRESULT_OK for success, VENC_DRV_MRESULT_FAIL for fail
 */
	VENC_DRV_MRESULT_T eVEncDrvRelease(VAL_HANDLE_T a_hHandle,
					   VENC_DRV_VIDEO_FORMAT_T a_eVideoFormat);
