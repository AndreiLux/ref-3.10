...
#define IP_RST_HSICPHY			(1<<10)
#define GT_CLK_USB2HOST_REF		(0X7<<11)
...
struct hisik3_ehci_platform_data {
	...
	const char *hclk_usb2host;
	const char *clk_usbhost48;
	const char *clk_usbhost12;
	const char *clk_usb2host_ref;
	const char *clk_hsic;
...
struct hisik3_ehci_hcd {
	...
	int irq;
	int instance;
	struct clk *hclk_usb2host;
	struct clk *clk_usbhost48;
	struct clk *clk_usbhost12;
	struct clk *clk_usb2host_ref;
	struct clk *clk_hsic;
