...
typedef enum {
	...
	/* ---------------------------------------------------------------------------- */
	/* Misc. feature id. */
	ENUM_MISC_FIDS_SI(FID_ZOOM_FACTOR,	/* Legacy symbol (Remove if possible) */
			  FID_AE_STROBE,
			  FID_EIS,
			  FID_ZSD,
			  FID_AWB2PASS,
	...
	ENUM_RAW_YUV_SHARED_FIDS_SI(FID_SCENE_MODE,
				    FID_COLOR_EFFECT,
				    FID_CAPTURE_MODE,
				    FID_CAP_SIZE,
				    FID_PREVIEW_SIZE,
	...
	/* ---------------------------------------------------------------------------- */
	/* Misc. feature id. */
	ENUM_MISC_FIDS_SD(FID_FD_ON_OFF,
	),
	/* RAW-only feature id. */
	ENUM_RAW_ONLY_SD(),
	/* RAW-YUV-shared feature id. */
	ENUM_RAW_YUV_SHARED_FIDS_SD(FID_AE_SCENE_MODE,
				    FID_AE_METERING,
				    FID_AE_ISO,
				    FID_AE_EV,
				    FID_AF_MODE,
	...
	/* YUV-only feature id. */
	ENUM_YUV_ONLY_SD(FID_YUV_AUTOTEST,
	),
	/* ---------------------------------------------------------------------------- */
