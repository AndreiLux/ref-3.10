...
/* MAX77888 MUIC support for device tree */
struct of_max77888_muic_support {
	bool	notifier;
	bool	otg_dongle;
};
...
typedef enum {
	...
	CTRL1_USB_DOCK	= (MAX77888_MUIC_CTRL1_ID_OPEN << IDBEN_SHIFT) | \
			(MAX77888_MUIC_CTRL1_COM_USB << COMP2SW_SHIFT) | \
			(MAX77888_MUIC_CTRL1_COM_USB << COMN1SW_SHIFT),
} max77888_reg_ctrl1_t;

enum {
	MAX77888_MUIC_CTRL4_ADCMODE_ALWAYS_ON		= 0x00,
	MAX77888_MUIC_CTRL4_ADCMODE_ALWAYS_ON_1M_MON	= 0x01,
	MAX77888_MUIC_CTRL4_ADCMODE_ONE_SHOT		= 0x02,
	MAX77888_MUIC_CTRL4_ADCMODE_2S_PULSE		= 0x03
};
