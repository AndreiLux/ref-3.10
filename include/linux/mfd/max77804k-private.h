...
#define MAX77804K_CHG_CNFG_00_MODE_SHIFT		0
#define MAX77804K_CHG_CNFG_00_CHG_SHIFT			0
#define MAX77804K_CHG_CNFG_00_OTG_SHIFT			1
#define MAX77804K_CHG_CNFG_00_BUCK_SHIFT		2
#define MAX77804K_CHG_CNFG_00_BOOST_SHIFT		3
#define MAX77804K_CHG_CNFG_00_DIS_MUIC_CTRL_SHIFT	5
#define MAX77804K_CHG_CNFG_00_MODE_MASK		(0xf << MAX77804K_CHG_CNFG_00_MODE_SHIFT)
#define MAX77804K_CHG_CNFG_00_CHG_MASK		(1 << MAX77804K_CHG_CNFG_00_CHG_SHIFT)
#define MAX77804K_CHG_CNFG_00_OTG_MASK		(1 << MAX77804K_CHG_CNFG_00_OTG_SHIFT)
#define MAX77804K_CHG_CNFG_00_BUCK_MASK		(1 << MAX77804K_CHG_CNFG_00_BUCK_SHIFT)
#define MAX77804K_CHG_CNFG_00_BOOST_MASK		(1 << MAX77804K_CHG_CNFG_00_BOOST_SHIFT)
#define MAX77804K_CHG_CNFG_00_DIS_MUIC_CTRL_MASK	(1 << MAX77804K_CHG_CNFG_00_DIS_MUIC_CTRL_SHIFT)
#define MAX77804K_CHG_CNFG_00_OTG_CTRL		\
	(MAX77804K_CHG_CNFG_00_OTG_MASK | MAX77804K_CHG_CNFG_00_BOOST_MASK | MAX77804K_CHG_CNFG_00_DIS_MUIC_CTRL_MASK)

/* MAX77804K CHG_CNFG_04 register */
#define MAX77804K_CHG_CNFG_04_CHG_CV_PRM_SHIFT		0
#define MAX77804K_CHG_CNFG_04_CHG_CV_PRM_MASK		(0x1f << MAX77804K_CHG_CNFG_04_CHG_CV_PRM_SHIFT)
...
#define MAX77804K_STATUS1_ADC_SHIFT		0
#define MAX77804K_STATUS1_ADCLOW_SHIFT		5
#define MAX77804K_STATUS1_ADCERR_SHIFT		6
#define MAX77804K_STATUS1_ADC1K_SHIFT		7
#define MAX77804K_STATUS1_ADC_MASK		(0x1f << MAX77804K_STATUS1_ADC_SHIFT)
#define MAX77804K_STATUS1_ADCLOW_MASK		(0x1 << MAX77804K_STATUS1_ADCLOW_SHIFT)
#define MAX77804K_STATUS1_ADCERR_MASK		(0x1 << MAX77804K_STATUS1_ADCERR_SHIFT)
#define MAX77804K_STATUS1_ADC1K_MASK		(0x1 << MAX77804K_STATUS1_ADC1K_SHIFT)

/* MAX77804K STATUS2 register */
#define MAX77804K_STATUS2_CHGTYP_SHIFT		0
#define MAX77804K_STATUS2_CHGDETRUN_SHIFT	3
#define MAX77804K_STATUS2_DXOVP_SHIFT		5
#define MAX77804K_STATUS2_VBVOLT_SHIFT		6
#define MAX77804K_STATUS2_CHGTYP_MASK		(0x7 << MAX77804K_STATUS2_CHGTYP_SHIFT)
#define MAX77804K_STATUS2_CHGDETRUN_MASK	(0x1 << MAX77804K_STATUS2_CHGDETRUN_SHIFT)
#define MAX77804K_STATUS2_DXOVP_MASK		(0x1 << MAX77804K_STATUS2_DXOVP_SHIFT)
#define MAX77804K_STATUS2_VBVOLT_MASK		(0x1 << MAX77804K_STATUS2_VBVOLT_SHIFT)

/* MAX77804K CDETCTRL1 register */

#define MAX77804K_CHGDETEN_SHIFT		0
#define MAX77804K_CHGTYPM_SHIFT			1
#define MAX77804K_CHGDETEN_MASK			(0x1 << MAX77804K_CHGDETEN_SHIFT)
#define MAX77804K_CHGTYPM_MASK			(0x1 << MAX77804K_CHGTYPM_SHIFT)

/* MAX77804K CONTROL1 register */
#define MAX77804K_CLEAR_IDBEN_MICEN_MASK	0x3f
#define MAX77804K_COMN1SW_SHIFT			0x0
#define MAX77804K_COMP2SW_SHIFT			0x3
#define MAX77804K_MICEN_SHIFT			0x6
#define MAX77804K_COMN1SW_MASK			(0x7 << MAX77804K_COMN1SW_SHIFT)
#define MAX77804K_COMP2SW_MASK			(0x7 << MAX77804K_COMP2SW_SHIFT)
#define MAX77804K_MICEN_MASK			(0x1 << MAX77804K_MICEN_SHIFT)

/* MAX77804K CONTROL2 register */
#define MAX77804K_CTRL2_ACCDET_SHIFT		5
#define MAX77804K_CTRL2_ACCDET_MASK		(0x1 << MAX77804K_CTRL2_ACCDET_SHIFT)
#define MAX77804K_CTRL2_CPEn_SHIFT		2
#define MAX77804K_CTRL2_CPEn_MASK		(0x1 << MAX77804K_CTRL2_CPEn_SHIFT)
#define MAX77804K_CTRL2_LOWPWD_SHIFT		0
#define MAX77804K_CTRL2_LOWPWD_MASK		(0x1 << MAX77804K_CTRL2_LOWPWD_SHIFT)
#define MAX77804K_CTRL2_CPEn1_LOWPWD0 ((MAX77804K_ENABLE_BIT << MAX77804K_CTRL2_CPEn_SHIFT) | \
				(MAX77804K_DISABLE_BIT << MAX77804K_CTRL2_LOWPWD_SHIFT))
#define MAX77804K_CTRL2_CPEn0_LOWPWD1 ((MAX77804K_DISABLE_BIT << MAX77804K_CTRL2_CPEn_SHIFT) | \
				(MAX77804K_ENABLE_BIT << MAX77804K_CTRL2_LOWPWD_SHIFT))

/* MAX77804K CONTROL3 register */
#define MAX77804K_CTRL3_JIGSET_SHIFT		0
#define MAX77804K_CTRL3_BOOTSET_SHIFT		2
#define MAX77804K_CTRL3_ADCDBSET_SHIFT		4
#define MAX77804K_CTRL3_JIGSET_MASK		(0x3 << MAX77804K_CTRL3_JIGSET_SHIFT)
#define MAX77804K_CTRL3_BOOTSET_MASK		(0x3 << MAX77804K_CTRL3_BOOTSET_SHIFT)
#define MAX77804K_CTRL3_ADCDBSET_MASK		(0x3 << MAX77804K_CTRL3_ADCDBSET_SHIFT)

/* MAX77804 CONTROL4 register */
#define MAX77804K_CTRL4_ADCMODE_SHIFT		6
#define MAX77804K_CTRL4_ADCDBSET_SHIFT		0
#define MAX77804K_CTRL4_ADCMODE_MASK		(0x3 << MAX77804K_CTRL4_ADCMODE_SHIFT)
#define MAX77804K_CTRL4_ADCDBSET_MASK		(0x3 << MAX77804K_CTRL4_ADCDBSET_SHIFT)

/* Interrupt 1 */
#define MAX77804K_INT_DETACH			(0x1 << 1)
#define MAX77804K_INT_ATTACH			(0x1 << 0)
...
enum max77804k_reg_ctrl1_type {
	MAX77804K_CTRL1_AP_USB =
		(MAX77804K_MUIC_CTRL1_BIN_1_001 << MAX77804K_COMP2SW_SHIFT)
		| MAX77804K_MUIC_CTRL1_BIN_1_001 ,
	MAX77804K_CTRL1_AUDIO =
		(MAX77804K_MUIC_CTRL1_BIN_2_010 << MAX77804K_COMP2SW_SHIFT)
		| MAX77804K_MUIC_CTRL1_BIN_2_010 ,
	MAX77804K_CTRL1_CP_USB =
		(MAX77804K_MUIC_CTRL1_BIN_4_100 << MAX77804K_COMP2SW_SHIFT)
		| MAX77804K_MUIC_CTRL1_BIN_4_100 ,
	MAX77804K_CTRL1_AP_UART =
		(MAX77804K_MUIC_CTRL1_BIN_3_011 << MAX77804K_COMP2SW_SHIFT)
		| MAX77804K_MUIC_CTRL1_BIN_3_011 ,
	MAX77804K_CTRL1_CP_UART =
		(MAX77804K_MUIC_CTRL1_BIN_5_101 << MAX77804K_COMP2SW_SHIFT)
...
extern void max77804k_muic_set_chgdeten(int enable);
...
enum max77804k_cable_type_muic {
	MAX77804K_CABLE_TYPE_NONE_MUIC = 0,		/* 0 */
	MAX77804K_CABLE_TYPE_USB_MUIC,			/* 1 */
	MAX77804K_CABLE_TYPE_OTG_MUIC,			/* 2 */
	MAX77804K_CABLE_TYPE_TA_MUIC,			/* 3 */
	MAX77804K_CABLE_TYPE_DESKDOCK_MUIC,		/* 4 */
	MAX77804K_CABLE_TYPE_CARDOCK_MUIC,		/* 5 */
	MAX77804K_CABLE_TYPE_JIG_UART_OFF_MUIC,		/* 6 */
	MAX77804K_CABLE_TYPE_JIG_UART_OFF_VB_MUIC,	/* 7 VBUS enabled */
	MAX77804K_CABLE_TYPE_JIG_UART_ON_MUIC,		/* 8 */
	MAX77804K_CABLE_TYPE_JIG_USB_OFF_MUIC,		/* 9 */
	MAX77804K_CABLE_TYPE_JIG_USB_ON_MUIC,		/* 10 */
	MAX77804K_CABLE_TYPE_MHL_MUIC,			/* 11 */
	MAX77804K_CABLE_TYPE_MHL_VB_MUIC,			/* 12 */
	MAX77804K_CABLE_TYPE_SMARTDOCK_MUIC,		/* 13 */
	MAX77804K_CABLE_TYPE_SMARTDOCK_TA_MUIC,		/* 14 */
	MAX77804K_CABLE_TYPE_SMARTDOCK_USB_MUIC,		/* 15 */
	MAX77804K_CABLE_TYPE_AUDIODOCK_MUIC,		/* 16 */
	MAX77804K_CABLE_TYPE_INCOMPATIBLE_MUIC,		/* 17 */
	MAX77804K_CABLE_TYPE_CDP_MUIC,			/* 18 */
#if defined(CONFIG_MUIC_MAX77804K_SUPPORT_HMT_DETECTION)
	MAX77804K_CABLE_TYPE_HMT_MUIC,			/* 19 */
	MAX77804K_CABLE_TYPE_HMT_TA_MUIC,			/* 20 */
#endif
#if defined(CONFIG_MUIC_DET_JACK)
	MAX77804K_CABLE_TYPE_EARJACK_MUIC,
#endif
	MAX77804K_CABLE_TYPE_UNKNOWN_MUIC
};

enum {
	MAX77804K_OPEN_USB_MODE = 0,
	MAX77804K_AP_USB_MODE,
	MAX77804K_AUDIO_MODE,
	MAX77804K_CP_USB_MODE,
};

enum {
	MAX77804K_ADC_ALWAYS = 0,
	MAX77804K_ADC_ALWAYS_1M,
	MAX77804K_ADC_ONESHOT,
	MAX77804K_ADC_PULSE,
};
#if 0
enum usb_cable_status {
	MAX77804K_USB_CABLE_DETACHED = 0,
	MAX77804K_USB_CABLE_ATTACHED,
	MAX77804K_USB_OTGHOST_DETACHED,
	MAX77804K_USB_OTGHOST_ATTACHED,
	MAX77804K_USB_POWERED_HOST_DETACHED,
	MAX77804K_USB_POWERED_HOST_ATTACHED,
	MAX77804K_USB_CABLE_DETACHED_WITHOUT_NOTI,
};
#endif
enum {
	MAX77804K_UART_PATH_CP = 0,
	MAX77804K_UART_PATH_AP,
};

#if defined(CONFIG_MUIC_DET_JACK)
enum {
	MAX77804K_NOT_INIT = 0,
	MAX77804K_INIT_START,
	MAX77804K_INIT_DONE,
};
#endif
