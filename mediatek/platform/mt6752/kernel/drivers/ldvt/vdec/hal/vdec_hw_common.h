...
#define vWriteGconReg(dAddr, dVal)  mt_reg_sync_writel(dVal, VDEC_GCON_BASE + dAddr)
#define u4ReadGconReg(dAddr)  *(volatile UINT32 *)(VDEC_GCON_BASE + dAddr)
#define vWriteGenReg(dAddr, dVal)  mt_reg_sync_writel(dVal, dAddr) //*(volatile UINT32 *)(IO_BASE + dAddr) = dVal
