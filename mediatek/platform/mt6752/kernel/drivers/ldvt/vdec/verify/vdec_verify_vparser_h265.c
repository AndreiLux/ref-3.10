...
void vHEVCResetFBAddr(UINT32 u4InstID, UINT32 u4FBindex)
{
    ...
    if (bIsUFO){
        _ptH265FBufInfo[u4InstID][u4FBindex].u4CAddrOffset = u4PicSizeYBS;
        _ptH265FBufInfo[u4InstID][u4FBindex].u4PicSizeBS = u4PicSizeBS;
        _ptH265FBufInfo[u4InstID][u4FBindex].u4UFOLenYsize = u4UFOLenYsize;
        _ptH265FBufInfo[u4InstID][u4FBindex].u4PicSizeYBS = u4PicSizeYBS;
        _ptH265FBufInfo[u4InstID][u4FBindex].u4UFOLenCsize  = u4UFOLenCsize;
        _ptH265FBufInfo[u4InstID][u4FBindex].u4YLenStartAddr = _ptH265FBufInfo[u4InstID][u4FBindex].u4YStartAddr + u4PicSizeBS;
        _ptH265FBufInfo[u4InstID][u4FBindex].u4CLenStartAddr = _ptH265FBufInfo[u4InstID][u4FBindex].u4YLenStartAddr + u4UFOLenYsize;
    }
