...
static struct
{
    ...
    long                 vow_info_apuser[MAX_VOW_INFO_LEN];
    int                  vow_info_dsp[MAX_VOW_INFO_LEN];
    long                 voicedata_user_addr;
    long                 voicedata_user_size;
...
void vow_ipi_handler(int id, void *data, unsigned int len)
{
    ...
    switch (*vowmsg)
    {
        ...
        {
            //xlog_printk(ANDROID_LOG_INFO, VOW_TAG, "MD32_IPIMSG_VOW_DATAREADY\n");
...
static void vow_service_Init(void)
{
   int I;
   short *ptr16;
   xlog_printk(ANDROID_LOG_INFO, VOW_TAG, "vow_service_Init\n");
#if DYNAMIC_VOW_SWAP
    vowserv.swapid          = -1;
    vowserv.swapwait        = false;
    ...
    vowserv.voicedata_scp_addr = dma_map_single(NULL, (void*)vowserv.voicddata_scp_ptr, VOW_VOICE_DATA_LENGTH_BYTES, DMA_BIDIRECTIONAL);
    //dma_sync_single_for_device(NULL, vowserv.voicedata_scp_addr, VOW_VOICE_DATA_LENGTH_BYTES, DMA_TO_DEVICE);
...
static bool vow_service_SetSpeakerModel(unsigned long arg)
{
    ...
    vowserv.vow_info_dsp[2] = dma_map_single(NULL, vowserv.vow_speaker_model[I].model_ptr, vowserv.vow_info_apuser[2], DMA_TO_DEVICE);
    vowserv.vow_info_dsp[3] = vowserv.vow_info_apuser[2];
    dma_sync_single_for_device(NULL, vowserv.vow_info_dsp[2], vowserv.vow_info_apuser[2], DMA_TO_DEVICE);
...
static bool vow_service_SetInitModel(unsigned long arg)
{
    ...
    vowserv.vow_info_dsp[2] = dma_map_single(NULL, vowserv.vow_init_model, vowserv.vow_info_apuser[2], DMA_TO_DEVICE);
    vowserv.vow_info_dsp[3] = vowserv.vow_info_apuser[2];
    dma_sync_single_for_device(NULL, vowserv.vow_info_dsp[2], vowserv.vow_info_apuser[2], DMA_TO_DEVICE);
...
static bool vow_service_SetNoiseModel(unsigned long arg)
{
    ...
    vowserv.vow_info_dsp[1] = 0;
    vowserv.vow_info_dsp[2] = dma_map_single(NULL, vowserv.vow_noise_model, vowserv.vow_info_apuser[2], DMA_TO_DEVICE);
    vowserv.vow_info_dsp[3] = vowserv.vow_info_apuser[2];
    dma_sync_single_for_device(NULL, vowserv.vow_info_dsp[2], vowserv.vow_info_apuser[2], DMA_TO_DEVICE);
...
static bool vow_service_SetFirModel(unsigned long arg)
{
    ...
    vowserv.vow_info_dsp[1] = 0;
    vowserv.vow_info_dsp[2] = dma_map_single(NULL, vowserv.vow_fir_model, vowserv.vow_info_apuser[2], DMA_TO_DEVICE);
    vowserv.vow_info_dsp[3] = vowserv.vow_info_apuser[2];
    dma_sync_single_for_device(NULL, vowserv.vow_info_dsp[2], vowserv.vow_info_apuser[2], DMA_TO_DEVICE);
    ...
    while(1)
    {
       ...
       if (VoiceData_Wait_Queue_flag == 1) 
       {
          ...
          else
          {
             ...
             dma_sync_single_for_cpu(NULL, vowserv.voicedata_scp_addr, VOW_VOICE_DATA_LENGTH_BYTES, DMA_FROM_DEVICE);
          #if 0
             if(firstbuffer == 1 )
             {
