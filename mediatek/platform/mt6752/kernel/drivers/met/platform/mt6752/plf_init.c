...
extern struct metdevice met_gator;
extern struct metdevice met_mali;
...
static int __init met_plf_init(void)
{
	...
	/* met_register(&met_gator); */
	/* met_register(&met_mali); */

	met_set_platform("mt6752", 1);
...
static void __exit met_plf_exit(void)
{
	...
	/* met_deregister(&met_mali); */
	/* met_deregister(&met_gator); */
