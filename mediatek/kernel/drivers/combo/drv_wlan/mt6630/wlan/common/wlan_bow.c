    ...
    )
{
    ...
    {
        DBGLOG(BOW, INFO, ("bowCmdGetMacStatus, Get preferred channel.\n"));
    ...
    {
        DBGLOG(BOW, INFO, ("bowCmdGetMacStatus, Get channel list. Current number of channel, %d.\n", ucNumOfChannel));
    ...
    DBGLOG(BOW, INFO, ("ucNumOfChannel, eBand, aucChannelList, %x, %x, %x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x.\n",
        ucNumOfChannel,
    ...
    DBGLOG(BOW, INFO, ("prMacStatus->ucNumOfChannel, eBand, prMacStatus->arChannelList, %x, %x, %x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x.\n",
    ...
    DBGLOG(BOW, INFO, ("prMacStatus->ucNumOfChannel, %x.\n", prMacStatus->ucNumOfChannel));
    DBGLOG(BOW, INFO, ("prMacStatus->arChannelList[0].ucChannelBand, %x.\n", prMacStatus->arChannelList[0].ucChannelBand));
    DBGLOG(BOW, INFO, ("prMacStatus->arChannelList[0].ucChannelNum, %x.\n", prMacStatus->arChannelList[0].ucChannelNum));
    DBGLOG(BOW, INFO, ("prMacStatus->ucAvailability, %x.\n", prMacStatus->ucAvailability));
    DBGLOG(BOW, INFO, ("prMacStatus->aucMacAddr, %x:%x:%x:%x:%x:%x.\n",
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("bowCmdSetupConnection.\n"));
    DBGLOG(BOW, INFO, ("rCmdBtOverWifi Channel Number - 0x%x.\n", rCmdBtOverWifi.ucChannelNum));
    DBGLOG(BOW, INFO, ("rCmdBtOverWifi Peer address - %x:%x:%x:%x:%x:%x.\n", rCmdBtOverWifi.rPeerAddr[0],
    ...
    DBGLOG(BOW, INFO, ("rCmdBtOverWifi Beacon interval - 0x%x.\n", rCmdBtOverWifi.u2BeaconInterval));
    DBGLOG(BOW, INFO, ("rCmdBtOverWifi Timeout activity - 0x%x.\n", rCmdBtOverWifi.ucTimeoutDiscovery));
    DBGLOG(BOW, INFO, ("rCmdBtOverWifi Timeout inactivity - 0x%x.\n", rCmdBtOverWifi.ucTimeoutInactivity));
    DBGLOG(BOW, INFO, ("rCmdBtOverWifi Role - 0x%x.\n", rCmdBtOverWifi.ucRole));
    DBGLOG(BOW, INFO, ("rCmdBtOverWifi PAL capability - 0x%x.\n", rCmdBtOverWifi.PAL_Capabilities));
    DBGLOG(BOW, INFO, ("rCmdBtOverWifi Max Tx power - 0x%x.\n", rCmdBtOverWifi.cMaxTxPower));
    ...
    DBGLOG(BOW, INFO, ("bowStarting, g_u4LinkCount, %x.\n", g_u4LinkCount));

    if (g_u4LinkCount == 1)
    {
        DBGLOG(BOW, INFO, ("bowStarting, cnmTimerInitTimer.\n"));
        DBGLOG(BOW, INFO, ("prBowFsmInfo->u2BeaconInterval, %d.\n", prBowFsmInfo->u2BeaconInterval));
        ...
        DBGLOG(BOW, INFO, ("bowCmdSetupConnection, g_u4LinkCount, %x.\n", g_u4LinkCount));
        DBGLOG(BOW, INFO, ("kalInitBowDevice, bow0\n"));
    ...
    )
{
    ...
    {
        DBGLOG(BOW, INFO, ("bowCmdDestroyConnection, bowCheckIfVaild, not accepted.\n"));
        return WLAN_STATUS_NOT_ACCEPTED;
    }

    DBGLOG(BOW, INFO, ("bowCmdDestroyConnection, destroy Peer address - %x:%x:%x:%x:%x:%x.\n", prBowDestroyConnection->aucPeerAddress[0],
    ...
    DBGLOG(BOW, INFO, ("bowCmdDestroyConnection, rCmdBtOverWifi.rPeerAddr - %x:%x:%x:%x:%x:%x.\n", rCmdBtOverWifi.rPeerAddr[0],
        rCmdBtOverWifi.rPeerAddr[1],
        rCmdBtOverWifi.rPeerAddr[2],
        rCmdBtOverWifi.rPeerAddr[3],
        rCmdBtOverWifi.rPeerAddr[4],
    ...
    {
        DBGLOG(BOW, INFO, ("BoW receiving PAL packet delta time vs packet number -- %d ms vs %x.\n", ucIdx, g_arBowRevPalPacketTime[ucIdx]));
    }
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("prBowSetPTK->aucPeerAddress, %x:%x:%x:%x:%x:%x.\n",
    ...
    DBGLOG(BOW, INFO, ("prBowSetPTK->aucTemporalKey, %x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x.\n",
    ...
    DBGLOG(BOW, INFO, ("rCmdKey.aucKeyMaterial, %x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x:%x.\n",
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("bowCmdShortRangeMode.\n"));
    ...
    DBGLOG(BOW, INFO, ("prBowShortRangeMode->aucPeerAddress, %x:%x:%x:%x:%x:%x.\n",
    ...
    {
        DBGLOG(BOW, INFO, ("bowCmdShortRangeMode, %x.\n", WLAN_STATUS_SUCCESS));
        wlanbowCmdEventSetStatus(prAdapter, prCmd, BOWCMD_STATUS_SUCCESS);
        return WLAN_STATUS_SUCCESS;
    }
    else
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("prEvent->rHeader.ucEventId, 0x%x\n", prEvent->rHeader.ucEventId));
    DBGLOG(BOW, INFO, ("prEvent->rHeader.ucSeqNumber, 0x%x\n", prEvent->rHeader.ucSeqNumber));
    DBGLOG(BOW, INFO, ("prEvent->rHeader.u2PayloadLength, 0x%x\n", prEvent->rHeader.u2PayloadLength));
    DBGLOG(BOW, INFO, ("prBowLinkConnected->rChannel.ucChannelNum, 0x%x\n", prBowLinkConnected->rChannel.ucChannelNum));
    DBGLOG(BOW, INFO, ("prBowLinkConnected->rChannel.ucChannelBand, 0x%x\n", prBowLinkConnected->rChannel.ucChannelBand));
    DBGLOG(BOW, INFO, ("wlanbowCmdEventLinkConnected, prBowFsmInfo->aucPeerAddress, %x:%x:%x:%x:%x:%x.\n",
    ...
    DBGLOG(BOW, INFO, ("wlanbowCmdEventLinkConnected, prBowLinkConnected->aucPeerAddress, %x:%x:%x:%x:%x:%x.\n",
    ...
    DBGLOG(BOW, INFO, ("wlanbowCmdEventLinkConnected, g_u4LinkCount, %x.\n", g_u4LinkCount));
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("wlanbowCmdEventLinkDisconnected, prBowFsmInfo->aucPeerAddress, %x:%x:%x:%x:%x:%x.\n",
        prBowFsmInfo->aucPeerAddress[0],
        prBowFsmInfo->aucPeerAddress[1],
        prBowFsmInfo->aucPeerAddress[2],
        prBowFsmInfo->aucPeerAddress[3],
    ...
    DBGLOG(BOW, INFO, ("wlanbowCmdEventLinkDisconnected, prBowLinkDisconnected->aucPeerAddress, %x:%x:%x:%x:%x:%x.\n",
    ...
    DBGLOG(BOW, INFO, ("wlanbowCmdEventLinkDisconnected, g_u4LinkCount, %x.\n", g_u4LinkCount));
    ...
    {
        fgSendDeauth = TRUE;
        DBGLOG(BOW, INFO, ("wlanbowCmdEventLinkDisconnected, bowGetBowTableState, %x.\n", bowGetBowTableState(prAdapter, prBowLinkDisconnected->aucPeerAddress)));
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("bowStoping.\n"));
    DBGLOG(BOW, INFO, ("bowStoping, SSID %s.\n", prBowBssInfo->aucSSID));
    DBGLOG(BOW, INFO, ("bowStoping, prBowBssInfo->aucBSSID, %x:%x:%x:%x:%x:%x.\n",
    ...
    DBGLOG(BOW, INFO, ("bowStoping, prBssInfo->aucOwnMacAddr, %x:%x:%x:%x:%x:%x.\n",
    ...
    DBGLOG(BOW, INFO, ("bowStoping, prAdapter->rWifiVar.aucDeviceAddress, %x:%x:%x:%x:%x:%x.\n",
    ...
    DBGLOG(BOW, INFO, ("bowStopping, g_u4LinkCount, %x.\n", g_u4LinkCount));
    DBGLOG(BOW, INFO, ("prBowFsmInfo->aucPeerAddress, %x:%x:%x:%x:%x:%x.\n", prBowFsmInfo->aucPeerAddress[0],
        prBowFsmInfo->aucPeerAddress[1],
        prBowFsmInfo->aucPeerAddress[2],
        prBowFsmInfo->aucPeerAddress[3],
        prBowFsmInfo->aucPeerAddress[4],
        prBowFsmInfo->aucPeerAddress[5]));
    DBGLOG(BOW, INFO, ("BoW Stoping,[%d,%d]\n", g_u4LinkCount, g_u4Beaconing));
    ...
    )
{
    ...
    if (g_u4LinkCount == 1)
    {
        DBGLOG(BOW, INFO, ("BoW Starting.\n"));
        DBGLOG(BOW, INFO, ("BoW channel granted.\n"));
    ...
    //4 <1.2> Setup SSID
        ...
        DBGLOG(BOW, INFO, ("SSID %s.\n", prBssInfo->aucSSID));
        DBGLOG(BOW, INFO, ("prBssInfo->aucBSSID, %x:%x:%x:%x:%x:%x.\n",
        ...
        DBGLOG(BOW, INFO, ("prBssInfo->aucOwnMacAddr, %x:%x:%x:%x:%x:%x.\n",
        ...
        DBGLOG(BOW, INFO, ("prAdapter->rWifiVar.aucDeviceAddress, %x:%x:%x:%x:%x:%x.\n",
            prAdapter->rWifiVar.aucDeviceAddress[0],
            prAdapter->rWifiVar.aucDeviceAddress[1],
            prAdapter->rWifiVar.aucDeviceAddress[2],
            prAdapter->rWifiVar.aucDeviceAddress[3],
...
//    rxmSetRxFilterBSSID0(prBssInfo->ucHwBssidId, prBssInfo->aucBSSID);
    ...
    DBGLOG(BOW, INFO, ("BoW Starting,[%d,%d]\n", g_u4LinkCount, g_u4Beaconing));
    DBGLOG(BOW, INFO, ("bowStarting, g_u4LinkCount, %x.\n", g_u4LinkCount));
    ...
    )
{
    ...
    if ((g_u4Beaconing != 0) && (g_u4LinkCount > 0) && (g_u4LinkCount < CFG_BOW_PHYSICAL_LINK_NUM))
    {
        ...
        DBGLOG(BOW, INFO, ("BoW Send Beacon,[%d,%d]\n", g_u4LinkCount, g_u4Beaconing));
    }
}
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("bowResponderScan.\n"));
    DBGLOG(BOW, INFO, ("BOW SCAN [REQ:%d]\n", prBowFsmInfo->ucSeqNumOfScanReq+1));
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("bowResponderScanDone.\n"));
    DBGLOG(BOW, INFO, ("BOW SCAN [DONE:%d]\n", ucSeqNumOfCompMsg));

    if( eScanStatus == SCAN_STATUS_CANCELLED) {
        DBGLOG(BOW, INFO, ("BOW SCAN [CANCELLED:%d]\n", ucSeqNumOfCompMsg));
    ...
    {
        DBGLOG(BOW, INFO, ("Sequence no. of BOW Responder scan done is not matched.\n"));
        return;
    }
    else
    {
    ...
    do {
        ...
        if (TRUE) {
            ...
            if (!prScanCancel) {
                ...
                DBGLOG(BOW, INFO, ("Buffer not enough, can not cancel scan.\n"));
                ASSERT(FALSE);
                break;
            }
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("Starting bowResponderJoin.\n"));
    ...
    if (prBowFsmInfo->ucAvailableAuthTypes &
        ...
        DBGLOG(BOW, INFO, ("JOIN INIT: Try to do Authentication with AuthType == OPEN_SYSTEM.\n"));
    ...
    if (prBssDesc->ucSSIDLen) {
        COPY_SSID(prConnSettings->aucSSID,
                  ...
                  prBssDesc->aucSSID,
                  prBssDesc->ucSSIDLen);
        DBGLOG(BOW, INFO, ("bowResponderJoin, SSID %s.\n", prBssDesc->aucSSID));
    ...
    DBGLOG(BOW, INFO, ("prStaRec->eStaType, %x.\n", prStaRec->eStaType));
    DBGLOG(BOW, INFO, ("BoW trigger SAA ["MACSTR"]\n", MAC2STR(prStaRec->aucMacAddr)));
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("Start bowfsmRunEventJoinComplete.\n"));
    DBGLOG(BOW, INFO, ("bowfsmRunEventJoinComplete ptr check\n"));
    DBGLOG(BOW, INFO, ("prMsgHdr %x\n", prMsgHdr));
    DBGLOG(BOW, INFO, ("prAdapter %x\n", prAdapter));
    DBGLOG(BOW, INFO, ("prBowFsmInfo %x\n", prBowFsmInfo));
    DBGLOG(BOW, INFO, ("prStaRec %x\n", prStaRec));
    ...
    if (prJoinCompMsg->ucSeqNum == prBowFsmInfo->ucSeqNumOfReqMsg) {
        ...
        if (prJoinCompMsg->rJoinStatus == WLAN_STATUS_SUCCESS) {
            ...
            nicUpdateBss(prAdapter, prBowBssInfo->ucBssIndex);
            DBGLOG(BOW, INFO, ("Finish bowUpdateBssInfoForJOIN.\n"));

            //4 <1.4> Activate current AP's STA_RECORD_T in Driver.
            cnmStaRecChangeState(prAdapter, prStaRec, STA_STATE_3);

            DBGLOG(BOW, INFO, ("bowFsmRunEventJoinComplete, qmActivateStaRec.\n"));
...
#endif
            DBGLOG(BOW, INFO, ("Start bowfsmRunEventJoinComplete -- Join failed.\n"));
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("bowRunEventAAATxFail , bssRemoveStaRecFromClientList.\n"));
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("BoW AAA complete ["MACSTR"]\n", MAC2STR(prStaRec->aucMacAddr)));
    ...
    )
{
    ...
    *pu2StatusCode = STATUS_CODE_REQ_DECLINED;
    ...
    DBGLOG(BOW, INFO, ("bowValidateAssocReq, prBowFsmInfo->aucPeerAddress, %x:%x:%x:%x:%x:%x.\n",
        prBowFsmInfo->aucPeerAddress[0],
        prBowFsmInfo->aucPeerAddress[1],
        prBowFsmInfo->aucPeerAddress[2],
        prBowFsmInfo->aucPeerAddress[3],
        prBowFsmInfo->aucPeerAddress[4],
        prBowFsmInfo->aucPeerAddress[5]));
    DBGLOG(BOW, INFO, ("bowValidateAssocReq, prAssocReqFrame->aucSrcAddr, %x:%x:%x:%x:%x:%x.\n",
    ...
    while(EQUAL_MAC_ADDR(prAssocReqFrame->aucSrcAddr, prBowFsmInfo->aucPeerAddress)) {
        DBGLOG(BOW, INFO, ("bowValidateAssocReq, return wlanbowCmdEventLinkConnected.\n"));
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("bowValidateAuth, prBowFsmInfo->aucPeerAddress, %x:%x:%x:%x:%x:%x.\n",
        prBowFsmInfo->aucPeerAddress[0],
        prBowFsmInfo->aucPeerAddress[1],
        prBowFsmInfo->aucPeerAddress[2],
        prBowFsmInfo->aucPeerAddress[3],
        prBowFsmInfo->aucPeerAddress[4],
        prBowFsmInfo->aucPeerAddress[5]));
    DBGLOG(BOW, INFO, ("bowValidateAuth, prAuthFrame->aucSrcAddr, %x:%x:%x:%x:%x:%x.\n",
    ...
    if (!prStaRec) {
        DBGLOG(BOW, INFO, ("bowValidateAuth, cnmStaRecAlloc.\n"));
        ...
        cnmStaRecChangeState(prAdapter, prStaRec, STA_STATE_1);
        DBGLOG(BOW, INFO, ("bowValidateAuth, cnmStaRecChangeState.\n"));
    }
    else
    {
        prSwRfb->ucStaRecIdx = prStaRec->ucIndex;
        DBGLOG(BOW, INFO, ("bowValidateAuth, prStaRec->ucIndex, %x.\n", prStaRec->ucIndex));
    ...
    if (EQUAL_MAC_ADDR(prAuthFrame->aucSrcAddr, prBowFsmInfo->aucPeerAddress)) {
        DBGLOG(BOW, INFO, ("bowValidateAuth, prStaRec->eStaType, %x.\n", prStaRec->eStaType));
        DBGLOG(BOW, INFO, ("bowValidateAuth, prStaRec->ucBssIndex, %x.\n", prStaRec->ucBssIndex));        
    ...
    DBGLOG(BOW, INFO, ("bowValidateAuth,  fgReplyAuth, %x.\n",  fgReplyAuth));
    return fgReplyAuth;
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("Entering bowRunEventChGrant.\n"));
    ...
    )
{
    ...
    while (ucBowTableIdx < CFG_BOW_PHYSICAL_LINK_NUM)
    {
        if (arBowTable[ucBowTableIdx].fgIsValid)
        {
            ...
            DBGLOG(BOW, INFO, ("bowNotifyAllLinkDisconnected, arBowTable[%x].aucPeerAddress, %x:%x:%x:%x:%x:%x.\n", ucBowTableIdx,
            ...
            DBGLOG(BOW, INFO, ("bowNotifyAllLinkDisconnected, arBowTable[%x].fgIsValid, %x.\n", ucBowTableIdx, arBowTable[ucBowTableIdx].fgIsValid));
#if 1
            wlanoidSendSetQueryBowCmd(prAdapter,
                    CMD_ID_CMD_BT_OVER_WIFI,
                    prBowFsmInfo->ucBssIndex,
    ...
    )
{
    ...
    for(idx = 0 ; idx < CFG_BOW_PHYSICAL_LINK_NUM ; idx++)
    {
            ...
            EQUAL_MAC_ADDR(arBowTable[idx].aucPeerAddress, aucPeerAddress))
        {
            ...
            DBGLOG(BOW, INFO, ("kalCheckBowifVaild, aucPeerAddress %x, %x:%x:%x:%x:%x:%x.\n", idx,
                aucPeerAddress[0],
                aucPeerAddress[1],
                aucPeerAddress[2],
                aucPeerAddress[3],
            ...
            DBGLOG(BOW, INFO, ("kalCheckBowifVaild, arBowTable[idx].aucPeerAddress %x, %x:%x:%x:%x:%x:%x.\n", idx,
            ...
            DBGLOG(BOW, INFO, ("kalCheckBowifVaild, arBowTable[idx].fgIsValid, %x, %x.\n", idx, arBowTable[idx].fgIsValid));
    ...
    )
{
    ...
    if (arBowTable[ucBowTableIdx].fgIsValid)
    {
        ...
        DBGLOG(BOW, INFO, ("bowGetBowTableContent, arBowTable[idx].fgIsValid, %x, %x.\n", ucBowTableIdx, arBowTable[ucBowTableIdx].fgIsValid));
    ...
    )
{
    ...
    DBGLOG(BOW, INFO, ("kalCheckBowifVaild, arBowTable[ucBowTableIdx].fgIsValid, %x, %x.\n", ucBowTableIdx, arBowTable[ucBowTableIdx].fgIsValid));
    ...
    )
{
    ...
    for(idx = 0 ; idx < CFG_BOW_PHYSICAL_LINK_NUM ; idx++)
    {
        if(!arBowTable[idx].fgIsValid)
        {
            DBGLOG(BOW, INFO, ("bowGetBowTableFreeEntry, arBowTable[idx].fgIsValid, %x, %x.\n", idx, arBowTable[idx].fgIsValid));
            *pucBowTableIdx = idx;
    ...
    )
{
    ...
    for(idx = 0 ; idx < CFG_BOW_PHYSICAL_LINK_NUM ; idx++)
    {
        if( arBowTable[idx].fgIsValid &&
            EQUAL_MAC_ADDR(arBowTable[idx].aucPeerAddress, aucPeerAddress))
        {
            DBGLOG(BOW, INFO, ("bowGetState, aucPeerAddress %x, %x:%x:%x:%x:%x:%x.\n", idx,
                aucPeerAddress[0],
                aucPeerAddress[1],
                aucPeerAddress[2],
                aucPeerAddress[3],
                aucPeerAddress[4],
                aucPeerAddress[5]));
            DBGLOG(BOW, INFO, ("bowGetState, arBowTable[idx].aucPeerAddress %x, %x:%x:%x:%x:%x:%x.\n", idx,
                arBowTable[idx].aucPeerAddress[0],
                arBowTable[idx].aucPeerAddress[1],
                arBowTable[idx].aucPeerAddress[2],
                arBowTable[idx].aucPeerAddress[3],
                arBowTable[idx].aucPeerAddress[4],
                arBowTable[idx].aucPeerAddress[5]));
            DBGLOG(BOW, INFO, ("bowGetState, arBowTable[idx].fgIsValid, %x, %x.\n", idx, arBowTable[idx].fgIsValid));
            DBGLOG(BOW, INFO, ("bowGetState, arBowTable[idx].eState;, %x, %x.\n", idx, arBowTable[idx].eState));
