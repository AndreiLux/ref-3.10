...
static int mt_auxadc_create_device_attr(struct device *dev)
{
    int ret = 0;
    /* For EM */
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_register)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_read_channel)) != 0) goto exit;
#if ADC_CHANNEL_MAX>0
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_0_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_0_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>1
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_1_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_1_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>2
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_2_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_2_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>3
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_3_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_3_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>4
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_4_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_4_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>5
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_5_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_5_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>6
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_6_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_6_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>7
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_7_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_7_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>8
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_8_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_8_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>9
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_9_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_9_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>10
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_10_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_10_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>11
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_11_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_11_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>12
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_12_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_12_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>13
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_13_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_13_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>14
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_14_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_14_Offset)) != 0) goto exit;
#endif
#if ADC_CHANNEL_MAX>15
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_15_Slope)) != 0) goto exit;
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_15_Offset)) != 0) goto exit;
#endif
    if ((ret = device_create_file(dev, &dev_attr_AUXADC_Channel_Is_Calibration)) != 0) goto exit;
