...
static int mt_sched_debug_write(struct file *filp, const char *ubuf,
...
static int mt_cputime_write(struct file *filp, const char *ubuf,
	   size_t cnt, loff_t *data)
{
#ifdef CONFIG_MTPROF_CPUTIME
    char buf[64];
...
static int mt_status_write(struct file *filp, const char *ubuf,
	size_t cnt, loff_t *data)
{
    char buf[64];
    unsigned long val;
...
static int mt_wq_dump_write(struct file *filp, const char *ubuf,
	size_t cnt, loff_t *data)
{
    char buf[64];
    unsigned long val;
...
static int mt_wq_log_write(struct file *filp, const char *ubuf,
	size_t cnt, loff_t *data)
{
