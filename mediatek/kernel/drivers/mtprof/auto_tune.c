...
#define PLD_START_DST 0
#define CACHELINE_SIZE 64
#define PLD_END_DST 40
#define PLD_DST_INC 2 
...
#define TEST_PLD_ONLY 0
#define TEST_PLD_PLDW 1
#define TEST_NOPLD 2

#include "attu_pattern.h"
#include "attu_test_instr.h"
#include "attu_test_ldr_instr.h"
	...
	size_t cnt, loff_t *data)
{
    ...
    if(val == 0){
        ...
        test_instr_NEON(1, TEST_NOPLD, TEST_LDRD); 
        test_instr_NEON(1, TEST_PLD_ONLY, TEST_LDRD); 
        test_instr_NEON(1, TEST_PLD_PLDW, TEST_LDRD); 

    }else if(val == 4){
        //4.  normal ldrm/strm + PLD + PLDW
        test_instr_NEON(1, TEST_NOPLD, TEST_LDM); 
        test_instr_NEON(1, TEST_PLD_ONLY, TEST_LDM); 
        test_instr_NEON(1, TEST_PLD_PLDW, TEST_LDM); 
    }else if(val == 5){
        //5.  NEON 
        test_instr_NEON(1, TEST_NOPLD, TEST_NEON); 
        test_instr_NEON(1, TEST_PLD_ONLY, TEST_NEON); 
        test_instr_NEON(1, TEST_PLD_PLDW, TEST_NEON); 
    }else if(val == 6){
        test_instr_NEON(1, TEST_NOPLD, TEST_LDRD); 
        test_instr_NEON(1, TEST_PLD_ONLY, TEST_LDRD); 
        test_instr_NEON(1, TEST_PLD_PLDW, TEST_LDRD); 
