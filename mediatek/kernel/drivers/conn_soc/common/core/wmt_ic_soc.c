...
static UCHAR WMT_COEX_FILTER_SPEC_CMD_6752[] = {
...
static UCHAR WMT_COEX_LTE_FREQ_IDX_TABLE_CMD_6752[] = {
...
mtk_wcn_soc_patch_dwn (UINT32 index)
{
  ...
  /* reserve 1st patch cmd space before patch body
    ...
    /*send wmt part patch address command*/
        if(0x6752 == wmt_ic_ops_soc.icId || 0x8127 == wmt_ic_ops_soc.icId || 0x6571 == wmt_ic_ops_soc.icId)
        {
