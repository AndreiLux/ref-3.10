...
{
	int (*enable_hw_batch)(int handle, int enable, long long samplingPeriodNs,long long maxBatchReportLatencyNs);//let the hardware know that data should be written to fifo
...
extern int batch_register_support_info(int handle, int support, int div);
#endif
