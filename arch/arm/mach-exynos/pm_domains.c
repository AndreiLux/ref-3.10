	...
	if (likely(pd->base)) {
		...
		while ((__raw_readl(pd->base+0x4) & EXYNOS_INT_LOCAL_PWR_EN) != power_flags) {
			if (timeout == 0) {
				...
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_SRC_MASK_TOP2", readl(EXYNOS5_CLK_SRC_MASK_TOP2));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_SRC_MASK_TOP0", readl(EXYNOS5_CLK_SRC_MASK_TOP0));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_SRC_MASK_DISP10", readl(EXYNOS5_CLK_SRC_MASK_DISP10));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_GATE_BUS_NOC", readl(EXYNOS5_CLK_GATE_BUS_NOC));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_GATE_BUS_DISP1", readl(EXYNOS5_CLK_GATE_BUS_DISP1));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_GATE_IP_DISP1", readl(EXYNOS5_CLK_GATE_IP_DISP1));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_GATE_TOP_SCLK_DISP1", readl(EXYNOS5_CLK_GATE_TOP_SCLK_DISP1));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_SRC_MASK_TOP1", readl(EXYNOS5_CLK_SRC_MASK_TOP1));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_GATE_BUS_GSCL1", readl(EXYNOS5_CLK_GATE_BUS_GSCL1));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_GATE_IP_GSCL0", readl(EXYNOS5_CLK_GATE_IP_GSCL0));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5422_DISP1_OPTION", readl(EXYNOS5422_DISP1_OPTION));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5422_CMU_CLKSTOP_DISP1_SYS_PWR_REG", readl(EXYNOS5422_CMU_CLKSTOP_DISP1_SYS_PWR_REG));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5422_CMU_SYSCLK_DISP1_SYS_PWR_REG", readl(EXYNOS5422_CMU_SYSCLK_DISP1_SYS_PWR_REG));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5422_CMU_RESET_DISP1_SYS_PWR_REG", readl(EXYNOS5422_CMU_RESET_DISP1_SYS_PWR_REG));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5422_DISP1_CONFIGURATION", readl(EXYNOS5422_DISP1_CONFIGURATION));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5422_DISP1_STATUS", readl(EXYNOS5422_DISP1_STATUS));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_SRC_DISP10", readl(EXYNOS5_CLK_SRC_DISP10));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_SRC_TOP0", readl(EXYNOS5_CLK_SRC_TOP0));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_SRC_TOP10", readl(EXYNOS5_CLK_SRC_TOP10));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_SRC_TOP3", readl(EXYNOS5_CLK_SRC_TOP3));
				pr_info("$$$$$$$$$ %s : %08X\n","EXYNOS5_CLK_SRC_TOP2", readl(EXYNOS5_CLK_SRC_TOP2));
