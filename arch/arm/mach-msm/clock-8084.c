...
static struct clk_lookup apq_clocks_8084[] = {
    ...
    CLK_LOOKUP("nfc_clk",			 bb_clk2_a_pin.c, NULL),
#else
...
#endif
#if defined(CONFIG_SEC_LENTIS_PROJECT) && defined(CONFIG_MSMB_CAMERA)
	CLK_LOOKUP("iface_clk", gcc_blsp2_ahb_clk.c,	"f9968000.i2c"),
#endif
...
#elif defined(CONFIG_SEC_LENTIS_PROJECT) && defined(CONFIG_MSMB_CAMERA)
	CLK_LOOKUP("core_clk",	gcc_blsp2_qup6_i2c_apps_clk.c,	"f9968000.i2c"),
#else
