...
static void apq8084_check_gpio_status(unsigned char phonestate)
{
...
/* Define appropriate variable in accordance with
	the specification of each BB vendor */
static struct gpio_dvs apq8084_gpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = apq8084_check_gpio_status,
	.count = AP_GPIO_COUNT,
};
/****************************************************************/
#endif
...
static struct platform_device secgpio_dvs_device = {
	 ...
	 ***************************************************************/
	.dev.platform_data = &apq8084_gpio_dvs,
};
