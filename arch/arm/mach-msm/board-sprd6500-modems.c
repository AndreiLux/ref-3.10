...
#define GPIO_GSM_PHONE_ON	304 /* GPIO_EXPANDER P0_4 pin */
#define GPIO_PDA_ACTIVE		305 /* GPIO_EXPANDER P0_5 pin */
#define GPIO_PHONE_ACTIVE	86
#define GPIO_AP_CP_INT1		0xFFF
#define GPIO_AP_CP_INT2		0xFFF

#define GPIO_UART_SEL		306 /* GPIO_EXPANDER P0_6 pin */
...
{
	if (sprd6500_is_qc_gpio(GPIO_GSM_PHONE_ON))	{
	...
	if (sprd6500_is_qc_gpio(GPIO_PDA_ACTIVE))	{
	...
	if (sprd6500_is_qc_gpio(GPIO_UART_SEL))	{
