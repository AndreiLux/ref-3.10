...
#define FH_SFSTRX_DYS  (0xFU<<28)
#define FH_SFSTRX_DTS  (0xFU<<24)
#define FH_FRDDSX_DYS (0xFU<<20)
#define FH_FRDDSX_DTS (0xFU<<16)
...
/* FHCTL */
/* PLLx CTL */
#define FHCTLx_CFG(pll_id) (FHCTL_BASE + 0x0050 + (pll_id * 0x14))
#define FHCTLx_UPDNLMT(pll_id) (FHCTL_BASE + 0x0054 + (pll_id * 0x14))
#define FHCTLx_DDS(pll_id) (FHCTL_BASE + 0x0058 + (pll_id * 0x14))
#define FHCTLx_DVFS(pll_id) (FHCTL_BASE + 0x005C + (pll_id * 0x14))
#define FHCTLx_MON(pll_id) (FHCTL_BASE + 0x0060 + (pll_id * 0x14))
...
#define fh_read8(reg)           __raw_readb((void const *)reg)
#define fh_read16(reg)          __raw_readw((void const *)reg)
#define fh_read32(reg)          __raw_readl((void const *)reg)
#define fh_write8(reg, val)      mt65xx_reg_sync_writeb((val), (void const *)(reg))
#define fh_write16(reg, val)     mt65xx_reg_sync_writew((val), (void const *)(reg))
#define fh_write32(reg, val)     mt65xx_reg_sync_writel((val), (void const *)(reg))
