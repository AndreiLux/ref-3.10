...
static __initdata struct tegra_pingroup_config flounder_pinmux_common[] = {
	...
	GPIO_PINMUX(GPIO_PBB6, PULL_DOWN, NORMAL, INPUT, DISABLE),
	...
	GPIO_PINMUX(GPIO_PI2, PULL_UP, NORMAL, OUTPUT, DISABLE),
	...
	GPIO_PINMUX(KB_ROW3, PULL_UP, NORMAL, OUTPUT, DISABLE),
	...
	/*radio start*/
	GPIO_PINMUX(ULPI_DATA0, NORMAL, NORMAL, OUTPUT, DISABLE), //AP2MDM_WAKEUP#PO1
	GPIO_PINMUX(ULPI_DATA1, NORMAL, NORMAL, OUTPUT, DISABLE), //AP2MDM_STATUS#PO2
	GPIO_PINMUX(ULPI_DATA2, NORMAL, NORMAL, OUTPUT, DISABLE), //AP2MDM_ERR_FATAL#PO3
	GPIO_PINMUX(ULPI_DATA3, NORMAL, NORMAL, OUTPUT, DISABLE), //AP2MDM_IPC1#PO4 (flashlight feature)
	GPIO_PINMUX(ULPI_DATA4, NORMAL, NORMAL, OUTPUT, DISABLE), //AP2MDM_IPC2#PO5 (EFS SYNC)
	GPIO_PINMUX(ULPI_DATA5, NORMAL, NORMAL, OUTPUT, DISABLE), //AP2MDM_VDDMIN#PO6 (reserved)
	GPIO_PINMUX(ULPI_DATA6, NORMAL, NORMAL, OUTPUT, DISABLE), //AP2MDM_PON_RESET_N#PO7
	GPIO_PINMUX(KB_COL7, NORMAL, NORMAL, OUTPUT, DISABLE), //AP2MDM_CHNL_RDY_CPU (reserved)
	GPIO_PINMUX(KB_ROW8,  NORMAL, NORMAL, OUTPUT, DISABLE), //MDM2AP_IPC3#PS0 (reserved)
...
static struct gpio_init_pin_info init_gpio_mode_flounder_common[] = {
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PI2, false, 1),
...
/* key end */
	...
	*/
	...
	/*radio start*/
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PO1, false, 0), //AP2MDM_WAKEUP#PO1
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PO2, false, 0), //AP2MDM_STATUS#PO2
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PO3, false, 0), //AP2MDM_ERR_FATAL#PO3
