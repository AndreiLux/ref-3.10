...
static struct tegra_dc_sd_settings dsi_j_qxga_8_9_sd_settings = {
        ...
        .use_auto_pwm = false,
        .hw_update_delay = 0,
        .bin_width = 4, /* Dependent on soft_clipping_threshold if soft_clipping_correction is true */
        .aggressiveness = 3,
        .use_vid_luma = false,
        ...
        .soft_clipping_correction = true,
        .soft_clipping_recip_offset = -145,
...
static int dsi_j_qxga_8_9_bl_notify(struct device *unused, int brightness)
{
	...
	if (brightness > 255 || brightness < 0) {
		pr_info("Error: Brightness (%d) out of range!\n", brightness);
		return brightness;
	}
