...
static int set_memory_np(unsigned long virt, int numpages)
{
	return set_page_attributes(virt, numpages, pte_mknp);
}

static int set_memory_p(unsigned long virt, int numpages)
{
	return set_page_attributes(virt, numpages, pte_mkp);
}
...
void kernel_map_pages(struct page *page, int numpages, int enable)
{
	...
	if (enable)
		set_memory_p(virt, numpages);
	else
		set_memory_np(virt, numpages);
}
