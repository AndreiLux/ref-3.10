...
static int synaptics_rmi4_parse_dt(struct device *dev, struct synaptics_dsx_platform_data *p_data)
 {
	...
	of_property_read_u32(node, "s7020,attn_gpio", &p_data->irq_gpio);
	of_property_read_u32(node, "s7020,odin_madk", &p_data->reset_gpio);
...
static int __init synaptics_rmi4_init(void)
{
	...
	if( odin_pmic_revision_get() == MADK_V1_2)
	{
