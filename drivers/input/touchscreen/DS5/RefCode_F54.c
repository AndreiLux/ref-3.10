		...
		case 0x54:
			if (!bHaveF54) {
				...
				if (bHaveSignalClarity) {
					...
					offset++; /*Ctrl 41*/
					bHaveF54Ctrl41 = true;/*bHaveF54Ctrl41 = bSignalClarityOn*/
				}
				...
				bHaveCtrl98  = ((Data[query_offset]
							& 0x20) == 0x20);
				bHaveF54Query24  = ((Data[query_offset]
							& 0x80) == 0x80);
				if (bHaveF54Query22)
				...
				bHaveF54Query23 = ((Data[query_offset]
							& 0x8) == 0x8);
				bHaveF54Query26 = ((Data[query_offset]
							& 0x10) == 0x10);
				bHaveF54Ctrl103 = ((Data[query_offset]
							& 0x10) == 0x10);
				bHaveF54Ctrl104 = ((Data[query_offset]
							& 0x20) == 0x20);
				bHaveF54Ctrl105 = ((Data[query_offset]
							& 0x40) == 0x40);
				bHaveF54Query28 = ((Data[query_offset]
							& 0x80) == 0x80);
				if (bHaveF54Query23) {
