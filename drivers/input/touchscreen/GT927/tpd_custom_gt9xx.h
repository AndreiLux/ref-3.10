...
0x41, 0x00, 0x05, 0x20, 0x03, 0x0A, 0x3D, 0x00,\
...
#else
#define GTP_MAX_HEIGHT   (p_gt9xx_platform_data->gtp_max_height)	/* 1280 */
#define GTP_MAX_WIDTH    (p_gt9xx_platform_data->gtp_max_width)	/* 800 */
