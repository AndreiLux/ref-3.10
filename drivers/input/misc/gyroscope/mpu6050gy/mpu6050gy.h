...
#define MPU6050GY_I2C_SLAVE_ADDR		(0xD0+2)	/* mtk i2c not allow to probe two same address */
#else
#define MPU6050GY_I2C_SLAVE_ADDR2		0xD0
#endif
...
#define MPU6050_REG_CFG             0x1A	/* set external sync,
						full-scale range and sample rate, low pass filter bandwidth */
...
/* for MPU6050_REG_CFG */
#define MPU6050_EXT_SYNC			0x03	/* 0x05 */
/* captue the state of external frame sync input pin to insert into LSB of registers */
