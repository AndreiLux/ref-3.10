...
/*DPCD 0x00518*/
#define DPCD_DOWN_STREAM_STATUS_1  0x18
#define DPCD_DOWN_STRM_HPD 0x01/*bit definition*/
...
#define SP_RX_7730_HDMI_SYSTEM_STATUS 0x01
#define DS_HPD_STATUS 0x08/*bit definition*/
