...
#define GPIO_MDM2AP_HSIC_READY		EXYNOS5_GPF2(2)
#define GPIO_AP2MDM_STATUS		EXYNOS5_GPF1(6)
#define GPIO_MDM2AP_HSIC_PWR_ACTIVE	EXYNOS5_GPX1(6)	/* AP2MDM_IPC2 */
#define GPIO_WCN_PRIORITY		EXYNOS5_GPF2(3)
#define GPIO_AP2MDM_ERR_FATAL		EXYNOS5_GPA0(1)
#define GPIO_AP2MDM_PON_RESET_N		EXYNOS5_GPA0(1)
#define GPIO_AP2MDM_WAKEUP		EXYNOS5_GPA0(1)
#define GPIO_AP2MDM_SOFT_RESET		EXYNOS5_GPM3(3)
#define GPIO_MDM2AP_STATUS		EXYNOS5_GPX0(5)
#define GPIO_MDM2AP_HSIC_RESUME_REQ	EXYNOS5_GPX0(6)	/* AP2MDM_IPC3 */
#define GPIO_AP2MDM_VDDMIN		EXYNOS5_GPX1(0)
#define GPIO_MDM2AP_VDDMIN		EXYNOS5_GPX1(1)
#define GPIO_MDM2AP_ERR_FATAL		EXYNOS5_GPX1(2)
#define GPIO_AP2MDM_HSIC_PORT_ACTIVE	EXYNOS5_GPX3(2)	/* AP2MDM_IPC1 */
#define GPIO_AP2MDM_PMIC_RESET_N	EXYNOS5_GPY2(3)
...
static struct mdm_platform_data mdm_platform_data = {
	...
	/* this value is initialized in s5p_ehci_probe function */
