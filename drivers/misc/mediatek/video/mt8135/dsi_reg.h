...
extern "C" {
	...
	typedef struct {
		unsigned RG_DSI0_MPPLL_VOD_EN:1;
	...
	typedef struct {
		unsigned RG_DSI0_MPPLL_SDM_PCW:31;
		unsigned rsv_31:1;
	...
	typedef struct {
		unsigned RG_DSI0_MPPLL_ISO_EN:1;
		unsigned RG_BY_ISO_DLY:1;
		unsigned RG_DSI0_MPPLL_PWR_ON:1;
		unsigned RG_BY_PWR_DLY:1;
		unsigned RSV_ATPG_CON:1;
		unsigned rsv_19:19;
		unsigned DSI0_MPPLL_PWR_ACK:1;
		unsigned rsv_7:7;
	} MIPITX_DSI0_MPPLL_SDM_CON1_REG, *PMIPITX_DSI0_MPPLL_SDM_CON1_REG;

	typedef struct {
		unsigned DSI0_MPPLL_ISO_TIMER0:8;
		unsigned DSI0_MPPLL_IS0_TIMER1:8;
		unsigned DSI0_MPPLL_PWR_TIMER0:8;
		unsigned DSI0_MPPLL_PWR_TIMER1:8;
	} MIPITX_DSI0_MPPLL_SDM_CON2_REG, *PMIPITX_DSI0_MPPLL_SDM_CON2_REG;
	...
	typedef struct {
		...
		MIPITX_DSI_PLL_TOP_REG MIPITX_DSI_PLL_TOP;	/* 0060 */
		MIPITX_DSI_RGS_REG MIPITX_DSI_RGS;	/* 0064 */
		MIPITX_DSI_GPIO_EN_REG MIPITX_DSI_GPIO_EN;	/* 0068 */
		MIPITX_DSI_GPIO_OUT_REG MIPITX_DSI_GPIO_OUT;	/* 006c */
		UINT32 rsv_70[4];	/* 0070~7c */
		...
		UINT32 rsv_8C;	/* 008C */
		MIPITX_DSI0_MPPLL_SDM_CON1_REG MIPITX_DSI0_MPPLL_SDM_CON1;	/* 0090 */
		MIPITX_DSI0_MPPLL_SDM_CON2_REG MIPITX_DSI0_MPPLL_SDM_CON2;	/* 0094 */
