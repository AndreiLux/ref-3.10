...
#define DISP_DEFAULT_UI_LAYER_ID LCD_LAYER_2
#define DISP_CHANGED_UI_LAYER_ID LCD_LAYER_3
#else
...
/* LCD Controller Interface */
	LCD_STATUS LCD_ConfigParallelIF(LCD_IF_ID id,
					...
					UINT32 readSetup,
					UINT32 readHold,
					UINT32 readLatency, UINT32 waitPeriod, UINT32 chw);
...
/* MT6573 added */
	...
	LCD_STATUS LCD_LayerGetInfo(LCD_LAYER_ID id, UINT32 *enabled, INT32 *curr_idx,
				    INT32 *next_idx);
...
int m4u_insert_tlb_range_stub(M4U_MODULE_ID_ENUM eModuleID, unsigned int MVAStart,
				const unsigned int MVAEnd, M4U_RANGE_PRIORITY_ENUM ePriority,
				unsigned int entryCount);
int m4u_invalid_tlb_range_stub(M4U_MODULE_ID_ENUM eModuleID, unsigned int MVAStart, unsigned int MVAEnd);
