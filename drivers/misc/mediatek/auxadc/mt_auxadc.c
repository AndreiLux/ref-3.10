...
static long auxadc_cali_unlocked_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case SET_ADC_CALI_Slop:
		...
		/*
		for (i = 0; i < ADC_CHANNEL_MAX; i++)
			pr_info("auxadc_cali_slop[%d] = %d\n", i, *(auxadc_cali_slop + i));
		pr_info("**** MT auxadc_cali ioctl : SET_ADC_CALI_Slop Done!\n");
		*/
	...
	case SET_ADC_CALI_Offset:
		...
		/*
		for (i = 0; i < ADC_CHANNEL_MAX; i++)
			pr_info("auxadc_cali_offset[%d] = %d\n", i, *(auxadc_cali_offset + i));
		pr_info("**** MT auxadc_cali ioctl : SET_ADC_CALI_Offset Done!\n");
		*/
	...
	case SET_ADC_CALI_Cal:
		...
		/*
		for (i = 0; i < 1; i++)
			pr_info("auxadc_cali_cal[%d] = %d\n", i, *(auxadc_cali_cal + i));
		pr_info("**** MT auxadc_cali ioctl : SET_ADC_CALI_Cal Done!\n");
		*/
	...
	case ADC_CHANNEL_READ:
		...
		pr_info("this api is removed !!\n");
		ret = copy_to_user(user_data_addr, auxadc_out_data, 8);
		pr_info("**** ioctl : AUXADC Channel %d * %d times = %d\n", auxadc_in_data[0],
					   ...
					   char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_0_Slope : %d\n", ret_value);
...
{
	pr_info("[EM] Not Support Write Function\n");
	return size;
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_0_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					   ...
					   char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_1_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_1_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					   ...
					   char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_2_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_2_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					   ...
					   char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_3_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_3_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					   ...
					   char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_4_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_4_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					   ...
					   char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_5_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_5_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					   ...
					   char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_6_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_6_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					   ...
					   char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_7_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_7_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					   ...
					   char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_8_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_8_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					   ...
					   char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_9_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_9_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_10_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					     ...
					     char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_10_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_11_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					     ...
					     char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_11_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_12_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					     ...
					     char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_12_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_13_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					     ...
					     char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_13_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_14_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					     ...
					     char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_14_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					    ...
					    char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_15_Slope : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
					     ...
					     char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_15_Offset : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
						  ...
						  char *buf)
{
	...
	pr_info("[EM] AUXADC_Channel_Is_Calibration : %d\n", ret_value);
	return sprintf(buf, "%u\n", ret_value);
}
...
static ssize_t store_AUXADC_register(struct device *dev, struct device_attribute *attr,
				     const char *buf, size_t size)
{
	pr_info("[EM] Not Support store_AUXADC_register\n");
	return size;
}
...
static ssize_t show_AUXADC_chanel(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	for (i = 0; i < 5; i++) {
		...
		if (res < 0) {
			pr_info("[adc_driver]: get data error\n");
			break;

		} else {
			pr_info("[adc_driver]: channel[%d]=%d.%d\n", i, data[0], data[1]);
	...
	while (g_start_debug_thread) {
		for (i = 0; i < ADC_CHANNEL_MAX; i++) {
			...
			if (res < 0) {
				...
				pr_info("[adc_driver]: channel[%d]raw =%d\n", i, rawdata);
				pr_info("[adc_driver]: channel[%d]=%d.%.02d\n", i, data[0],
					data[1]);

			}
			res = IMM_auxadc_GetOneChannelValue_Cali(i, &cali_voltage);
			if (res < 0) {
				pr_info("[adc_driver]: get cali voltage error\n");
				break;

			} else {
				pr_info("[adc_driver]: channel[%d] cali_voltage =%d\n", i,
					cali_voltage);
				    ...
				    const char *buf, size_t size)
{
	...
	if (sscanf(buf, "%u", &start_flag) != 1) {
		pr_info("[adc_driver]: Invalid values\n");
		return -EINVAL;
	}

	pr_info("[adc_driver] start flag =%d\n", start_flag);
	...
	if (1 == start_flag) {
		...
		if (IS_ERR(thread)) {
			...
			pr_info("[adc_driver] failed to create kernel thread: %d\n", error);
		}
	}
...
static int mt_auxadc_create_device_attr(struct platform_device *dev)
{
	int ret = 0;
	/* For EM */
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_register);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_read_channel);
	if (ret != 0)
		goto exit;
#if ADC_CHANNEL_MAX > 0
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_0_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_0_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 1
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_1_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_1_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 2
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_2_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_2_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 3
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_3_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_3_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 4
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_4_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_4_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 5
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_5_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_5_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 6
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_6_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_6_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 7
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_7_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_7_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 8
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_8_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_8_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 9
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_9_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_9_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 10
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_10_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_10_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 11
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_11_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_11_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 12
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_12_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_12_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 13
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_13_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_13_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 14
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_14_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_14_Offset);
	if (ret != 0)
		goto exit;
#endif
#if ADC_CHANNEL_MAX > 15
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_15_Slope);
	if (ret != 0)
		goto exit;
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_15_Offset);
	if (ret != 0)
		goto exit;
#endif
	ret = device_create_file(&(dev->dev), &dev_attr_AUXADC_Channel_Is_Calibration);
	if (ret != 0)
		goto exit;
...
static int adc_channel_info_init(void)
{
	...
	pr_info("[ADC] channel_name = %s channel num=%d\n",
...
static int mt_auxadc_probe(struct platform_device *dev)
{
	...
	if (ret)
		pr_info("auxadc_cali Error: cdev_add\n");
	...
	class_dev = (struct class_device *)device_create(auxadc_cali_class,
							 ...
							 AUXADC_CALI_DEVNAME);
	/* pr_info("[MT AUXADC_probe] NVRAM prepare : done !!\n"); */
...
{
	/* pr_info("******** MT auxadc driver resume!! ********\n" ); */
	/*
	   if(enable_clock(MT_PDN_PERI_AUXADC,"AUXADC"))
	   {
	   pr_info("hwEnableClock AUXADC again!!!.");
	   if(enable_clock(MT_PDN_PERI_AUXADC,"AUXADC"))
	   {pr_info("hwEnableClock AUXADC failed.");}
...
static int __init mt_auxadc_init(void)
{
	...
	if (ret) {
		pr_info("****[mt_auxadc_driver] Unable to register driver (%d)\n", ret);
		return ret;
	}
	pr_info("****[mt_auxadc_driver] Initialization : DONE\n");
	return 0;
}
