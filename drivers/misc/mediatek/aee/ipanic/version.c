...
int ipanic_write_log_buf(unsigned int off, struct ipanic_log_index start,
...
int ipanic_write_log_buf(struct mtd_info *mtd, unsigned int off, struct ipanic_log_index start,
			 struct ipanic_log_index end)
{
