...
#define MD_IMG_RESRVED_SIZE		(0x500000)	/* 5MB */
#define MD_RW_MEM_RESERVED_SIZE	(0x1100000)	/* 17MB */
...
/* For MD2 */
#define MOEDM_SYS1_IMAGE_NAME "modem_sys2.img"

#define MOEDM_SYS1_IMAGE_E1_NAME "modem_sys2_E1.img"

#define MOEDM_SYS1_IMAGE_E2_NAME "modem_sys2_E2.img"
...
typedef struct {
	...
	U8 md_sys_id;		/* MD_SYS1: 1, MD_SYS2: 2 */
	U8 dummy2;
	U32 dummy3[7];
} GFH_FILE_INFO_v1;
...
extern int ccci_load_firmware(int md_sys_id, unsigned int load_flag, char img_err_str[], int len);
