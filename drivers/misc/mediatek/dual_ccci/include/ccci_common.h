...
#define CCCI_MSG(fmt, args...)	pr_info("[ccci]" fmt, ##args)
#define CCCI_RAW		printk
/* #define CCCI_DEBUG_MSG(format, ...) pr_info("CCCI :" format, __VA_ARGS__) */
...
#define CCCI_MSG(fmt, args...)		pr_err("[ccci/com] (0)" fmt, ##args)
#define CCCI_MSG_INF(idx, tag, fmt, args...)	pr_err("[ccci/" tag "] (%d)" fmt, (idx+1), ##args)
#define CCCI_DBG_MSG(idx, tag, fmt, args...)	pr_debug("[ccci/" tag "] (%d)" fmt, (idx+1), ##args)
#define CCCI_DBG_COM_MSG(fmt, args...)		pr_debug("[ccci/com] (0)" fmt, ##args)
