...
void DpEngine_COLORonConfig(unsigned int srcWidth, unsigned int srcHeight)
{
	...
	/* 0x040C  WIN_X_MAIN  32
	Window X    Window X    COLOR_CFG   WrWIN_X
	31  16  win_x_end   RW  PUBLIC  16'hFFFF        X end for processing window */
	...
	for (index = 0; index < 8; index++) {
		DISP_REG_SET(Y_SLOPE_1_0_MAIN + 4 * index,
	...
	DISP_REG_SET(DISP_COLOR_CK_ON, 0x1);
	/* *(volatile kal_uint32 *)(0x1400A000 + 0xf28) = 0x1;   //Force clock on when program SRAM (only in 6589) */
	...
	for (index = 0; index < 3; index++) {
		...
		u4Temp =
		    (g_Color_Index.PURP_TONE_S[g_Color_Param.u4SatAdj[PURP_TONE]][SP1][index]) +
		    (g_Color_Index.
		     PURP_TONE_S[g_Color_Param.u4SatAdj[PURP_TONE]][SP2][index] << 8) +
		    (g_Color_Index.
		     PURP_TONE_S[g_Color_Param.u4SatAdj[PURP_TONE]][SG1][index] << 16) +
		    (g_Color_Index.
		     PURP_TONE_S[g_Color_Param.u4SatAdj[PURP_TONE]][SG2][index] << 24);
	...
	for (index = 0; index < 14; index++) {
		...
		u4Temp =
		    (g_Color_Index.SKIN_TONE_S[g_Color_Param.u4SatAdj[SKIN_TONE]][SP1][index]) +
		    (g_Color_Index.
		     SKIN_TONE_S[g_Color_Param.u4SatAdj[SKIN_TONE]][SP2][index] << 8) +
		    (g_Color_Index.
		     SKIN_TONE_S[g_Color_Param.u4SatAdj[SKIN_TONE]][SG1][index] << 16) +
		    (g_Color_Index.
		     SKIN_TONE_S[g_Color_Param.u4SatAdj[SKIN_TONE]][SG2][index] << 24);
		DISP_REG_SET(LOCAL_SAT_3, u4Temp);	/* LOCAL_SAT_3: SRAM addr increment trigger */
	...
	for (index = 0; index < 8; index++) {
		u4Temp =
		    (g_Color_Index.GRASS_TONE_S[g_Color_Param.u4SatAdj[GRASS_TONE]][SG3][index]);
		DISP_REG_SET(LOCAL_SAT_4, u4Temp);

		u4Temp =
		    (g_Color_Index.GRASS_TONE_S[g_Color_Param.u4SatAdj[GRASS_TONE]][SP1][index]) +
		    (g_Color_Index.
		     GRASS_TONE_S[g_Color_Param.u4SatAdj[GRASS_TONE]][SP2][index] << 8) +
		    (g_Color_Index.
		     GRASS_TONE_S[g_Color_Param.u4SatAdj[GRASS_TONE]][SG1][index] << 16) +
		    (g_Color_Index.
		     GRASS_TONE_S[g_Color_Param.u4SatAdj[GRASS_TONE]][SG2][index] << 24);
		DISP_REG_SET(LOCAL_SAT_3, u4Temp);	/* LOCAL_SAT_3: SRAM addr increment trigger */
