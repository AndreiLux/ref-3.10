...
{
	gpio_request(GPIO_LCD_RST_EN, "LCD-RST");
	gpio_request(GPIO_LCD_STB_EN, "LCD-STB");
}

static void lcm_res_exit(void)
{
	gpio_free(GPIO_LCD_RST_EN);
	gpio_free(GPIO_LCD_STB_EN);
}
...
static void lcm_init(void)
{
	...
	mt_pin_set_mode_gpio(GPIO_LCD_STB_EN);
	gpio_direction_output(GPIO_LCD_STB_EN, 1);
	MDELAY(20);
...
static void lcm_suspend(void)
{
	...
	mt_pin_set_mode_gpio(GPIO_LCD_STB_EN);
	gpio_direction_output(GPIO_LCD_STB_EN, 0);
	MDELAY(20);
