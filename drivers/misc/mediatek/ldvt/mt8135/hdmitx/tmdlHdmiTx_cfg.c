...
/* xuecheng, correct yuv444 setting? yvu. */
...
tmdlHdmiTxCfgVideoSignal422 videoPortMapping_YUV422[MAX_UNITS][6] = {
	{
	 ...
	 TMDL_HDMITX_VID422_Y_0_TO_3,	/* Signals connected to VPC[4..7] */
	 TMDL_HDMITX_VID422_UV_0_TO_3,	/* Signals connected to VPB[0..3] */
#endif
...
/* change the enum to specify which signal you connected to it. See file      */
/* tmdlHdmiTx_cfg.h to get the list of possible values                        */
tmdlHdmiTxCfgVideoSignalCCIR656 videoPortMapping_CCIR656[1][6] = {
	{
	 TMDL_HDMITX_VIDCCIR_NOT_CONNECTED,
	 TMDL_HDMITX_VIDCCIR_0_TO_3,	/* Signals connected to VPC[4..7] */
