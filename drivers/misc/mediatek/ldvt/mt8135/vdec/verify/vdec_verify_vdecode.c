...
void vVerifySetUpParm(UINT32 u4InstID, UINT32 dwPicW, UINT32 dwPicH, UINT32 dwFrmRatCod,
		      BOOL fgDivXM4v, BOOL fgDx4M4v);
...
void vVerifyWMVInitProc(UINT32 u4InstID)
{
	...
	if (_i4CodecVersion[u4InstID] == VDEC_VC1) {
		...
		i4VDEC_HAL_WMV_InitBarrelShifter(_u4BSID[u4InstID], u4InstID, &rWmvBSInitPrm,
						 FALSE);
	}
}
	...
	case DEC_NORM_INIT_PRM:
		...
		if (TRUE == _fgTestBarrelShift) {
			if (_u4CodecVer[u4InstID] == VDEC_WMV) {
				rWmvVFifoInitPrm.u4CodeType = _i4CodecVersion[u4InstID];
				rWmvVFifoInitPrm.u4VFifoSa = (UINT32) _pucVFifo[u4InstID];
				rWmvVFifoInitPrm.u4VFifoEa =
				    (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
				i4VDEC_HAL_WMV_InitVDecHW(u4InstID, &rWmvVFifoInitPrm);
				rWmvBSInitPrm.u4VFifoSa = (UINT32) _pucVFifo[u4InstID];
				rWmvBSInitPrm.u4VFifoEa = (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
				rWmvBSInitPrm.u4ReadPointer = (UINT32) _pucVFifo[u4InstID];
				rWmvBSInitPrm.u4WritePointer =
				    (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;

				if (_i4CodecVersion[u4InstID] == VDEC_VC1) {
					i4VDEC_HAL_WMV_InitBarrelShifter(_u4BSID[u4InstID],
									 u4InstID, &rWmvBSInitPrm,
									 TRUE);
				} else {
					i4VDEC_HAL_WMV_InitBarrelShifter(_u4BSID[u4InstID],
									 u4InstID, &rWmvBSInitPrm,
...
void vVerInitVDec(UINT32 u4InstID)
{
		...
		/* if(_u4CodecVer[u4InstID] == VDEC_H264) */
	{
...
#if AVC_8320_SUPPORT
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.u4VLDWrapperWrok =
		    (UINT32) _pucVLDWrapperWrok[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.u4PPWrapperWrok =
		    (UINT32) _pucPPWrapperWork[u4InstID];
#endif
		...
		rH264VDecInitPrm.u4CompModelValue =
		    (UINT32) (_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.prSEI->
			      pucCompModelValue);
...
/* rMPEGBSInitPrm.u4WritePointer = (UINT32)_pucVFifo[u4InstID] + (V_FIFO_SZ*(0.5 + 0.5 *(_u4LoadBitstreamCnt[u4InstID]%2))); */
		...
		if (_u4CodecVer[u4InstID] == VDEC_MPEG2) {
			...
			_u4DIVX3Width[u4InstID] =
			    (((temp & 0x00ff0000) >> 16) << 8) + ((temp & 0xff000000) >> 24);
			temp = u4VDEC_HAL_MPEG_GetBitStreamShift(_u4BSID[u4InstID], u4InstID, 32);
			_u4DIVX3Height[u4InstID] =
			    (((temp & 0x00ff0000) >> 16) << 8) + ((temp & 0xff000000) >> 24);
			vVerifySetUpParm(u4InstID, _u4DIVX3Width[u4InstID],
					 _u4DIVX3Height[u4InstID], 4 /*FRC_29_97 */ , FALSE, FALSE);
		}
...
void vVerifyVDecIsrInit(UINT32 u4InstID)
{
	...
	if (u4InstID == 0) {
		...
		/* reg ISR */
		if (request_irq
		    (MT_VDEC_IRQ_ID, vVDec0IrqProc, IRQF_TRIGGER_RISING, "VDEC0_VT", NULL)) {
			ASSERT(0);
		}
	} else if (u4InstID == 1) {
...
void vInitVParserMPEG(UINT32 u4InstID)
{
	...
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.rDep.rM4vDecPrm.
	    prVol = &_rMPEG4VolPrm[u4InstID];
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.rDep.rM4vDecPrm.
	    prVop = &_rMPEG4VopPrm[u4InstID];
}
...
void vSetWMVDecParam(UINT32 u4InstID, VDEC_INFO_DEC_PRM_T *tVerMpvDecPrm)
{
	...
	if (!tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.fgWmvMode) {
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Bp1Sa =
		    (UINT32) _pucBp_1[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Bp2Sa =
		    (UINT32) _pucBp_2[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Bp3Sa =
		    (UINT32) _pucBp_3[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Bp4Sa =
		    (UINT32) _pucBp_4[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Dcac2Sa =
		    (UINT32) _pucDcac_2[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4DcacSa =
		    (UINT32) _pucDcac[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Mv12Sa =
		    (UINT32) _pucMv_1_2[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Mv1Sa =
		    (UINT32) _pucMv_1[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Mv2Sa =
		    (UINT32) _pucMv_2[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Mv3Sa =
		    (UINT32) _pucMv_3[u4InstID];
	} else {
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4DcacNewSa =
		    (UINT32) _pucDcacNew[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4MvNewSa =
		    (UINT32) _pucMvNew[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Bp0NewSa =
		    (UINT32) _pucBp0New[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Bp1NewSa =
		    (UINT32) _pucBp1New[u4InstID];
		tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Bp2NewSa =
		    (UINT32) _pucBp2New[u4InstID];
	}
/* #endif */

	tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Pic0CSa =
	    (UINT32) _pucPic0C[u4InstID];
	tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Pic0YSa =
	    (UINT32) _pucPic0Y[u4InstID];
	tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Pic1CSa =
	    (UINT32) _pucPic1C[u4InstID];
	tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Pic1YSa =
	    (UINT32) _pucPic1Y[u4InstID];
	tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Pic2CSa =
	    (UINT32) _pucPic2C[u4InstID];
	tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Pic2YSa =
	    (UINT32) _pucPic2Y[u4InstID];
	tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Pp1Sa =
	    (UINT32) _pucPp_1[u4InstID];
	tVerMpvDecPrm->SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.u4Pp2Sa =
	    (UINT32) _pucPp_2[u4InstID];
...
BOOL fgVDecProcWMV(UINT32 u4InstID)
{
	...
	if (_u4BSID[u4InstID] == 1) {
		u4Bytes =
		    u4VDEC_HAL_WMV_ReadRdPtr(1, u4InstID, (UINT32) _pucVFifo[u4InstID], &u4Bits);
		rWmvBSInitPrm.u4VFifoSa = (UINT32) _pucVFifo[u4InstID];
		rWmvBSInitPrm.u4VFifoEa = (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
...
void vSetFGTParam(UINT32 u4InstID, VDEC_INFO_H264_FGT_PRM_T *prFGTPrm)
{
	...
	prFGTPrm->pucFGTScrCAddr =
	    _pucDecWorkBuf[u4InstID] + _ptCurrFBufInfo[u4InstID]->u4DramPicSize;
	...
	prFGTPrm->ucMBYSize =
	    (((_ptCurrFBufInfo[u4InstID]->u4H >> (1 - (fgIsFrmPic(u4InstID)))) + 15) >> 4);
	prFGTPrm->u4Ctrl =
	    ((ptVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSEI->
	      u4NumModelValuesMinus1[0] & 0x3) << 0) | ((ptVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.
							 prSEI->
							 u4NumModelValuesMinus1[1] & 0x3) << 2) |
	    ((ptVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSEI->
	      u4NumModelValuesMinus1[2] & 0x3) << 4) | ((ptVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.
							 prSEI->
							 u4NumModelValuesMinus1[2] & 0x3) << 4) |
	    (ptVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSEI->
	     fgFilmGrainCharacteristicsCancelFlag << 8) | (ptVerMpvDecPrm->SpecDecPrm.
							   rVDecH264DecPrm.prSEI->
							   fgCompModelPresentFlag[0] << 9) |
	    (ptVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSEI->
	     fgCompModelPresentFlag[1] << 10) | (ptVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSEI->
						 fgCompModelPresentFlag[2] << 11) |
	    ((ptVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSEI->
	      u4Log2ScaleFactor & 0xfff) << 12) | ((_ptCurrFBufInfo[u4InstID]->
						    i4POC & 0xff) << 16) | (((ptVerMpvDecPrm->
									      SpecDecPrm.
									      rVDecH264DecPrm.
									      prSliceHdr->
									      u4IdrPicId) & 0x7) <<
...
void vSetDownScaleParam(UINT32 u4InstID, BOOL fgEnable, VDEC_INFO_VDSCL_PRM_T *prDownScalerPrm)
{
	...
	if (fgEnable) {
		...
		if (_u4CodecVer[u4InstID] == VDEC_WMV) {
			...
			if ((_rWMVEPS[u4InstID].fgLoopFilter == 1)
			    || (_rWMVPPS[u4InstID].i4Overlap & 1)) {
		...
		if ((prDownScalerPrm->ucPicStruct == TOP_FIELD)
		    || (prDownScalerPrm->ucPicStruct == BOTTOM_FIELD)) {
			dwPicHeightDec = (dwPicHeightDec >> 1);
		}
		if (((_u4CodecVer[u4InstID] == VDEC_WMV)
		     && (_rWMVPPS[u4InstID].i4CurrentTemporalField == 0))
		    || ((_u4CodecVer[u4InstID] == VDEC_H264)
			&& (fgIsDecFlagSet(u4InstID, DEC_FLAG_CHG_FBUF)))
		    || ((!_fgDec2ndFldPic[u4InstID]) && (_u4CodecVer[u4InstID] != VDEC_WMV)
			&& (_u4CodecVer[u4InstID] != VDEC_H264))) {
			if (_u4CodecVer[u4InstID] == VDEC_WMV) {
				...
				prDownScalerPrm->fgYOnly =
				    (fgIsMonoPic(u4InstID) ? (RW_VDSCL_Y_ONLY >> 7) : 0);
#ifdef FGT_SUPPORT
			...
			if (_fgVDSCLEnableRandomTest[u4InstID]) {
				...
				while (TRUE) {
					...
					if (((prDownScalerPrm->u4TrgWidth % 2) == 0)
						...
						if (prDownScalerPrm->u4TrgHeight ==
						    (dwPicHeightDec >> (prDownScalerPrm->ucVdoFmt)))
						{
				...
				if (prDownScalerPrm->ucScrAgent == (RW_VDSCL_SRC_PP >> 2)) {
					if (prDownScalerPrm->ucSpectType ==
					    (RW_VDSCL_SPEC_WMV >> 5)) {
#if 0
						if ((prDownScalerPrm->u4SrcWidth >> 1) >=
						    prDownScalerPrm->u4TrgWidth) {
...
#endif
						if (prDownScalerPrm->ucPicStruct ==
						    TOP_BOTTOM_FIELD) {
							prDownScalerPrm->u4SrcYOffV =
							    (UINT32) ((((UINT32) rand()) % 3) * 2);
							prDownScalerPrm->u4SrcCOffV =
							    (UINT32) ((((UINT32) rand()) % 3) * 2);
						} else {
							prDownScalerPrm->u4SrcYOffV =
							    (UINT32) (((UINT32) rand()) % 5);
							prDownScalerPrm->u4SrcCOffV =
							    (UINT32) (((UINT32) rand()) % 5);
						}
					} else	/* h264 */
					{
						...
						if (prDownScalerPrm->ucPicStruct ==
						    TOP_BOTTOM_FIELD) {
							prDownScalerPrm->u4SrcYOffV =
							    (UINT32) ((((UINT32) rand()) % 4) * 2);
							prDownScalerPrm->u4SrcCOffV =
							    (UINT32) ((((UINT32) rand()) % 2) * 2);
						} else {
							prDownScalerPrm->u4SrcYOffV =
							    (UINT32) (((UINT32) rand()) % 7);
							prDownScalerPrm->u4SrcCOffV =
							    (UINT32) (((UINT32) rand()) % 4);
						}
					}
				} else {
#if 0
					...
					if (prDownScalerPrm->ucPicStruct == TOP_BOTTOM_FIELD) {
						prDownScalerPrm->u4SrcYOffV =
						    (UINT32) ((((UINT32) rand()) % 5) * 2);
						prDownScalerPrm->u4SrcCOffV =
						    (UINT32) ((((UINT32) rand()) % 3) * 2);
					} else {
						prDownScalerPrm->u4SrcYOffV =
						    (UINT32) (((UINT32) rand()) % 9);
						prDownScalerPrm->u4SrcCOffV =
						    (UINT32) (((UINT32) rand()) % 5);
					}
				}
				if (prDownScalerPrm->fgEnColorCvt) {
					prDownScalerPrm->u4SrcYOffH =
					    prDownScalerPrm->u4SrcYOffH -
					    (prDownScalerPrm->u4SrcYOffH % 2);
					prDownScalerPrm->u4SrcYOffV =
					    prDownScalerPrm->u4SrcYOffV -
					    (prDownScalerPrm->u4SrcYOffV % 2);
					prDownScalerPrm->u4SrcCOffH =
					    prDownScalerPrm->u4SrcCOffH -
					    (prDownScalerPrm->u4SrcCOffH % 2);
					prDownScalerPrm->u4SrcCOffV =
					    prDownScalerPrm->u4SrcCOffV -
				...
				if ((prDownScalerPrm->u4TrgWidth + prDownScalerPrm->u4TrgOffH) <
				    1920) {
					prDownScalerPrm->u4DispW =
					    ((((prDownScalerPrm->u4TrgWidth +
						prDownScalerPrm->u4TrgOffH +
						(((UINT32) rand()) %
						 (1920 - prDownScalerPrm->u4TrgWidth -
						  prDownScalerPrm->u4TrgOffH))) + 15) >> 4) << 4);
				} else {
				...
				while (TRUE) {
					...
					if ((prDownScalerPrm->u4TrgHeight >= 8)
					    && (prDownScalerPrm->u4TrgWidth >= 8)
					    && ((prDownScalerPrm->u4TrgWidth % 2) == 0)
					    && ((prDownScalerPrm->u4TrgHeight % 4) == 0)
					    && (prDownScalerPrm->u4TrgWidth <= dwPicWidthDec)
					    && (prDownScalerPrm->u4TrgHeight <=
						(dwPicHeightDec >> (prDownScalerPrm->ucVdoFmt)))) {
			...
			prDownScalerPrm->u4WorkAddr = (UINT32) (_pucVDSCLWorkBuf[u4InstID]);
			vFilledFBuf(u4InstID, _pucVDSCLBuf[u4InstID],
...
#if 0
	if ((_u4CodecVer == WMV) && (_rWMVPPS.i4CurrentTemporalField == 0)
	    && (prDownScalerPrm->fgDSCLEn == TRUE)) {
		vFilledFBuf(_pucVDSCLBuf, _ptCurrFBufInfo->u4DramPicSize);
	} else if ((_u4CodecVer != H264) && (!_fgDec2ndFldPic)
		   && (prDownScalerPrm->fgDSCLEn == TRUE)) {
		vFilledFBuf(_pucVDSCLBuf, _ptCurrFBufInfo->u4DramPicSize);
	}
#endif
...
void vVParserProc(UINT32 u4InstID)
{
		...
		/* if(_u4CodecVer[u4InstID] == VDEC_H264) */
	{
		...
		printk("vVParserProc, u4VLDWrapperWrok = 0x%x\n",
		       _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecWMVDecPrm.rWmvWorkBufSa.
		       u4VLDWrapperWrok);
		...
		vVDecWriteMC(u4InstID, RW_MC_VLD_WRAPPER,
			     PHYSICAL(_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecWMVDecPrm.
				      rWmvWorkBufSa.u4VLDWrapperWrok));
		vVDecWriteMC(u4InstID, RW_MC_PP_WRAPPER,
			     PHYSICAL(_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecWMVDecPrm.
				      rWmvWorkBufSa.u4PPWrapperWrok));
#endif

		_u4CurrPicStartAddr[u4InstID] =
		    u4VDEC_HAL_WMV_ReadRdPtr(_u4BSID[u4InstID], u4InstID,
					     (UINT32) _pucVFifo[u4InstID], &u4VldBit);
		...
		if (fgVParserProcWMV(u4InstID)) {
			...
			if (prWMVPPS->ucPicType == SKIPFRAME) {
				...
				if (_i4CodecVersion[u4InstID] != VDEC_VC1) {
					...
					rWmvBSInitPrm.u4VFifoSa = (UINT32) _pucVFifo[u4InstID];
					rWmvBSInitPrm.u4VFifoEa =
					    (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
					rWmvBSInitPrm.u4ReadPointer =
					    (UINT32) _pucVFifo[u4InstID] + _iSetPos[u4InstID];
#ifndef RING_VFIFO_SUPPORT
					rWmvBSInitPrm.u4WritePointer =
					    (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
#else
					...
					rWmvBSInitPrm.u4VFifoEa =
					    (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
					rWmvBSInitPrm.u4ReadPointer =
					    (UINT32) _pucVFifo[u4InstID] + u4VldByte;
#ifndef RING_VFIFO_SUPPORT
					rWmvBSInitPrm.u4WritePointer =
					    (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
#else
			...
			if (_u4VprErr[u4InstID] == END_OF_FILE) {
				...
				strcpy(_tFileListRecInfo[u4InstID].bFileName,
		...
		vDEC_HAL_COMMON_SetVLDPower(u4InstID, ON);
		_u4CurrPicStartAddr[u4InstID] =
		    u4VDEC_HAL_MPEG_ReadRdPtr(_u4BSID[u4InstID], u4InstID,
					      (UINT32) _pucVFifo[u4InstID], &u4VldBit);
		printk("<vdec> _u4CurrPicStartAddr[%u]=0x%x (%u)\n", u4InstID,
		       _u4CurrPicStartAddr[u4InstID], _u4CurrPicStartAddr[u4InstID]);
		...
		_tVerDec[u4InstID].ucState = DEC_NORM_WAIT_TO_DEC;
	} else if ((_u4CodecVer[u4InstID] == VDEC_DIVX3) || (_u4CodecVer[u4InstID] == VDEC_MPEG4)
		   || (_u4CodecVer[u4InstID] == VDEC_H263)) {
		vDEC_HAL_COMMON_SetVLDPower(u4InstID, ON);
		_u4CurrPicStartAddr[u4InstID] =
		    u4VDEC_HAL_MPEG_ReadRdPtr(_u4BSID[u4InstID], u4InstID,
...
void vVPrsMPEGIPProc(UINT32 u4InstID)
{
	...
	} else			/* Field Picture */
	{
		...
		if (!_fgDec2ndFldPic[u4InstID]) {
			...
			vSetVerBRefBuf(u4InstID, 1 - _u4FRefBufIdx[u4InstID]);
			vSetVerDecBuf(u4InstID, _u4BRefBufIdx[u4InstID]);
			_u4PicStruct[u4InstID] =
			    (_u4PicStruct[u4InstID] ==
			     TOP_FLD_PIC) ? TWO_FLDPIC_TOPFIRST : TWO_FLDPIC_BTMFIRST;
		}
		/* 2nd Field Picture */
		else {
			vSetVerDecBuf(u4InstID, _u4BRefBufIdx[u4InstID]);
...
void vVDecProc(UINT32 u4InstID)
{
	...
	if (_u4CodecVer[u4InstID] == VDEC_RM) {
		vRM_TriggerDecode(u4InstID,
				  &_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.
				  rRMParsPicInfo);
		_tVerDec[u4InstID].ucState = DEC_NORM_WAIT_DECODE;
	} else if (_u4CodecVer[u4InstID] == VDEC_H264)
		/* if(_u4CodecVer[u4InstID] == VDEC_H264) */
	{
#ifdef REDEC
		_u4VLDPosByte[u4InstID] =
		    u4VDEC_HAL_H264_ReadRdPtr(0, u4InstID, (UINT32) _pucVFifo[u4InstID],
					      &_u4VLDPosBit[u4InstID]);
		if (_u4ReDecCnt[u4InstID] > 0) {
			vVerifyVDecSetPicInfo(u4InstID, &_tVerMpvDecPrm[u4InstID]);
		}
#endif
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.ucNalRefIdc =
		    _u4NalRefIdc[u4InstID];

		if (_ucMVCType[u4InstID] == 2) {
			/* Dep View */
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.fgIsAllegMvcCfg =
			    (_u4NalRefIdc[0] > 0) ? 1 : 0;
		} else {
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.fgIsAllegMvcCfg = 0;
		}

		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.fgIsFrmPic =
		    fgIsFrmPic(u4InstID);
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.fgIsIDRPic =
		    fgIsIDRPic(u4InstID);
		/* _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.u4DecWorkBuf = (UINT32)_pucDecWorkBuf[u4InstID]; */
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.prCurrFBufInfo =
		    _ptCurrFBufInfo[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.prCurrFBufInfo->u4YStartAddr =
		    /*PHYSICAL*/((UINT32) _pucDecWorkBuf[u4InstID]);
#ifdef VERIFICATION_DOWN_SCALE
#ifdef DOWN_SCALE_SUPPORT
		/* vSetDownScaleParam(u4InstID, TRUE, &_tDownScalerPrm[u4InstID]); */
		vSetDownScaleParam(u4InstID, TRUE, &(_tVerMpvDecPrm[u4InstID].rDownScalerPrm));
...
/* BSP_InvDCacheRange((UINT32)_pucDPB[u4InstID],DPB_SZ); */
		...
		_u4VLDPosByte[u4InstID] =
		    u4VDEC_HAL_WMV_ReadRdPtr(_u4BSID[u4InstID], u4InstID,
					     (UINT32) _pucVFifo[u4InstID], &_u4VLDPosBit[u4InstID]);
#endif
		...
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.fgDec2ndFld =
		    _fgDec2ndFldPic[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rMpegFrameBufSa.u4Pic0CSa =
		    (UINT32) _pucPic0C[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rMpegFrameBufSa.u4Pic0YSa =
		    (UINT32) _pucPic0Y[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rMpegFrameBufSa.u4Pic1CSa =
		    (UINT32) _pucPic1C[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rMpegFrameBufSa.u4Pic1YSa =
		    (UINT32) _pucPic1Y[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rMpegFrameBufSa.u4Pic2CSa =
		    (UINT32) _pucPic2C[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rMpegFrameBufSa.u4Pic2YSa =
		    (UINT32) _pucPic2Y[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rMpegPpInfo.fgPpEnable =
		    VDEC_PP_ENABLE;
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rMpegPpInfo.u4PpYBufSa =
		    (UINT32) _pucPpYSa[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rMpegPpInfo.u4PpCBufSa =
		    (UINT32) _pucPpCSa[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.u4DecH =
		    ((_tVerMpvDecPrm[u4InstID].u4PicH + 15) >> 4) << 4;
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.u4DecW =
		...
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.u4FRefBufIdx =
		    _u4FRefBufIdx[u4InstID];
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.u4MaxMbl =
		    ((_tVerMpvDecPrm[u4InstID].u4PicH + 15) >> 4) - 1;
		...
		if (_u4CodecVer[u4InstID] == VDEC_MPEG2) {
...
#ifdef DOWN_SCALE_SUPPORT
			/* vSetDownScaleParam(u4InstID, TRUE, &_tDownScalerPrm[u4InstID]); */
			vSetDownScaleParam(u4InstID, TRUE,
					   &(_tVerMpvDecPrm[u4InstID].rDownScalerPrm));
#else
			/* vSetDownScaleParam(u4InstID, FALSE, &_tDownScalerPrm[u4InstID]); */
			vSetDownScaleParam(u4InstID, FALSE,
					   &(_tVerMpvDecPrm[u4InstID].rDownScalerPrm));
#endif
			/* vDEC_HAL_COMMON_SetDownScaler(u4InstID, &_tDownScalerPrm[u4InstID]); */
			/* vVDECSetDownScalerPrm(u4InstID, &_tDownScalerPrm[u4InstID]); */
			...
			if (_u4BSID[u4InstID] == 1) {
				...
				vDEC_HAL_COMMON_SetVLDPower(u4InstID, ON);
				u4Bytes =
				    u4VDEC_HAL_MPEG_ReadRdPtr(1, u4InstID,
							      (UINT32) _pucVFifo[u4InstID],
							      &u4Bits);
				rMpegBSInitPrm.u4VFifoSa = (UINT32) _pucVFifo[u4InstID];
				rMpegBSInitPrm.u4VFifoEa = (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
				rMpegBSInitPrm.u4ReadPointer =
				    (UINT32) _pucVFifo[u4InstID] + u4Bytes;
#ifndef RING_VFIFO_SUPPORT
				rMpegBSInitPrm.u4WritePointer =
				    (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
#else
/* rMpegBSInitPrm.u4WritePointer = (UINT32)_pucVFifo[u4InstID] + (V_FIFO_SZ*(0.5 + 0.5 *(_u4LoadBitstreamCnt[u4InstID]%2))); */
				rMpegBSInitPrm.u4WritePointer = (UINT32) _pucVFifo[u4InstID] + ((_u4LoadBitstreamCnt[u4InstID] % 2) ? (V_FIFO_SZ) : (V_FIFO_SZ >> 1));	/* mtk40343 */
			...
			_u4VLDPosByte[u4InstID] =
			    u4VDEC_HAL_MPEG_ReadRdPtr(_u4BSID[u4InstID], u4InstID,
						      ...
						      &_u4VLDPosBit[u4InstID]);
#endif
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4BcodeSa = (UINT32) _pucMp4Bcode[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4Bmb1Sa = (UINT32) _pucMp4Bmb1[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4Bmb2Sa = (UINT32) _pucMp4Bmb2[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4DcacSa = (UINT32) _pucMp4Dcac[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4MvecSa = (UINT32) _pucMp4Mvec[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4VldWrapperSa = (UINT32) _pucVLDWrapperWrok[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4PPWrapperSa = (UINT32) _pucPPWrapperWork[u4InstID];
			/* 8130NEW 2.4, 2.5, 4.1 */
#if (MPEG4_8130_SUPPORT)
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4DataPartitionSa =
			    (UINT32) _pucMp4DataPartition[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4NotCodedSa = (UINT32) _pucMp4NotCoded[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4MvDirectSa = (UINT32) _pucMp4MvDirect[u4InstID];
#endif
#if (CONFIG_CHIP_VER_CURR >= CONFIG_CHIP_VER_MT8580)
			...
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSize.u4DcacSize = DCAC_SZ;
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSize.u4MVSize = VER_MVEC_SZ;
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSize.u4MB1Size = VER_BMB1_SZ;
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSize.u4MB2Size = VER_BMB2_SZ;
			/* 8130NEW 2.4, 2.5, 4.1(MV Direct size not required) */
#if (MPEG4_8130_SUPPORT)
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSize.u4DataPartitionSize = DATA_PARTITION_SZ;
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSize.u4NotCodedSize = NOT_CODED_SZ;
#endif
#endif
#if (MPEG4_8130_SUPPORT)
			vSetDx3SliceBoundary(u4InstID,
			...
			/* ~PANDA */
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rDep.rM4vDecPrm.prVol = &_rMPEG4VolPrm[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rDep.rM4vDecPrm.prVop = &_rMPEG4VopPrm[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rDep.rM4vDecPrm.prVop->prDirMd = &_rDirMode[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rDep.rM4vDecPrm.prVop->prGmcPrm = &_rMPEG4GmcPrm[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4BcodeSa = (UINT32) _pucMp4Bcode[u4InstID];
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.rPicLayer.rMp4DecPrm.
			    rMpeg4WorkBufSa.u4Bmb1Sa = (UINT32) _pucMp4Bmb1[u4InstID];
			...
			if (0)	/* (_fgReInitBS) */
			{
				...
				vDEC_HAL_COMMON_SetVLDPower(u4InstID, ON);
				u4Bytes =
				    u4VDEC_HAL_MPEG_ReadRdPtr(0, u4InstID,
							      (UINT32) _pucVFifo[u4InstID],
							      &u4Bits);
				rMpegBSInitPrm.u4VFifoSa = (UINT32) _pucVFifo[u4InstID];
				rMpegBSInitPrm.u4VFifoEa = (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
...
void vWMVVDecEnd(UINT32 u4InstID)
{
...
#else
	vWMVWrData2PC(u4InstID, _pucDumpYBuf[u4InstID],
		      ((((_tVerPic[u4InstID].u4W + 15) >> 4) * ((_tVerPic[u4InstID].u4H +
								 31) >> 5)) << 9));
#endif
	...
	if (_u4ReDecCnt[u4InstID] > 0) {
		...
		rWmvBSInitPrm.u4VFifoEa = (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
		rWmvBSInitPrm.u4ReadPointer =
		    (UINT32) _pucVFifo[u4InstID] + _u4VLDPosByte[u4InstID];
#ifndef RING_VFIFO_SUPPORT
		rWmvBSInitPrm.u4WritePointer = (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
#else
/* rWmvBSInitPrm.u4WritePointer = (UINT32)_pucVFifo[u4InstID] + (V_FIFO_SZ*(0.5 + 0.5 *(_u4LoadBitstreamCnt[u4InstID]%2))); */
...
/* rWmvBSInitPrm.u4WritePointer = (UINT32)_pucVFifo[u4InstID] + (V_FIFO_SZ*(0.5 + 0.5 *(_u4LoadBitstreamCnt[u4InstID]%2))); */
	...
	if ((_u4LoadBitstreamCnt[u4InstID] & 0x1) && (rWmvBSInitPrm.u4ReadPointer >
		...
		_tInFileInfo[u4InstID].u4FileOffset =
		    (V_FIFO_SZ * ((_u4LoadBitstreamCnt[u4InstID] + 1) / 2));
		_tInFileInfo[u4InstID].u4TargetSz = (V_FIFO_SZ / 2);
		_tInFileInfo[u4InstID].u4FileLength = 0;
#ifdef SATA_HDD_READ_SUPPORT
		if (!fgOpenHDDFile
		    (u4InstID, _bFileStr1[u4InstID][1], "r+b", &_tInFileInfo[u4InstID])) {
			fgOpenPCFile(u4InstID, _bFileStr1[u4InstID][1], "r+b",
				     &_tInFileInfo[u4InstID]);
		}
#else
...
#if (POWER_TEST_CASE == POWER_TEST_DCM)
		{
			i4VDEC_HAL_Common_Gcon_Enable_After_Complete(u4InstID, VDEC_WMV);
		}
#endif
		vVDEC_HAL_WMV_GetMbxMby(u4InstID, &u4MbX, &u4MbY);
		if (prWMVPPS->ucFrameCodingMode != INTERLACEFIELD) {
			if (u4MbX < ((prWMVSPS->u4PicWidthDec >> 4) - 1)
			    || (u4MbY < ((prWMVSPS->u4PicHeightDec >> 4) - 1))) {
				return FALSE;
			} else {
				return TRUE;
			}
			...
			if (u4MbX < ((prWMVSPS->u4PicWidthDec >> 4) - 1)
			    || u4MbY < ((prWMVSPS->u4PicHeightDec >> 5) - 1)) {
				return FALSE;
			} else {
				return TRUE;
			}
	  ...
	  */
		...
		if ((u4CntTimeChk == DEC_RETRY_NUM) ||
			...
			sprintf(strMessage,
				...
				u4mvErrType, u4MbX, ((_tVerPic[u4InstID].u4W + 15) >> 4) - 1, u4MbY,
				(((_tVerPic[u4InstID].u4H >> (1 - (fgWMVIsFrmPic(u4InstID)))) +
				  15) >> 4) - 1);
			fgWrMsg2PC(strMessage, strlen(strMessage), 8, &_tFileListRecInfo[u4InstID]);
...
void vH264DecEndProc(UINT32 u4InstID)
{
	...
	if ((u4CntTimeChk == DEC_RETRY_NUM) || ((u4VDEC_HAL_H264_GetErrMsg(u4InstID) != 0)
						&&
						(!(((u4VDEC_HAL_H264_GetErrMsg(u4InstID) == 8)
						    || (u4VDEC_HAL_H264_GetErrMsg(u4InstID) ==
							0x40))
						   && (fgVDEC_HAL_H264_DecPicComplete(u4InstID))))))
	{
#ifndef INTERGRATION_WITH_DEMUX
#ifdef EXT_COMPARE
		_fgVDecErr[u4InstID] = TRUE;
		...
		vVDecOutputDebugString
		    ("\n!!!!!!!!! Decoding Error 0x%.8x in pic %d (frm %d) !!!!!!!\n",
		     u4VDEC_HAL_H264_GetErrMsg(u4InstID), _u4PicCnt[u4InstID],
		     _u4FileCnt[u4InstID]);
		sprintf(strMessage,
			"\n!!!!!!!!! Decoding Error 0x%.8x at MC (x,y)=(%d/%d, %d/%d) in pic %d (frm %d) !!!!!!!\n",
			u4VDEC_HAL_H264_GetErrMsg(u4InstID), u4MbX,
			((_ptCurrFBufInfo[u4InstID]->u4W + 15) >> 4) - 1, u4MbY,
			(((_ptCurrFBufInfo[u4InstID]->u4H >> (1 - (fgIsFrmPic(u4InstID)))) +
			  15) >> 4) - 1, _u4PicCnt[u4InstID], _u4FileCnt[u4InstID]);
		fgWrMsg2PC(strMessage, strlen(strMessage), 8, &_tFileListRecInfo[u4InstID]);
		sprintf(strMessage, "the length is %d (0x%.8x)\n",
...
/* Print LOG */
	...
	sprintf(strMessage,
		"(dram_dle_cnt: 0x%x, mc_dle_cnt: 0x%x, cycle_cnt: 0x%x, dram_dle_by_preq: 0x%x)\n",
		u4Mc770, u4Mc774, u4Mc778, u4Mc8B8);
	printk("%s", strMessage);

#endif
	u4CurrentPtr =
	    u4VDEC_HAL_H264_ReadRdPtr(_u4BSID[u4InstID], u4InstID, (UINT32) _pucVFifo[u4InstID],
				      &u4Bit);
...
BOOL fgIsMPEGVDecComplete(UINT32 u4InstID)
{
	...
	if (_fgVDecComplete[u4InstID]) {
#if (POWER_TEST_CASE == POWER_TEST_DCM)
		{
			i4VDEC_HAL_Common_Gcon_Enable_After_Complete(u4InstID, VDEC_MPEG);
		}
#endif
		...
		if (_u4PicStruct[u4InstID] == FRM_PIC) {
			if ((u4MbX <
			     (((_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.u4DecW +
				_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.u4DecXOff +
				15) >> 4) - 1))
			    || (u4MbY <
				(((_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.u4DecH +
				   _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.u4DecYOff +
				   15) >> 4) - 1))) {
				return FALSE;
			} else {
				return TRUE;
...
void vMPEGVDecDumpPic(UINT32 u4InstID)
{
	...
	if (!_fgDumpDeblocky) {
		...
		do {
			...
			if (u4DataSizeY !=
			    linux_fwrite((char *)(_pucDecWorkBuf[u4InstID]), 1, u4DataSizeY,
					 _pFileHandleY)) {
		...
		do {
			...
			if (u4DataSizeCbcr !=
			    linux_fwrite((char *)(_pucDecCWorkBuf[u4InstID]), 1, u4DataSizeCbcr,
					 _pFileHandleCbcr)) {
				printk("MPV Emu Write to %s fail\n", pFileNameCbcr);
				printk("MPV Emu need to Write data count %d\n", u4DataSizeCbcr);
		...
		do {
			...
			if (u4DataSizeY !=
			    linux_fwrite((char *)(_pucPpYSa[u4InstID]), 1, u4DataSizeY,
					 _pFileHandleDeblockyY)) {
				printk("MPV Emu Write to %s fail\n", pFileNameYDeblocky);
				printk("MPV Emu need to Write data count %d\n", u4DataSizeY);
		...
		do {
			...
			if (u4DataSizeCbcr !=
			    linux_fwrite((char *)(_pucPpCSa[u4InstID]), 1, u4DataSizeCbcr,
					 _pFileHandleDeblockyCbcr)) {
				printk("MPV Emu Write to %s fail\n", pFileNameCbcrDeblocky);
				printk("MPV Emu need to Write data count %d\n", u4DataSizeCbcr);
...
void vMPEGVDecEnd(UINT32 u4InstID)
{
	...
	if (_fgVerVopCoded0[u4InstID]) {
		u4VldByte =
		    u4VDEC_HAL_MPEG_ReadRdPtr(0, u4InstID, (UINT32) _pucVFifo[u4InstID],
					      &u4VldBit) + 4;
	} else {
		u4VldByte =
		    u4VDEC_HAL_MPEG_ReadRdPtr(0, u4InstID, (UINT32) _pucVFifo[u4InstID],
...
#else
		vMPEGWrData2PC(u4InstID, _pucDumpYBuf[u4InstID],
			       ((((_u4RealHSize[u4InstID] + 15) >> 4) * ((_u4RealVSize[u4InstID] +
									  31) >> 5)) << 9));
#endif
	} else {
		vMPEGWrData2PC(u4InstID, _pucDumpYBuf[u4InstID],
...
*/
	...
	if (_u4CodecVer[u4InstID] == VDEC_DIVX3) {
		...
		rMpegBSInitPrm.u4VFifoEa = (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
		rMpegBSInitPrm.u4ReadPointer =
		    (UINT32) _pucVFifo[u4InstID] + _u4Divx3SetPos[u4InstID];
#ifndef RING_VFIFO_SUPPORT
		rMpegBSInitPrm.u4WritePointer = (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
#else
		/* rMpegBSInitPrm.u4WritePointer = (UINT32)_pucVFifo[u4InstID] + (V_FIFO_SZ*(0.5 + 0.5 *(_u4LoadBitstreamCnt[u4InstID]%2))); */
...
#ifdef MPEG4_8130_ERROR_CONCEAL
			...
			if ((u4Cnt & 0x3f) == 0x3f) {
				...
				if (u4VDEC_HAL_MPEG_VDec_ReadFinishFlag(u4InstID, fgMpeg4)) {
...
#endif
					{
						...
						fgWrData2PC(_pucRegisterLog[u4InstID],
							    _u4RegisterLogLen[u4InstID], 7,
							    _RegFileName[u4InstID]);
	  ...
	  else
	  {
		...
		if ((u4CntTimeChk == DEC_RETRY_NUM) ||
			...
			if (u4CntTimeChk == DEC_RETRY_NUM) {
				...
				sprintf(strMessage, "%s",
					"\n<vdec> !!!!!!!!! Decoding Timeout !!!!!!!\n");
				printk("[VDEC] End decoding (timeout)  \n");
				fgWrMsg2PC(strMessage, strlen(strMessage), 8,
					   &_tFileListRecInfo[u4InstID]);
				/* vDumpReg(); */
#ifdef REG_LOG_NEW
			...
			sprintf(strMessage,
				...
				u4MpegErrType, prMpegErrInfo.u4MpegErrType,
				prMpegErrInfo.u4MpegErrRow, u4MbX,
				((_tVerPic[u4InstID].u4W + 15) >> 4) - 1, u4MbY,
				(((_tVerPic[u4InstID].u4H >> (1 - (fgMPEGIsFrmPic(u4InstID)))) +
				  15) >> 4) - 1);
/* fgWrMsg2PC(strMessage,strlen(strMessage),8,&_tFileListRecInfo[u4InstID]); */
...
/* vWrite2PC(u4InstID, 12, (UCHAR *)(&_u4DumpChksum[u4InstID][0])); */
...
#if 0				/* mc performance */
	{
		...
		printk
		    ("VDEC_perf_measure: seq_name=%s pic_idx=%d pic_width=%d pic_height=%d pic_type=%s CYCLE_DRAM=%d\n",
		     _bFileStr1[u4InstID][8], _u4FileCnt[u4InstID],
		     _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.u4DecW,
		     _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.u4DecH, u4TypeCode,
		     u4CycleDram);
	...
	if (_u4FileCnt[u4InstID] == 5) {
		printk("WorkAround before 4139 = 0x%x,4140 = 0x%x\n", u4ReadSram(u4InstID, 4139),
		       u4ReadSram(u4InstID, 4140));
...
void vVerifyDx3SufxChk(UINT32 u4InstID)
{
	...
	if (_ucVopCdTp[u4InstID] == VCT_I) {
		dwByte =
		    u4VDEC_HAL_MPEG_ReadRdPtr(_u4BSID[u4InstID], u4InstID,
					      (UINT32) _pucVFifo[u4InstID], &dwBit);
		dwBit += (dwByte * 8);
		if (_u4Divx3SetPos[u4InstID] >= V_FIFO_SZ) {
			_u4Divx3SetPos[u4InstID] = _u4Divx3SetPos[u4InstID] - V_FIFO_SZ;
		}
		...
		if (dwShift >= 17) {
			_fgVerSwitchRounding[u4InstID] =
			    (u4VDEC_HAL_MPEG_ShiftGetBitStream(_u4BSID[u4InstID], u4InstID, 0) >>
			     15) & 0x1;
		}
	}
}
...
void vSetDx3SliceBoundary(UINT32 u4InstID, VDEC_INFO_MPEG_DEC_PRM_T *prVDecMPEGDecPrm)
{
	...
	UINT32 u4SliceSize =
	    u4MbH / (prVDecMPEGDecPrm->rPicLayer.rMp4DecPrm.rDep.rDx3DecPrm.ucFrameMode - 22);
	UINT32 i = 0;
	UINT32 j = 0;
	memset(prVDecMPEGDecPrm->rPicLayer.rMp4DecPrm.rDep.rDx3DecPrm.ucSliceBoundary, 0,
	       5 * sizeof(UINT32));

	for (i = 0; i < u4MbH; i++) {
		if (!(i % u4SliceSize)) {
			if (j < 5) {
				prVDecMPEGDecPrm->rPicLayer.rMp4DecPrm.rDep.rDx3DecPrm.
				    ucSliceBoundary[j] = i;
			}
			j++;
		}
...
void vH264VDecEnd(UINT32 u4InstID)
{
	...
	if (fgIsRefPic(u4InstID)) {
		...
		{
			if (tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			    fgLongTermReferenceFlag) {
				vVerifySetPicRefType(u4InstID, tVerMpvDecPrm->ucPicStruct,
						     LREF_PIC);
				...
				tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.u4MaxLongTermFrameIdx =
				    0xffffffff;
				vVerifySetPicRefType(u4InstID, tVerMpvDecPrm->ucPicStruct,
						     SREF_PIC);
			}
		...
		{
			if (tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			    fgAdaptiveRefPicMarkingModeFlag) {
	...
	tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.rLastInfo.fgLastMmco5 =
	    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->fgMmco5;
	tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.rLastInfo.ucLastPicStruct =
	    tVerMpvDecPrm->ucPicStruct;
	if (tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.rLastInfo.fgLastMmco5) {
		...
		tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.rLastInfo.i4LastFrameNumOffset =
...
/* tVerMpvDecPrm->rLastInfo.iLastRefPOCCntMsb = tVerMpvDecPrm->prSliceHdr->i4PicOrderCntMsb; */
		tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.rLastInfo.i4LastRefPOCLsb =
		    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->i4PicOrderCntLsb;
		tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.rLastInfo.i4LastRefPOCMsb =
		    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->i4PicOrderCntMsb;
	}
#if VDEC_MVC_SUPPORT
	if (_ucMVCType[u4InstID] != 0) {
		tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.rLastInfo.ucLastDpbId =
		    tVerMpvDecPrm->ucDecFBufIdx;
		tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.rLastInfo.u4LastViewId =
		    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.rMvcExtInfo.u4ViewId;
		memcpy(&_rH264PrevFbInfo[u4InstID], _ptCurrFBufInfo[u4InstID],
		       sizeof(VDEC_INFO_H264_FBUF_INFO_T));
	}
#endif
	...
	VERIFY(x_sema_lock(_ahVDecEndSema[u4InstID], X_SEMA_OPTION_WAIT) == OSR_OK);
#endif
	_u4FileOffset[u4InstID] =
	    u4VDEC_HAL_H264_ReadRdPtr(0, u4InstID, (UINT32) _pucVFifo[u4InstID], &u4Bits);
	rH264VDecInitPrm.u4FGDatabase = (UINT32) _pucFGDatabase[u4InstID];
	rH264VDecInitPrm.u4CompModelValue =
	    (UINT32) (_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.prSEI->pucCompModelValue);
	rH264VDecInitPrm.u4FGSeedbase = (UINT32) _pucFGSeedbase[u4InstID];
	i4VDEC_HAL_H264_InitVDecHW(u4InstID, &rH264VDecInitPrm);
	rH264BSInitPrm.u4VFifoSa = (UINT32) _pucVFifo[u4InstID];
	rH264BSInitPrm.u4VFifoEa = (UINT32) _pucVFifo[u4InstID] + V_FIFO_SZ;
	...
	if ((0 == _tInFileInfo[u4InstID].u4RealGetBytes) ||
		...
		UCHAR *pbDramAddr =
		    _tInFileInfo[u4InstID].pucTargetAddr + _tInFileInfo[u4InstID].u4RealGetBytes;
...
void vVerifyAdapRefPicmarkingProce(UINT32 u4InstID)
{
	...
	tVerMpvDecPrm = &_tVerMpvDecPrm[u4InstID];
	u4Cnt = 0;
	while (tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
	       u4MemoryManagementControlOperation[u4Cnt] != 0) {
		switch (tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			u4MemoryManagementControlOperation[u4Cnt] & 0xff) {
		case 0:
			break;
		case 1:
			/* picNumX */
			tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			    u4DifferencOfPicNumsMinus1 =
			    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			    u4MemoryManagementControlOperation[u4Cnt] >> 8;
			/* if(fgIsFrmPic(_u4VDecID)) */
			{
				u4PicNumX =
				    _ptCurrFBufInfo[u4InstID]->i4PicNum -
				    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
				    u4DifferencOfPicNumsMinus1 - 1;
			}
#if 0
			/* else */
			if (tVerMpvDecPrm->ucPicStruct & TOP_FIELD) {
				u4PicNumX =
				    _ptCurrFBufInfo[u4InstID]->i4TFldPicNum -
				    tVerMpvDecPrm->prSliceHdr->u4DifferencOfPicNumsMinus1 - 1;
			} else if (tVerMpvDecPrm->ucPicStruct & BOTTOM_FIELD) {
				u4PicNumX =
				    _ptCurrFBufInfo[u4InstID]->i4BFldPicNum -
				    tVerMpvDecPrm->prSliceHdr->u4DifferencOfPicNumsMinus1 - 1;
			}
#endif
			for (i = 0; i < tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.ucMaxFBufNum; i++) {
				if (fgIsFrmPic(u4InstID)
				    && (_ptFBufInfo[u4InstID][i].i4PicNum == u4PicNumX)
				    && (_ptFBufInfo[u4InstID][i].ucFBufRefType == SREF_PIC)) {
					...
					i = tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.ucMaxFBufNum;	/* break */
					   ...
					   (((_ptFBufInfo[u4InstID][i].i4TFldPicNum == u4PicNumX)
					     && (_ptFBufInfo[u4InstID][i].ucTFldRefType ==
						 SREF_PIC))
					    || ((_ptFBufInfo[u4InstID][i].i4BFldPicNum == u4PicNumX)
						&& (_ptFBufInfo[u4InstID][i].ucBFldRefType ==
						    SREF_PIC)))) {
					if ((_ptFBufInfo[u4InstID][i].i4TFldPicNum == u4PicNumX)
					    && (_ptFBufInfo[u4InstID][i].ucTFldRefType ==
						SREF_PIC)) {
						vVerifyClrPicRefInfo(u4InstID, TOP_FIELD, i);
					}
					if ((_ptFBufInfo[u4InstID][i].i4BFldPicNum == u4PicNumX)
					    && (_ptFBufInfo[u4InstID][i].ucBFldRefType ==
						SREF_PIC)) {
			...
			break;
		case 2:
			tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->u4LongTermPicNum =
			    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			    u4MemoryManagementControlOperation[u4Cnt] >> 8;
			u4PicNumX =
			    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->u4LongTermPicNum;
			for (i = 0; i < tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.ucMaxFBufNum; i++) {
				if (fgIsFrmPic(u4InstID)
				    && (_ptFBufInfo[u4InstID][i].i4LongTermPicNum == u4PicNumX)
					...
					i = tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.ucMaxFBufNum;	/* break */
					   ...
					   (((_ptFBufInfo[u4InstID][i].i4TFldLongTermPicNum ==
					    ...
					    ((_ptFBufInfo[u4InstID][i].i4BFldLongTermPicNum ==
					     ...
					     && (_ptFBufInfo[u4InstID][i].ucBFldRefType ==
						 LREF_PIC)))) {
					if ((_ptFBufInfo[u4InstID][i].i4TFldLongTermPicNum ==
					     u4PicNumX)
					    && (_ptFBufInfo[u4InstID][i].ucTFldRefType ==
						LREF_PIC)) {
						vVerifyClrPicRefInfo(u4InstID, TOP_FIELD, i);
					}
					if ((_ptFBufInfo[u4InstID][i].i4BFldLongTermPicNum ==
					     u4PicNumX)
					    && (_ptFBufInfo[u4InstID][i].ucBFldRefType ==
						LREF_PIC)) {
						vVerifyClrPicRefInfo(u4InstID, BOTTOM_FIELD, i);
		...
		case 3:
			tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			    u4DifferencOfPicNumsMinus1 =
			    (tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			     u4MemoryManagementControlOperation[u4Cnt] >> 8) & 0xff;
			tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->u4LongTermFrameIdx =
			    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			    u4MemoryManagementControlOperation[u4Cnt] >> 16;
			u4PicNumX =
			    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			    u4LongTermFrameIdx;
			for (i = 0; i < tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.ucMaxFBufNum; i++) {
				if (i != tVerMpvDecPrm->ucDecFBufIdx) {
					if ((_ptFBufInfo[u4InstID][i].ucFBufStatus == FRAME)
					    && (_ptFBufInfo[u4InstID][i].u4LongTermFrameIdx ==
						u4PicNumX)
					    && (_ptFBufInfo[u4InstID][i].ucFBufRefType ==
						LREF_PIC)) {
						vVerifyClrPicRefInfo(u4InstID, FRAME, i);
						i = tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.ucMaxFBufNum;	/* break */
					} else if ((_ptFBufInfo[u4InstID][i].ucFBufStatus != FRAME)
						   &&
						   (((_ptFBufInfo[u4InstID][i].
						      u4TFldLongTermFrameIdx == u4PicNumX)
						     && (_ptFBufInfo[u4InstID][i].ucTFldRefType ==
							 LREF_PIC))
						    ||
						    ((_ptFBufInfo[u4InstID][i].
						      u4BFldLongTermFrameIdx == u4PicNumX)
						     && (_ptFBufInfo[u4InstID][i].ucBFldRefType ==
							 LREF_PIC)))) {
						if ((_ptFBufInfo[u4InstID][i].
						     u4TFldLongTermFrameIdx == u4PicNumX)
						    && (_ptFBufInfo[u4InstID][i].ucTFldRefType ==
							LREF_PIC)) {
							vVerifyClrPicRefInfo(u4InstID, TOP_FIELD,
									     i);
						}
						if ((_ptFBufInfo[u4InstID][i].
						     u4BFldLongTermFrameIdx == u4PicNumX)
						    && (_ptFBufInfo[u4InstID][i].ucBFldRefType ==
							LREF_PIC)) {
							vVerifyClrPicRefInfo(u4InstID, BOTTOM_FIELD,
									     i);
						}
						i = tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.ucMaxFBufNum;	/* break */
					}
			...
			for (i = 0; i < tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.ucMaxFBufNum; i++) {
				if (fgIsFrmPic(u4InstID)
					...
					_ptFBufInfo[u4InstID][i].u4LongTermFrameIdx =
					    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
					    u4LongTermFrameIdx;
					_ptFBufInfo[u4InstID][i].u4TFldLongTermFrameIdx =
					    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
					    u4LongTermFrameIdx;
					_ptFBufInfo[u4InstID][i].u4BFldLongTermFrameIdx =
					    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
					    u4LongTermFrameIdx;
					...
					i = tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.ucMaxFBufNum;	/* break */
					   ...
					   (((_ptFBufInfo[u4InstID][i].i4TFldPicNum == u4PicNumX)
					     && (_ptFBufInfo[u4InstID][i].ucTFldRefType == SREF_PIC)
					     && (!_ptFBufInfo[u4InstID][i].fgNonExisting))
					    || ((_ptFBufInfo[u4InstID][i].i4BFldPicNum == u4PicNumX)
						&& (_ptFBufInfo[u4InstID][i].ucBFldRefType ==
						    SREF_PIC)
					...
					if ((_ptFBufInfo[u4InstID][i].i4TFldPicNum == u4PicNumX)
						...
						_ptFBufInfo[u4InstID][i].ucTFldRefType = LREF_PIC;
						_ptFBufInfo[u4InstID][i].u4TFldLongTermFrameIdx =
						    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.
						    prSliceHdr->u4LongTermFrameIdx;
						_ptFBufInfo[u4InstID][i].i4TFldLongTermPicNum =
						    (tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.
						     prSliceHdr->u4LongTermFrameIdx << 1) +
						    ((_tVerMpvDecPrm[u4InstID].ucPicStruct ==
						      TOP_FIELD) ? 1 : 0);
						if (_ptFBufInfo[u4InstID][i].ucBFldRefType ==
						    LREF_PIC) {
							_ptFBufInfo[u4InstID][i].ucFBufRefType =
							    LREF_PIC;
							_ptFBufInfo[u4InstID][i].
							    u4LongTermFrameIdx =
							    tVerMpvDecPrm->SpecDecPrm.
							    rVDecH264DecPrm.prSliceHdr->
							    u4LongTermFrameIdx;
							_ptFBufInfo[u4InstID][i].i4LongTermPicNum =
							    _ptFBufInfo[u4InstID][i].
							    u4LongTermFrameIdx;
					...
					if ((_ptFBufInfo[u4InstID][i].i4BFldPicNum == u4PicNumX)
						...
						_ptFBufInfo[u4InstID][i].i4BFldLongTermPicNum =
						    ...
						    ((_tVerMpvDecPrm[u4InstID].ucPicStruct ==
						      BOTTOM_FIELD) ? 1 : 0);
						if (_ptFBufInfo[u4InstID][i].ucTFldRefType ==
						    LREF_PIC) {
							_ptFBufInfo[u4InstID][i].ucFBufRefType =
							    LREF_PIC;
							_ptFBufInfo[u4InstID][i].
		...
		case 4:
			tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			    u4MaxLongTermFrameIdxPlus1 =
			    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			    u4MemoryManagementControlOperation[u4Cnt] >> 8;
			if (tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
			    u4MaxLongTermFrameIdxPlus1 == 0) {
				_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.
				    u4MaxLongTermFrameIdx = 0xffffffff;
				u4PicNumX = 0;
			} else {
				u4PicNumX =
				    (tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
		...
		case 5:
			...
			if (tVerMpvDecPrm->ucPicStruct == TOP_FIELD) {
				...
				_ptCurrFBufInfo[u4InstID]->i4POC =
				    (_ptCurrFBufInfo[u4InstID]->i4TFldPOC <
				     _ptCurrFBufInfo[u4InstID]->
				     i4BFldPOC) ? _ptCurrFBufInfo[u4InstID]->
		...
		case 6:
			...
			if (fgIsFrmPic(u4InstID))	/* 2 flds decoded */
			{
				...
				_ptCurrFBufInfo[u4InstID]->u4LongTermFrameIdx =
				    _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
				    u4LongTermFrameIdx;
				_ptCurrFBufInfo[u4InstID]->u4TFldLongTermFrameIdx =
				    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
				    u4LongTermFrameIdx;
				_ptCurrFBufInfo[u4InstID]->u4BFldLongTermFrameIdx =
				    tVerMpvDecPrm->SpecDecPrm.rVDecH264DecPrm.prSliceHdr->
				    u4LongTermFrameIdx;
...
void vChkOutputFBuf(UINT32 u4InstID)
{
	...
	do {
		...
		if ((u4MinPOCFBufIdx != 0xFF)
		    && (_ptFBufInfo[u4InstID][u4MinPOCFBufIdx].eH264DpbStatus !=
			H264_DPB_STATUS_EMPTY)) {
			_ptFBufInfo[u4InstID][u4MinPOCFBufIdx].eH264DpbStatus =
			    H264_DPB_STATUS_OUTPUTTED;
			...
			if ((u4MinPOCFBufIdx != 0xff)
			    && (_ptFBufInfo[u4MinPOCFBufIdx].eH264DpbStatus !=
				H264_DPB_STATUS_EMPTY)) {
...
#if (POWER_TEST_CASE == POWER_TEST_DCM)
		{
			i4VDEC_HAL_Common_Gcon_Enable_After_Complete(u4InstID, VDEC_H264);
		}
#endif
		vVDEC_HAL_H264_GetMbxMby(u4InstID, &u4MbX, &u4MbY);
		if (fgIsFrmPic(u4InstID)) {
			if (u4MbX < ((_ptCurrFBufInfo[u4InstID]->u4W >> 4) - 1)
			    || (u4MbY < ((_ptCurrFBufInfo[u4InstID]->u4H >> 4) - 1))) {
				return FALSE;
			} else {
				return TRUE;
			}
			...
			if (u4MbX < ((_ptCurrFBufInfo[u4InstID]->u4W >> 4) - 1)
			    || u4MbY < ((_ptCurrFBufInfo[u4InstID]->u4H >> 5) - 1)) {
				return FALSE;
			} else {
				return TRUE;
			}
...
INT32 i4VPModeDecStart(UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T *prDecPrm)
{
	...
	VDEC_INFO_MPEG_DEC_PRM_T *prMpegDecPrm =
	    (VDEC_INFO_MPEG_DEC_PRM_T *) &(prDecPrm->SpecDecPrm.rVDecMPEGDecPrm);
#else
	VDEC_INFO_MPEG_DEC_PRM_T *prMpegDecPrm =
	    (VDEC_INFO_MPEG_DEC_PRM_T *) prDecPrm->prVDecCodecHalPrm;
#endif
...
/* HalFlushInvalidateDCache(); */
	...
	if (prDecPrm->ucDecFBufIdx == 2) {
		if (prMpegDecPrm->u4FRefBufIdx == 0) {
			prMpegDecPrm->rMpegFrameBufSa.u4Pic1YSa =
			    prMpegDecPrm->rMpegFrameBufSa.u4Pic2YSa;
			prMpegDecPrm->rMpegFrameBufSa.u4Pic1CSa =
			    prMpegDecPrm->rMpegFrameBufSa.u4Pic2CSa;
			prMpegDecPrm->u4FRefBufIdx = 1;
			prDecPrm->ucDecFBufIdx = 0;
			_u4DecBufIdx[u4VDecID] = 0;
			_u4FRefBufIdx[u4VDecID] = 1;
		} else {
			prMpegDecPrm->rMpegFrameBufSa.u4Pic0YSa =
			    prMpegDecPrm->rMpegFrameBufSa.u4Pic2YSa;
			prMpegDecPrm->rMpegFrameBufSa.u4Pic0CSa =
			    prMpegDecPrm->rMpegFrameBufSa.u4Pic2CSa;
...
/* vVDECSetDownScalerPrm(u4VDecID, &prDecPrm->rDownScalerPrm); */
	...
	if (prMpegDecPrm->rMpegPpInfo.fgPpEnable) {
		...
		vVDecWriteMC(u4VDecID, RW_MC_PP_Y_ADDR,
			     u4AbsDramANc(prMpegDecPrm->rMpegPpInfo.u4PpYBufSa) >> 9);
		vVDecWriteMC(u4VDecID, RW_MC_PP_C_ADDR,
			     u4AbsDramANc(prMpegDecPrm->rMpegPpInfo.u4PpCBufSa) >> 8);
		vVDecWriteMC(u4VDecID, RW_MC_PP_MB_WIDTH, (prDecPrm->u4PicW + 15) >> 4);

		u4MBqp =
		    (prMpegDecPrm->rMpegPpInfo.
		     au1MBqp[0] & 0x1F) | ((UINT32) (prMpegDecPrm->rMpegPpInfo.
						     au1MBqp[1] & 0x1F) << 8)
		    | ((UINT32) (prMpegDecPrm->rMpegPpInfo.au1MBqp[2] & 0x1F) << 16) |
		    ((UINT32) (prMpegDecPrm->rMpegPpInfo.au1MBqp[3] & 0x1F) << 24);
		...
		vVDecWriteMC(u4VDecID, RW_MC_PP_Y_RANGE,
...
#if MPEG4_8130_SUPPORT
	vVDecWriteVLDTOP(u4VDecID, RW_TOPVLD_WMV_PICSIZE_MB,
			 (u4HeightMB - 1) << 16 | (u4WidthMB - 1));
#else
...
/* vVDecWriteMC(u4InstID,0x93C,u4VDecReadMC(u4InstID,0x93C)&(~(1<<0))&(~(1<<4)));//disable sram read */
	...
	for (u4Mcstart = 0; u4Mcstart < 13312; u4Mcstart++) {
		...
		ucLen +=
		    sprintf(ucTempBuff + ucLen, "%x ",
			    (_pucDumpSRAMBuf[u4InstID])[u4Mcstart * 4 + 2]);
		ucLen +=
		    sprintf(ucTempBuff + ucLen, "%x ",
			    (_pucDumpSRAMBuf[u4InstID])[u4Mcstart * 4 + 1]);
		ucLen +=
		    sprintf(ucTempBuff + ucLen, "%x", (_pucDumpSRAMBuf[u4InstID])[u4Mcstart * 4]);
		fseek(pFile, SEEK_CUR, 0);
		fwrite((char *)(_pucDumpSRAMBuf[u4InstID] + u4Mcstart * 4), 1, strlen(ucTempBuff),
		       pFile);
	}
#endif
