...
void *x_alloc_aligned_verify_mem_ex(UINT32 u4Size, UINT32 u4Align, BOOL fgChannelA,
				    const char *szFunction, INT32 i4Line)
{
	UCHAR *p = NULL;
	...
	if (g_u4AllocSize + u4Size < 0x0B000000) {
...
void vMemoryAllocate_RM(UINT32 u4InstID)
{
	...
	_pucVDSCLBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(VDSCL_BUF_SZ, 1024, VDSCL_CHANEL_A);
	_pucVDSCLWorkBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(VDSCL_WORK_SZ, 1024, VDSCL_CHANEL_A);
	_pucVDSCLWork1Sa[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(VDSCL_SW_WORK1_SZ, 1024, VDSCL_CHANEL_A);
	_pucVDSCLWork2Sa[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(VDSCL_SW_WORK2_SZ, 1024, VDSCL_CHANEL_A);
	_pucVDSCLWork3Sa[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(VDSCL_SW_WORK3_SZ, 1024, VDSCL_CHANEL_A);
	_pucVDSCLWork4Sa[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(VDSCL_SW_WORK4_SZ, 1024, VDSCL_CHANEL_A);
#endif

#ifdef SATA_HDD_READ_SUPPORT
#ifndef SATA_HDD_FS_SUPPORT
	_pucGoldenFileInfoSa[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(GOLDEN_FILE_INFO_SZ, 1024, 1);
#endif
#endif
	...
	_pucDumpYBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(GOLD_Y_SZ, 1024, GOLD_CHANEL_A);
	printk("_pucDumpYBuf[u4InstID] Address :%x!!!\n", _pucDumpYBuf[u4InstID]);
	_pucDumpCBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(GOLD_C_SZ, 1024, GOLD_CHANEL_A);
	...
	_pucPic0C[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(PIC_C_SZ, 2048, WORKING_AREA_CHANEL_A);
	printk("_pucPic0C[u4InstID] Address :%x!!!\n", _pucPic0C[u4InstID]);

	_pucPic1Y[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(PIC_Y_SZ, 2048, WORKING_AREA_CHANEL_A);
	...
	_pucRMFrmInfoBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(RM_FRMINFO_SZ, 1024, WORKING_AREA_CHANEL_A);
	printk("_pucRMFrmInfoBuf[u4InstID] Address :%x!!!\n", _pucRMFrmInfoBuf[u4InstID]);

	_pucRMMvHwWorkBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(RM_MVHWBUF_SZ, 4096, WORKING_AREA_CHANEL_A);
	printk("_pucRMMvHwWorkBuf[u4InstID] Address :%x!!!\n", _pucRMMvHwWorkBuf[u4InstID]);
	_pucRmVldPredWorkBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(RM_VLDPRED_SZ, 4096, WORKING_AREA_CHANEL_A);
	...
	_pucRMGoldenDataBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(RM_GOLDENDATA_SZ, 1024, WORKING_AREA_CHANEL_A);
	printk("_pucRMGoldenDataBuf[u4InstID] Address :%x!!!\n", _pucRMGoldenDataBuf[u4InstID]);

	_pucDumpYBuf_1[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(GOLD_Y_SZ_1, 2048, WORKING_AREA_CHANEL_A);
	printk("_pucDumpYBuf_1[u4InstID] Address :%x!!!\n", _pucDumpYBuf_1[u4InstID]);
	_pucDumpCBuf_1[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(GOLD_C_SZ_1, 2048, WORKING_AREA_CHANEL_A);
	printk("_pucDumpCBuf_1[u4InstID] Address :%x!!!\n", _pucDumpCBuf_1[u4InstID]);

#ifdef DOWN_SCALE_SUPPORT
	_pucVDSCLBuf_1[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(VDSCL_BUF_SZ_1, 1024, WORKING_AREA_CHANEL_A);
	...
	_pucRMReszWorkBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(RM_RSZWORKBUF_SZ, 1024, WORKING_AREA_CHANEL_A);
	_pucRMRingWorkBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(RM_RINGFLOW_TEMPFIFO_SZ, 1024,
						 WORKING_AREA_CHANEL_A);

	_pucRMAULikeBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(RM_AULIKEBUF_SZ, 1024, WORKING_AREA_CHANEL_A);

	_pucRMChecksumBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(RM_CHECKSUM_BUFFER_SZ, 1024,
						 WORKING_AREA_CHANEL_A);

#ifdef RM_CRCCHECKFLOW_SUPPORT
	_pucRMCRCResultBuf[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(RM_CRCRESULT_SZ, 8, WORKING_AREA_CHANEL_A);
#endif				/* RM_CRCCHECKFLOW_SUPPORT */

	_pucVP6VLDWrapperWorkspace[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(15 * 4096, 1024, WORKING_AREA_CHANEL_A);
	_pucVP6PPWrapperWorkspace[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(30 * 4096, 1024, WORKING_AREA_CHANEL_A);
...
void vMemoryAllocate(UINT32 u4InstID)
{
	...
	_pucDramBusy[u4InstID] =
	    (UCHAR *) x_alloc_aligned_verify_mem(0x10000, 2048, WORKING_AREA_CHANEL_A);
...
#ifdef LETTERBOX_SUPPORT
	{
		_pucSettingFileSa[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(FILE_LIST_SZ, 1024, 1);
...
/* printk("CRCBUF_SA = 0x%x\n", CRCBUF_SA); */
...
#if VDEC_AVS_EMU
	{
		...
		_pucAvsPred[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(AVS_VLD_PRED_SZ, 1024,
							 WORKING_AREA_CHANEL_A);
		_pucAvsMv1[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(AVS_VLD_MV_SZ, 1024,
							 WORKING_AREA_CHANEL_A);
		_pucAvsMv2[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(AVS_VLD_MV_SZ, 1024,
							 WORKING_AREA_CHANEL_A);
		...
		printk("_pucDcac[u4InstID] = 0x%x 0x%x 0x%x\n", (UINT32) _pucAvsPred[u4InstID],
		       AVS_VLD_PRED_BUF, AVS_VLD_PRED_SZ);
		printk("_pucMv_1[u4InstID] = 0x%x 0x%x 0x%x\n", (UINT32) _pucAvsMv1[u4InstID],
		       AVS_VLD_MV1_BUF, AVS_VLD_MV_SZ);
		printk("_pucMv_2[u4InstID] = 0x%x 0x%x 0x%x\n", (UINT32) _pucAvsMv2[u4InstID],
		       AVS_VLD_MV2_BUF, AVS_VLD_MV_SZ);
		...
		if (_u2AddressSwapMode[u4InstID] != ADDRSWAP_OFF) {
			...
			_pucAddressSwapBuf[u4InstID] =
			    ioremap_nocache(AVS_ADDSWAP_BUF, ADDSWAP_BUF_SZ);
			memset(_pucAddressSwapBuf[u4InstID], 0, ADDSWAP_BUF_SZ);
#else
			_pucAddressSwapBuf[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(ADDSWAP_BUF_SZ, 2048,
								 WORKING_AREA_CHANEL_A);
#endif
...
void vMemoryFree(UINT32 u4InstID)
{
...
#if 0				/* VDEC_AVS_EMU */
	{
		...
		if (_u2AddressSwapMode[u4InstID] != ADDRSWAP_OFF) {
			x_free_aligned_verify_mem(_pucAddressSwapBuf[u4InstID],
						  WORKING_AREA_CHANEL_A);
		}
	}
#endif
...
BOOL fgVDecAllocWorkBuffer(UINT32 u4InstID)
{
	...
	if (_u4CodecVer[u4InstID] == VDEC_H264) {
		...
		_pucVLDWrapperWrok[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(VLD_WRAP_SZ, 2048, WORKING_AREA_CHANEL_A);
		_pucPPWrapperWork[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(PP_WRAP_SZ, 2048, WORKING_AREA_CHANEL_A);
		...
		_pucDPB[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(DPB_SZ, 4096, WORKING_AREA_CHANEL_A);
		printk("_pucDPB[u4InstID] = 0x%x\n", _pucDPB[u4InstID]);

		_pucPredSa[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(AVC_PRED_SZ, 1024, WORKING_AREA_CHANEL_A);
		printk("_pucPredSa[u4InstID] = 0x%x\n", _pucPredSa[u4InstID]);


#ifdef VERIFICATION_FGT
		_pucFGSeedbase[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(FGT_SEED_SZ, 1024, WORKING_AREA_CHANEL_A);
		_pucFGDatabase[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(FGT_DATABASE_SZ, 1024,
							 WORKING_AREA_CHANEL_A);
		_pucFGSEISa[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(FGT_SEI_SZ, 1024, WORKING_AREA_CHANEL_A);
		_pucFGTBuf[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(FGT_SZ, 1024, WORKING_AREA_CHANEL_A);
#endif
		...
		if (u4InstID == 0) {
			...
			_pucAVCMVBuff_Main[0] =
			    (UCHAR *) x_alloc_aligned_verify_mem(1920 * 1088, 4096,
								 WORKING_AREA_CHANEL_A);
			for (i = 1; i < 16; i++) {
				_pucAVCMVBuff_Main[i] =
				    _pucAVCMVBuff_Main[i - 1] + ((1920 * 1088) / 16);
			...
			/* 15/9/2010 mtk40343 */
			_pucAVCMVBuff_Main[0] =
			    (UCHAR *) x_alloc_aligned_verify_mem(MVBUF_SZ, 4096,
								 WORKING_AREA_CHANEL_A);
			for (i = 1; i < 17; i++) {
				/* _pucAVCMVBuff_Main[i] = _pucAVCMVBuff_Main[i-1] + ((4096*2048) / 8); */
				_pucAVCMVBuff_Main[i] =
				    _pucAVCMVBuff_Main[i - 1] + ((1920 * 1088) / 8);
			...
			for (i = 1; i < 16; i++) {
				_pucAVCMVBuff_Sub[i] =
				    _pucAVCMVBuff_Sub[i - 1] + ((1920 * 1088) / 16);
			}
#endif
			_pucAVCMVBuff_Sub[0] =
			    (UCHAR *) x_alloc_aligned_verify_mem(1920 * 1088 * 5, 4096,
								 WORKING_AREA_CHANEL_A);
			for (i = 1; i < 17; i++) {
				_pucAVCMVBuff_Sub[i] =
				    _pucAVCMVBuff_Sub[i - 1] + ((1920 * 1088) / 4);
...
#ifdef DOWN_SCALE_SUPPORT
		_pucVDSCLBuf[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(VDSCL_BUF_SZ, 2048, VDSCL_CHANEL_A);
		_pucVDSCLWorkBuf[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(VDSCL_WORK_SZ, 1024, VDSCL_CHANEL_A);
		_pucVDSCLWork1Sa[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(VDSCL_SW_WORK1_SZ, 1024, VDSCL_CHANEL_A);
...
/* ~AVC Working Buffer */
		 ...
		 || _u4CodecVer[u4InstID] == VDEC_H263 || _u4CodecVer[u4InstID] == VDEC_DIVX3) {
		...
		if (_u4WmvMode[u4InstID] == 0) {
			_pucDcac[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(DCAC_SZ, 1024,
								 WORKING_AREA_CHANEL_A);
			_pucMv_1[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(Mv_1_SZ, 1024,
								 WORKING_AREA_CHANEL_A);
			_pucMv_2[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(Mv_2_SZ, 1024,
								 WORKING_AREA_CHANEL_A);
		...
		_pucBp_1[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(Bp_1_SZ, 1024, WORKING_AREA_CHANEL_A);
		_pucBp_2[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(Bp_2_SZ, 1024, WORKING_AREA_CHANEL_A);
		_pucBp_3[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(Bp_3_SZ, 1024, WORKING_AREA_CHANEL_A);
		_pucBp_4[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(Bp_4_SZ, 1024, WORKING_AREA_CHANEL_A);
		...
		if (_u4WmvMode[u4InstID] == 0) {
			_pucMv_3[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(Mv_3_SZ, 1024,
								 WORKING_AREA_CHANEL_A);
			_pucMv_1_2[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(Mv_1_2_SZ, 1024,
								 WORKING_AREA_CHANEL_A);
			_pucDcac_2[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(DCAC_2_SZ, 1024,
								 WORKING_AREA_CHANEL_A);
			...
			_pucDcacNew[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(DCAC_NEW_SZ, 1024,
								 WORKING_AREA_CHANEL_A);
			_pucMvNew[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(MV_NEW_SZ, 1024,
								 WORKING_AREA_CHANEL_A);
			_pucBp0New[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(BP_0_NEW_SZ, 1024,
								 WORKING_AREA_CHANEL_A);
			_pucBp1New[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(BP_1_NEW_SZ, 1024,
								 WORKING_AREA_CHANEL_A);
			_pucBp2New[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(BP_2_NEW_SZ, 1024,
								 WORKING_AREA_CHANEL_A);
		...
		_pucPp_1[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(DEC_PP_SZ, 1024, WORKING_AREA_CHANEL_A);
		_pucPp_2[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(DEC_PP_SZ, 1024, WORKING_AREA_CHANEL_A);
		/* MPEG part */
#ifdef VDEC_PP_ENABLE
		_pucPpYSa[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(DEC_PP_Y_SZ, 1024, WORKING_AREA_CHANEL_A);
		_pucPpCSa[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(DEC_PP_C_SZ, 1024, WORKING_AREA_CHANEL_A);
		...
		_pucMp4Dcac[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(DCAC_SZ, 1024, WORKING_AREA_CHANEL_A);
		printk("// <buffer> dcac + mv pred address: 32'h%x\n",
		       PHYSICAL(_pucMp4Dcac[u4InstID]));
		_pucMp4Mvec[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(VER_MVEC_SZ, 1024, WORKING_AREA_CHANEL_A);
		_pucMp4Bmb1[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(VER_BMB1_SZ, 1024, WORKING_AREA_CHANEL_A);
		_pucMp4Bmb2[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(VER_BMB2_SZ, 1024, WORKING_AREA_CHANEL_A);
		_pucMp4Bcode[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(BCODE_SZ, 1024, WORKING_AREA_CHANEL_A);
		...
		_pucMp4DataPartition[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(DATA_PARTITION_SZ, 1024,
							 WORKING_AREA_CHANEL_A);
		_pucMp4NotCoded[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(NOT_CODED_SZ, 1024, WORKING_AREA_CHANEL_A);
		_pucMp4MvDirect[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(MV_DIRECT_SZ, 1024, WORKING_AREA_CHANEL_A);
		...
		_pucDumpSRAMBuf[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(54 * 1024, 1024, 1);
		...
		_pucSizeFileBuf[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(1024 * 400, 2048, WORKING_AREA_CHANEL_A);
		_pucPic0Y[u4InstID] = (UCHAR *) x_alloc_aligned_verify_mem(PIC_Y_SZ, 2048, WORKING_AREA_CHANEL_A);	/* UCHAR address */
		_pucPic0C[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(PIC_C_SZ, 2048, WORKING_AREA_CHANEL_A);
		_pucPic1Y[u4InstID] =
		...
		_pucPpYSa[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(DEC_PP_Y_SZ, 2048, WORKING_AREA_CHANEL_A);
		_pucPpCSa[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(DEC_PP_C_SZ, 2048, WORKING_AREA_CHANEL_A);
		...
		if (_u1AlphaBitstream[u4InstID]) {
			...
			_pucPic0Y[u4InstID] = (UCHAR *) x_alloc_aligned_verify_mem(PIC_Y_SZ, 2048, WORKING_AREA_CHANEL_A);	/* UCHAR address */
			_pucPic0C[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(PIC_C_SZ, 2048,
								 WORKING_AREA_CHANEL_A);
			_pucPic1Y[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(PIC_Y_SZ, 2048,
								 WORKING_AREA_CHANEL_A);
			_pucPic1C[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(PIC_C_SZ, 2048,
								 WORKING_AREA_CHANEL_A);
			...
			_pucPpYSa[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(DEC_PP_Y_SZ, 2048,
								 WORKING_AREA_CHANEL_A);
			_pucPpCSa[u4InstID] =
			    (UCHAR *) x_alloc_aligned_verify_mem(DEC_PP_C_SZ, 2048,
								 WORKING_AREA_CHANEL_A);
...
#else
		_pucSizeFileBuf[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(FILEBUF_SZ, 2048, WORKING_AREA_CHANEL_A);
#endif
		...
		_pucWorkYBuf[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(PIC_Y_SZ + PIC_C_SZ, 2048,
							 WORKING_AREA_CHANEL_A);
#endif
		...
		_pucDumpArfYBuf[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(DEC_PP_Y_SZ + DEC_PP_C_SZ, 2048,
							 WORKING_AREA_CHANEL_A);
#endif
		...
		_pucVLDWrapper[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(VLD_PRED_SZ, 2048, WORKING_AREA_CHANEL_A);
#endif
		...
		_pucPPWrapperY[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(PP_WRAPY_SZ, 2048, WORKING_AREA_CHANEL_A);
#endif
		...
		_pucPPWrapperC[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(PP_WRAPC_SZ, 2048, WORKING_AREA_CHANEL_A);
#endif
		...
		_pucSegIdWrapper[u4InstID] =
		    (UCHAR *) x_alloc_aligned_verify_mem(SEG_ID_SZ, 2048, WORKING_AREA_CHANEL_A);
#endif
