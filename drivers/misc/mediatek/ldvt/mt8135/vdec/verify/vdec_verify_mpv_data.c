...
#define MT8130_VDEC_VP8		/* Jackal Chen 20120202 */
...
char _FileList_Rec[2][100] =
    { "\\\\emu264\\f\\ChkFolder\\8530_filelist_rec_mpeg2.txt",
"\\\\emu264\\f\\ChkFolder\\8530_filelist_rec_mpeg2_1.txt" };
char _FileList[2][100] =
    { "\\\\emu264\\f\\ChkFolder\\8530_filelist_mpeg2.txt",
"\\\\emu264\\f\\ChkFolder\\8530_filelist_mpeg2_1.txt" };
#elif defined(FPGA_FOR_H264)
char _FileList_Rec[2][100] =
    { "\\\\emu264\\f\\ChkFolder\\8530_filelist_rec_h264.txt",
"\\\\emu264\\f\\ChkFolder\\8530_filelist_rec_h264_1.txt" };
char _FileList[2][100] =
    { "\\\\emu264\\f\\ChkFolder\\8530_filelist_h264.txt",
"\\\\emu264\\f\\ChkFolder\\8530_filelist_h264_1.txt" };
#else

#ifdef SATA_HDD_FS_SUPPORT
#ifdef MT8130_VDEC_VP8		/* Jackal Chen 20120202 */
char _FileList_Rec[2][100] =
    { "w:\\chkfolder\\mtk40093\\VDec0_filelist_rec.txt", "/mnt/udiska/VDec1_filelist_rec.txt" };
#else
char _FileList_Rec[2][100] =
    { "/mnt/udiska/VDec0_filelist_rec.txt", "/mnt/udiska/VDec1_filelist_rec.txt" };
#endif
/* char _FileList[2][100]= {"list_normal_test1.txt","list_normal_test2.txt"}; */
#ifdef MT8130_VDEC_VP8		/* Jackal Chen 20120202 */
char _FileList[2][100] =
    { "w:\\chkfolder\\mtk40093\\8130_ver_list.txt\0", "/mnt/udiska/8320_ver_list.txt\0" };
#else
char _FileList[2][100] = { "/mnt/udiska/8320_ver_list.txt\0", "/mnt/udiska/8320_ver_list.txt\0" };
#endif
...
char _FileList_Rec[2][100] =
    { "D:\\ChkFolder\\VDec0_filelist_rec.txt", "D:\\ChkFolder\\VDec1_filelist_rec.txt" };
char _FileList[2][100] =
    { "D:\\ChkFolder\\list_normal_test1.txt", "D:\\ChkFolder\\list_normal_test2.txt" };
#else
...
char _FileList_Rec[2][100] =
    { "d:\\ChkFolder\\VDec0_filelist_rec.txt", "F:\\ChkFolder\\VDec1_filelist_rec.txt" };
char _FileList[2][100] =
    { "d:\\ChkFolder\\list_normal_test1.txt", "F:\\ChkFolder\\list_normal_test2.txt" };
#endif
