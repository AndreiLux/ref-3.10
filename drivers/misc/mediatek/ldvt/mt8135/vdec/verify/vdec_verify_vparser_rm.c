...
extern void vSetDownScaleParam(UINT32 u4InstID, BOOL fgEnable,
			       VDEC_INFO_VDSCL_PRM_T * prDownScalerPrm);
extern void vGenerateDownScalerGolden(UINT32 u4InstID, UINT32 DecYAddr, UINT32 DecCAddr,
				      UINT32 u4Size);
extern UINT32 u4CalculatePixelAddress_Y(UINT32 u4YBase,	/* /< [IN] frame buffer Y component address */
...
extern UINT32 u4CalculatePixelAddress_C(UINT32 u4CBase,	/* /< [IN] frame buffer CbCr component address */
					UINT32 u4XPos,	/* /< [IN] x position of pixel in frame buffer */
					UINT32 u4YPos,	/* /< [IN] y position of pixel in frame buffer */
					UINT32 u4FrameWidth,	/* /< [IN] Frame buffer width */
					BOOL fgBlock,	/* /< [IN] MTK block / raster scan */
...
extern void vVDSCLSetBoundPad(UINT32 u4VDecID, EPadMode ePadMode, UCHAR ucYColor, UCHAR ucCbColor,
			      UCHAR ucCrColor);
...
extern void vVDSCLSetScalerHParm(UINT32 u4VDecID, UINT32 u4SrcWidth, UINT32 u4TrgWidth,
				 VDEC_INFO_VDSCL_PRM_T *prDownScalerPrm);
extern void vVDSCLSetSrcOffset(UINT32 u4VDecID, UINT32 u4SrcYOffH, UINT32 u4SrcYOffV,
			       UINT32 u4SrcCOffH, UINT32 u4SrcCOffV);
extern void vVDSCLSetScalerVParm(UINT32 u4VDecID, UINT32 u4SrcHeight, UINT32 u4TrgHeight,
				 BOOL fgIs422, BOOL fgIsMbaff, UINT32 u4OffY, UINT32 u4OffC,
				 VDEC_INFO_VDSCL_PRM_T *prDownScalerPrm);
...
BOOL fgRM_IsRMVDecComplete(UINT32 u4InstID)
{
	...
	prParsingPic =
	    (VDEC_INFO_RM_PICINFO_T *) &_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.
	    rRMParsPicInfo;

	if (_fgVDecComplete[u4InstID]) {
#if (POWER_TEST_CASE == POWER_TEST_DCM)
		{
			i4VDEC_HAL_Common_Gcon_Enable_After_Complete(u4InstID, VDEC_RM);
		}
#endif
		...
		if ((u4MbX == (u4RealMbX - 1)) && (u4MbY == (u4RealMbY - 1))) {
			return TRUE;
		}
	}
	return FALSE;
...
BOOL fgGetRvPic(UINT32 u4InstID, const char *szFunction, INT32 i4Line)
{
	...
	for (i = 0; i < prPic->u4NumSlice; i++) {
		u4Parm =
		    *(UINT32 *) (_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMFrmInfoBuf +
				 _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMFrmInfoRPtr);
		_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMFrmInfoRPtr += 4;
...
{
	VDEC_INFO_VDSCL_PRM_T *prDownScalerPrm =
	    (VDEC_INFO_VDSCL_PRM_T *) &_tVerMpvDecPrm[u4InstID].rDownScalerPrm;
...
void vRM_SetDownScaleParam(UINT32 u4InstID, BOOL fgEnable, VDEC_INFO_VDSCL_PRM_T *prDownScalerPrm)
{
	...
	if (fgEnable) {
		...
		prDownScalerPrm->ucAddrSwapMode =
		    auAddrSwapMapTable_RM[_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.
					  u4RMAddrSwapMode];
		...
		/* ((!_fgDec2ndFldPic[u4InstID])&&(_u4CodecVer[u4InstID] != VDEC_WMV)&&(_u4CodecVer[u4InstID] != VDEC_H264))) */
		{
...
#else				/* NO_SCALE_TEST_ENABLE */
					prDownScalerPrm->u4TrgWidth =
					    (UINT32) (((UINT32) rand()) % RM_MAX_DSCL_WIDTH);
...
#ifdef RM_INTERLACEFRAME_DSCL_TEST
			{
				...
				u4Offset =
				    (prDownScalerPrm->u4SrcHeight -
				     prDownScalerPrm->u4TrgHeight) / (prDownScalerPrm->u4TrgHeight *
								      2);
...
void vRM_VDECSetDownScalerPrm(UINT32 u4VDecID, VDEC_INFO_VDSCL_PRM_T *prDownScalerPrm)
{
	...
	if (prDownScalerPrm->fgDSCLEn) {
		...
		vVDSCLSetSrcPicSize(u4VDecID, prDownScalerPrm->u4SrcWidth,
				    prDownScalerPrm->u4SrcHeight);
		vVDSCLSetTrgBufWidth(u4VDecID, prDownScalerPrm->u4DispW);
		vVDSCLSetTrgPicSize(u4VDecID, prDownScalerPrm->u4TrgWidth,
				    prDownScalerPrm->u4TrgHeight);
		vVDSCLSetTrgPicOffset(u4VDecID, prDownScalerPrm->u4TrgOffH,
				      prDownScalerPrm->u4TrgOffV);
...
#if (CONFIG_DRV_MT8520)
		vVDSCLSetScalerHParm(u4VDecID, prDownScalerPrm->u4SrcWidth,
				     prDownScalerPrm->u4TrgWidth);
#else
		vVDSCLSetScalerHParm(u4VDecID, prDownScalerPrm->u4SrcWidth,
				     prDownScalerPrm->u4TrgWidth, prDownScalerPrm);
#endif
		...
		if (prDownScalerPrm->ucPicStruct == BTM_FLD_PIC) {
			...
			prDownScalerPrm->u4R_norm =
			    (((src_h - tg_h) -
			      (prDownScalerPrm->u4QY * (tg_h * 2))) * 2048) / (2 * src_h);
		}
		...
		vVDSCLSetScalerVParm(u4VDecID, prDownScalerPrm->u4SrcHeight,
				     prDownScalerPrm->u4TrgHeight, prDownScalerPrm->ucVdoFmt,
				     prDownScalerPrm->fgMbaff, prDownScalerPrm->u4OffY,
				     prDownScalerPrm->u4OffC);
#else
		vVDSCLSetSrcOffset(u4VDecID, prDownScalerPrm->u4SrcYOffH,
				   prDownScalerPrm->u4SrcYOffV, prDownScalerPrm->u4SrcCOffH,
				   prDownScalerPrm->u4SrcCOffV);
...
#ifdef RM_INTERLACEFRAME_DSCL_TEST
		{
			...
			u4Offset =
			    (prDownScalerPrm->u4SrcHeight -
			     prDownScalerPrm->u4TrgHeight) / (prDownScalerPrm->u4TrgHeight * 2);

			u4Factor =
			    (0x8000 * prDownScalerPrm->u4TrgHeight +
			     prDownScalerPrm->u4SrcHeight / 2) / prDownScalerPrm->u4SrcHeight;
			u4Scl_Offset =
			    (((prDownScalerPrm->u4SrcHeight - prDownScalerPrm->u4TrgHeight) -
			      (u4Offset * prDownScalerPrm->u4TrgHeight * 2)) * 0x8000) / (2 *
											  prDownScalerPrm->
											  u4SrcHeight);
		...
		vVDSCLSetScalerVParm(u4VDecID, prDownScalerPrm->u4SrcHeight,
				     prDownScalerPrm->u4TrgHeight, prDownScalerPrm->ucVdoFmt,
				     prDownScalerPrm->fgMbaff, prDownScalerPrm->u4OffY,
				     prDownScalerPrm->u4OffC, prDownScalerPrm);
#endif				/* RM_INTERLACEFRAME_DSCL_TEST */
#endif
...
void vRM_VerInitDec(UINT32 u4InstID)
{
	...
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4MvHwWorkBuf =
	    (UINT32) _pucRMMvHwWorkBuf[u4InstID];

	/* 3*128*128 = 49152 */
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4VldPredWorkBuf =
	    (UINT32) _pucRmVldPredWorkBuf[u4InstID];

	/* Init Read Ptr */
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMFrmInfoBuf =
	    (UINT32) _pucRMFrmInfoBuf[u4InstID];
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMFrmInfoRPtr = 0;

	/* Golden Data Info */
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMGoldenDataBuf =
	    (UINT32) _pucRMGoldenDataBuf[u4InstID];
	...
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMRingFlowTempFIFO =
	    (UINT32) _pucRMRingWorkBuf[u4InstID];
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMRingFlowTempFIFOSize =
	    (UINT32) RM_RINGFLOW_TEMPFIFO_SZ;


	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4GlobalChecksumBuf =
	    (UINT32) _pucRMChecksumBuf[u4InstID];
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4GlobalChecksumBufSize =
	    RM_CHECKSUM_BUFFER_SZ;
	...
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMFIFORPtr =
	    (UINT32) _pucRMAULikeBuf[u4InstID];
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMVFIFOSa =
	    (UINT32) _pucRMAULikeBuf[u4InstID];
	...
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4CRCResultBufAddr =
	    (UINT32) _pucRMCRCResultBuf[u4InstID];
...
#ifdef RM_MCOutPut_ENABLE
	if ((_pucRMMCOutputBufY[u4InstID] == NULL) || (_pucRMMCOutputBufC[u4InstID] == NULL)) {
...
extern UINT32 u4VDEC_HAL_VP6_VDec_SetWorkspace(UINT32 u4VDecID, UINT32 u4VLDWrapperWorkspace,
...
#ifdef RM_RINGVIFO_FLOW
	rRMVdecBSInfo.u4WritePointer =
	    (UINT32) (_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMVFIFOWPtr + 1024);
#else
...
*/
	...
	u4VDEC_HAL_VP6_VDec_SetWorkspace(u4InstID, (UINT32) _pucVP6VLDWrapperWorkspace[u4InstID],
					 (UINT32) _pucVP6PPWrapperWorkspace[u4InstID]);
	...
	/* Pre-Parsing Picture Information */
	{
		...
		memcpy((void *)(&_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.
				rRMPicInfo_Preparsing),
		...
		if ((prPic_Preparsing->ePtype == RM_INTRAPIC)
			...
			/* Search Next I or  P */
			for (u4SearchLoop = 0; u4SearchLoop < RPR_RAC_PREPARSING_CNT;
			     u4SearchLoop++) {
				...
				if (prPic_Normal->ePtype == RM_INTERPIC) {
					if ((prPic_Normal->u4OrgWidth !=
					     prPic_Preparsing->u4OrgWidth)
					    || (prPic_Normal->u4OrgHeight !=
						prPic_Preparsing->u4OrgHeight)) {
						printk
						    ("<vdec> RPR Racing Mode Enalbe !!!!!!!!!!!!!!!\n");
						/* Enable RPR Racing Mode */
						_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.
						    fgRPRRacingModeEnable = TRUE;

						memcpy((void *)(&_tVerMpvDecPrm[u4InstID].
								SpecDecPrm.rVDecRMDecPrm.
								rRMPicInfo_Preparsing),
						       (void *)(&_tVerMpvDecPrm[u4InstID].
								SpecDecPrm.rVDecRMDecPrm.
								rRMPicInfo),
						       sizeof(VDEC_INFO_RM_PICINFO_T));
					}
...
/* Get Golden Syntax Pic Info */
		...
		if (u4LoopDecodeFirstFlag) {
			if (u4LoopDecodeFrmCnt > 0) {
				_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.rRMParsPicInfo.
				    u4DecodedPicCnt = u4LoopDecodeFrmCnt - 1;
...
#ifdef RM_SKIPFRAME_Test
	{
		...
		if (u4SkipFrameNum > 0) {
			...
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.rRMParsPicInfo.
			    u4DecodedPicCnt = u4SkipFrameNum - 1;
...
/* Synctax Parsing  ////////////////////////////////////////////////////////// */
	...
	if (prPic->fgRV9) {
		...
		prParsingPic->ePtype =
		    (EnumRMPicCodType) u4VDEC_HAL_RM_ShiftGetBitStream(0, u4InstID, 2);
		...
		if ((prParsingPic->ePtype == RM_INTERPIC) || (prParsingPic->ePtype == RM_TRUEBPIC)) {
			prParsingPic->fgUserPrevWidth =
			    u4VDEC_HAL_RM_ShiftGetBitStream(0, u4InstID, 1);

			if (!(prParsingPic->fgUserPrevWidth)) {
				vRM_GetPicSize(0, u4InstID, &prParsingPic->u4OrgWidth,
					       &prParsingPic->u4OrgHeight);
			}
		} else {
			vRM_GetPicSize(0, u4InstID, &prParsingPic->u4OrgWidth,
				       &prParsingPic->u4OrgHeight);
		...
		prParsingPic->u4Mba =
		    u4VDEC_HAL_RM_ShiftGetBitStream(0, u4InstID, prParsingPic->u4MbaSize);
	} else {
		/* RV8 Syntax */
		...
		if (prPic->u4PctszSize > 0) {
			prParsingPic->u4PicSz =
			    u4VDEC_HAL_RM_ShiftGetBitStream(0, u4InstID, prParsingPic->u4PctszSize);
		}
		...
		/* if (fgFirstTime) */
	{
		if (prParsingPic->ePtype == RM_INTRAPIC
			...
			if (_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.fgRPRRacingModeEnable) {
				...
				rPreParsingPicInfo =
				    (VDEC_INFO_RM_PICINFO_T *) &_tVerMpvDecPrm[u4InstID].
				    SpecDecPrm.rVDecRMDecPrm.rRMPicInfo_Preparsing;

				printk
				    ("=====> I Racing Mode, About to trigger image resizer in racing mode...\n");
				vRprImgResz(u4InstID, prPic->u4Width, prPic->u4Height,
					    prPic->u4OrgWidth, prPic->u4OrgHeight,
					    rPreParsingPicInfo->u4Width,
					    rPreParsingPicInfo->u4Height,
					    rPreParsingPicInfo->u4OrgWidth,
					    rPreParsingPicInfo->u4OrgHeight);
				printk
				    ("=====> I Racing Mode, Image resizer is now waiting for vdec...\n");
			}
#endif				/* RM_RPR_RACINGMODE_ENABLE */
/*
...
*/
			...
			if (_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.fgRPRRacingModeEnable) {
				...
				printk
				    ("=====> P Racing Mode, About to trigger image resizer in racing mode...\n");
				vRprImgResz(u4InstID, prPic->u4Width, prPic->u4Height,
					    prPic->u4OrgWidth, prPic->u4OrgHeight,
					    rPreParsingPicInfo->u4Width,
					    rPreParsingPicInfo->u4Height,
					    ...
					    rPreParsingPicInfo->u4OrgHeight);
				printk
				    ("=====> P Racing Mode, Image resizer is now waiting for vdec...\n");
			}
#endif				/* RM_RPR_RACINGMODE_ENABLE */
/*
#ifdef RPR_RACING
...
*/
			...
			if (prParsingPic->u4OrgWidth != prParsingPic->u4PrevDispWidth || prParsingPic->u4OrgHeight != prParsingPic->u4PrevDispHeight)	/* RPR */
			{
				...
				vRprImgResz(u4InstID,
					    prParsingPic->u4PrevDecWidth,
					    prParsingPic->u4PrevDecHeight,
					    prParsingPic->u4PrevDispWidth,
					    prParsingPic->u4PrevDispHeight, prParsingPic->u4Width,
					    prParsingPic->u4Height, prParsingPic->u4OrgWidth,
					    prParsingPic->u4OrgHeight);
...
#endif
				{
					...
					vRprImgResz(_u4PrevDecWidth, _u4PrevDecHeight,
...
/* VDec HW Init Flow  ////////////////////////////////////////////////////////// */
	...
	if (_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMFIFORPtr ==
		...
		pu4FIFOPtr =
		    (UINT32 *) _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMFIFORPtr;
	...
	_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMFIFORPtr =
	    ((UINT32) pu4FIFOPtr) + u4FrmInfoLength;
...
inline UINT32 mb_to_line_y(UINT32 buf, int width, int x, int y)
{
	...
	offset = offset_x + (offset_y << 4) + (mb_x << 9) + (((mb_y >> 1) * width) << 5);
...
static inline void mb_to_line_c(UINT32 *pu4Val1, UINT32 *pu4Val2, UINT32 buf, int width, int x,
				int y)
{
	int mb_x;
	int mb_y;
	...
	offset = (offset_x << 1) + (offset_y << 4) + (mb_x << 8) + (((mb_y >> 1) * width) << 4);
		      ...
		      UINT32 u4BlockWidth, UINT32 u4BlockHeight)
{
	...
	while (u4Addr < u4Len) {
		*(UCHAR *) (u4DestBufSA + u4Y * u4BufWidth + u4X) =
		    *(UCHAR *) (u4SrcBufSA + u4Addr);
		u4Addr++;
		u4X++;
	...
	for (y = 0; y < u4Height && fgYOK; y++) {
		for (x = 0; x < u4Width && fgYOK; x += 4) {
			...
			if (u4ErrVal != u4GolVal) {
				...
				printk
				    ("<vdec> Y mismatch. x=%d, y=%d. HW Val = 0x%08X, Golden Val = 0x%08X\n",
	...
	for (y = 0; y < u4Height / 2 && fgUOK && fgVOK; y++) {
		for (x = 0; x < u4Width / 2 && fgUOK && fgVOK; x += 4) {
			...
			if (u4ErrVal != u4GolVal) {
				...
				printk
				    ("<vdec> C mismatch. x=%d, y=%d. HW Val = 08X, Golden Val = 0x%08X\n",
				     x, y, u4ErrVal, u4GolVal);
...
#endif				/* DIRECT_DEC */
		{
			...
			for (u4Pix = 0; u4Pix < u4Width * (u4Height >> 1); u4Pix++) {
				...
				/* if((_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecMPEGDecPrm.fgDec2ndFld) || (_tVerMpvDecPrm[u4InstID].ucPicStruct == FRM_PIC)) */
				{
					...
					pbGoldenBuf =
					    (UCHAR *) ((UINT32) _pucDumpCBuf[u4InstID] + u4Pix);

					if ((((*(pbDecBuf)) > (*(pbGoldenBuf)))
					     && ((*(pbDecBuf)) <=
						 (*(pbGoldenBuf) + DSCL_TOLERATED_RANGE)))
				  ...
				  BOOL lk_en, UINT32 luma_key)
{
...
#else
	vRM_dscl(u4InstID, srcWidth, srcHeight, targetWidth, targetHeight, srcDataY, targetData, 0,
		 pic_stru, tgbufLen, h_ofst, v_ofst, src_agent, spec_type, mbaff, fg_src,
			...
			for (i = 0; i < tgblkCnt; i++)	/* block count */
			{
				for (k = 0; k < (tgbufLen / 16); k++) {
					for (j = 0; j < 32; j++)	/* line count */
					{
						...
						/* PANDA */
						else if (((_tVerMpvDecPrm[u4InstID].rDownScalerPrm.
	...
	vdscl(u4InstID, srcWidth, srcHeight / 2, targetWidth, targetHeight, srcDataC, targetData, 1,
	      pic_stru, tgbufLen, h_ofst, v_ofst, src_agent, spec_type, mbaff, fg_src);
#else
	vRM_dscl(u4InstID, srcWidth, srcHeight / 2, targetWidth, targetHeight, srcDataC, targetData,
		 1, pic_stru, tgbufLen, h_ofst, v_ofst, src_agent, spec_type, mbaff, fg_src,
...
void vCheckGlobalChecksum(UINT32 u4InstID)
{
	...
	UINT32 u4ChecksumBuf =
	    _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4GlobalChecksumBuf;
#ifdef RM_DUMP_CHECKSUM
	UINT32 u4ChecksumBufSize =
	    _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4GlobalChecksumBufSize;
...
void crc32(unsigned char *src, int component)
{
	...
	for (i = 0; i < 4; i++) {
		data =
		    (src[4 * i + 0] << 0) + (src[4 * i + 1] << 8) + (src[4 * i + 2] << 16) +
		    (src[4 * i + 3] << 24);
		if (component == 0)	/* Y */
...
/* HalFlushInvalidateDCache(); */
	...
	if ((u4LoopDecodeTargetCnt + 1) >= u4LoopDecodeFrmCnt)
...
#endif				/* RM_SKIPFRAME_Test */
		{
			...
			if (_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.
			    u4CRCCheckFrameNumber ==
			    _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.rRMParsPicInfo.
			    u4DecodedPicCnt) {
				/* Check Golden */
				if (fgRM_CheckYCGolden(u4InstID) == FALSE) {
			...
			/* Check Golden */
			if ((_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.rRMParsPicInfo.
			     u4DecodedPicCnt >= _u4StartCompPicNum[u4InstID])
			    && (_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.rRMParsPicInfo.
				u4DecodedPicCnt <= _u4EndCompPicNum[u4InstID])) {
				if (fgRM_CheckYCGolden(u4InstID) == FALSE) {
					printk("<vdec> RM Dec Cnt = %u is error\n",
					       _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.
					       rRMParsPicInfo.u4DecodedPicCnt);
					/* ASSERT(0); */
				}
	...
	if (((prParsingPic->ePtype == RM_INTRAPIC) ||
	     (prParsingPic->ePtype == RM_FORCED_INTRAPIC) ||
	     (prParsingPic->ePtype == RM_INTERPIC)) && (fgGetNextIPPic == FALSE)) {
		if (u4SkipCheckFrameNum <
		    _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.rRMParsPicInfo.
		    u4DecodedPicCnt) {
			fgGetNextIPPic = TRUE;
		}
...
/* HalFlushInvalidateDCache(); */
	...
	u4Size =
	    ((((prParsingPic->u4OrgWidth + 15) >> 4) * ((prParsingPic->u4OrgHeight +
							 31) >> 5)) << 9);
...
/* HalFlushInvalidateDCache(); */
	...
	vRM_GenerateDownScalerGolden(u4InstID,
				     ...
				     u4Size, fgLumaKeyEnable, u4LumaKey);
#else				/* DSCL_LUMAKEY_ENABLE */
	vGenerateDownScalerGolden(u4InstID, (UINT32) _pucDecWorkBuf[u4InstID],
				  (UINT32) (_pucDecCWorkBuf[u4InstID]), u4Size);
#endif				/* DSCL_LUMAKEY_ENABLE */
...
/* Update Src Bitstream and Golden Data */
	{
		...
		if (_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.fgCRCLoadGoldenFlag == FALSE) {
...
#ifdef RM_CRCCHECK_ENABLE
			sprintf(strEmuFileName, "%s/%s%07d%s",
				_bFileStr1[u4InstID][RM_GOLDENPATH_INDEX], strRMGoldenFileName,
				_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.
				u4CRCCheckFrameNumber, strGoldenFileNameExt_FileList);
#else				/* RM_CRCCHECK_ENABLE */
			{
				UINT32 u4PicCnt =
				    _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.
				    rRMParsPicInfo.u4DecodedPicCnt;
				if (u4PicCnt / 5000 > 0) {
					sprintf(strEmuFileName, "%s%05d/%s%07d%s",
						_bFileStr1[u4InstID][RM_GOLDENPATH_INDEX],
						u4PicCnt / 5000 * 5000, strRMGoldenFileName,
						_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.
						rRMParsPicInfo.u4DecodedPicCnt,
			...
			sprintf(strEmuFileName, "%s\\%s%07d%s",
				_bFileStr1[u4InstID][RM_GOLDENPATH_INDEX], strRMGoldenFileName,
				_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.rRMParsPicInfo.
				u4DecodedPicCnt, strGoldenFileNameExt_FileList);
#endif				/* RM_CRCCHECK_ENABLE */
...
#ifdef RM_CRCCHECK_ENABLE
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.fgCRCLoadGoldenFlag =
			    TRUE;
		}
#endif				/* RM_CRCCHECK_ENABLE */
		...
		/* sprintf(strEmuFileName, "%s/%s%07d%s", _bFileStr1[u4InstID][RM_SOURCEPATH_INDEX], */
		{
			...
			if (u4PicCnt / 5000 > 0) {
				sprintf(strEmuFileName, "%s%05d/%s%07d%s",
					_bFileStr1[u4InstID][RM_SOURCEPATH_INDEX],
					u4PicCnt / 5000 * 5000, strRMSrcFileName, u4PicCnt,
					strSrcFileNameExt_FileList);
			} else {
				sprintf(strEmuFileName, "%s%s%07d%s",
					_bFileStr1[u4InstID][RM_SOURCEPATH_INDEX], strRMSrcFileName,
					u4PicCnt, strSrcFileNameExt_FileList);
			}
		}
#else				/* SATA_HDD_FS_SUPPORT */
		sprintf(strEmuFileName, "%s\\%s%07d%s", _bFileStr1[u4InstID][RM_SOURCEPATH_INDEX],
			strRMSrcFileName,
			_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.rRMParsPicInfo.
			u4DecodedPicCnt, strSrcFileNameExt_FileList);
#endif				/* SATA_HDD_FS_SUPPORT */
...
#ifdef RM_RINGVIFO_FLOW
		{
			...
			UINT32 u4VFIFOSa =
			    _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMVFIFOSa;
			UINT32 u4VFIFOSz =
			    _tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMVFIFOSz;
			...
			if ((u4VFifoWPtr + _tInFileInfo[u4InstID].u4FileLength) <
			    (UINT32) (u4VFIFOSa + u4VFIFOSz)) {
				...
				memcpy((void *)(u4VFIFOSa), (void *)(u4TempVFIFOSa + u4CopySize),
				       u4RemSz);
				_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.u4RMVFIFOWPtr =
				    u4VFIFOSa + u4RemSz;
			}
