...
INT32 i4VDEC_HAL_MPEG_InitVDecHW(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_MPEG_ShiftGetBitStream(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
...
UINT32 u4VDEC_HAL_MPEG_GetBitStreamShift(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
					 UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					 UINT32 u4ShiftBits	/* /< [IN] Shift bits number */
    );
...
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_MPEG_InitBarrelShifter(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
					UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					VDEC_INFO_MPEG_BS_INIT_PRM_T * prMpegBSInitPrm);

INT32 i4VDEC_HAL_MPEG2_InitBarrelShifter(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
					 UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					 VDEC_INFO_MPEG_BS_INIT_PRM_T * prMpegBSInitPrm);
...
UINT32 u4VDEC_HAL_MPEG_ReadRdPtr(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				 UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_MPEG_AlignRdPtr(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
			       UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
			       UINT32 u4VFIFOSa,	/* /< [IN] Video FIFO start address */
...
UINT32 u4VDEC_HAL_MPEG_GetBitcount(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				   UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
#endif
...
void vVDEC_HAL_MPEG12_LoadQuantMatrix(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
#if (CONFIG_DRV_ONLY || CONFIG_DRV_VERIFY_SUPPORT)
BOOL fgVDEC_HAL_MPEG4_LoadQuantMatrix(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
				      BOOL fgIntra,	/* /< [IN] flag of intra block or not */
...
/* / \return None */
void vVDEC_HAL_MPEG12_FW_LoadQuantMatrix(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					 BOOL fgIntra,	/* /< [IN] flag of intra block or not */
...
/* / \return None */
void vVDEC_HAL_MPEG4_FW_LoadQuantMatrix(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					BOOL fgIntra,	/* /< [IN] flag of intra block or not */
					UINT32 *pu4QuanMatrixLen,	/* /< [IN] Pointer of MPEG4 quantization matrix length */
...
/* / \return None */
void vVDEC_HAL_MPEG_ReLoadQuantMatrix(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
				      BOOL fgIntra	/* /< [IN] flag of intra block or not */
    );
...
/* / and load it */
/* / \return None */
void vVDEC_HAL_MPEG_ReStoreQuantMatrix(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
				       BOOL fgIntra,	/* /< [IN]  flag of intra block or not */
...
/*  */
void vVDEC_HAL_MPEG_ResetQuantMatrix(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
/* / \return None */
#if (CONFIG_DRV_ONLY || CONFIG_DRV_VERIFY_SUPPORT)
void vVDEC_HAL_MPEG_SetMPEG4Flag(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_MPEG12_DecStart(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / Set video decoder hardware registers to decode */
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_DIVX3_DecStart(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / Set video decoder hardware registers to decode */
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_MPEG4_DecStart(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / Set video decoder hardware registers to decode */
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_MPEG_VPStart(UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T * prDecPrm	/* /< [IN] Pointer to WMV decode Information */
    );


/* / Read current decoded mbx and mby */
/* / \return None */
void vVDEC_HAL_MPEG_GetMbxMby(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_MPEG_GetErrInfo(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_MPEG4_GetErrType(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
