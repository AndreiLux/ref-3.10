...
INT32 i4VDEC_HAL_VP8_InitVDecHW(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_VP8_ShiftGetBitStream(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
...
UINT32 u4VDEC_HAL_VP8_GetBitStreamShift(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
					UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					UINT32 u4ShiftBits	/* /< [IN] Shift bits number */
    );
...
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_VP8_InitBarrelShifter(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				       UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_VP8_ReadRdPtr(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_VP8_AlignRdPtr(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
			      UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_VP8_GetBitcount(UINT32 u4BSID,	/* /< [IN] Barrel shifter ID */
				  UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
/* / Set video decoder hardware registers to decode */
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_VP8_VPStart(UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T * prDecPrm	/* /< [IN] Pointer to VP8 decode Information */
    );


/* / Read current decoded mbx and mby */
/* / \return None */
void vVDEC_HAL_VP8_GetMbxMby(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_VP8_GetErrInfo(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_VP8_GetErrType(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
/* / Read Barrel Shifter before shifting */
/* / \return Value of barrel shifter input window before shifting */
UINT32 u4VDEC_HAL_VP8_GetBoolCoderShift(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
					UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					UINT32 u4ShiftBits	/* /< [IN] Shift bits number */
    );
...
/* / Read Barrel Shifter before shifting */
/* / \return Value of barrel shifter input window before shifting */
UINT32 u4VDEC_HAL_VP8_InitBoolCoder(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				    UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
