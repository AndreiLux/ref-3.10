...
INT32 i4VDEC_HAL_AVS_InitVDecHW(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_AVS_ShiftGetBitStream(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
...
UINT32 u4VDEC_HAL_AVS_GetBitStreamShift(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
					UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					UINT32 u4ShiftBits	/* /< [IN] Shift bits number */
    );
...
UINT32 u4VDEC_HAL_AVS_GetRealBitStream(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				       UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
				       UINT32 u4ShiftBits	/* /< [IN] Shift bits number */
    );
...
BOOL bVDEC_HAL_AVS_GetBitStreamFlg(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				   UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_AVS_DecStart(UINT32 u4BsID, UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T * prDecPrm	/* /< [IN] Pointer to AVS decode Information */
    );


/* / Read current decoded mbx and mby */
/* / \return None */
void vVDEC_HAL_AVS_GetMbxMby(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
BOOL fgVDEC_HAL_AVS_DecPicComplete(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
UINT32 u4VDEC_HAL_AVS_GetErrMsg(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );


/* / Check AVS error info */
/* / \return AVS decode error check result */
BOOL fgVDEC_HAL_AVS_ChkErrInfo(UINT32 u4BSID,	/* /< [IN] Barrel shifter ID */
			       UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_AVS_VDec_DumpReg(UINT32 u4VDecID);
...
/* / \return None */
void vVDEC_HAL_AVS_VDec_ReadCheckSum(UINT32 u4VDecID, UINT32 *pu4CheckSum);
