...
INT32 i4VDEC_HAL_WMV_InitVDecHW(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_WMV_ShiftGetBitStream(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
...
UINT32 u4VDEC_HAL_WMV_GetBitStreamShift(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
					UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					UINT32 u4ShiftBits	/* /< [IN] Shift bits number */
    );
#endif
...
UINT32 u4VDEC_HAL_WMV_GetRealBitStream(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				       UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
				       UINT32 u4ShiftBits	/* /< [IN] Shift bits number */
    );
...
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_WMV_InitBarrelShifter(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				       UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_WMV_ReadRdPtr(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_WMV_AlignRdPtr(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
			      UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_WMV_HWDecBP(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
#if 0				/* VDEC_REMOVE_UNUSED_FUNC */
UINT32 u4VDEC_HAL_WMV_GetBitcount(UINT32 u4BSID,	/* /< [IN] Barrel shifter ID */
				  UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
#endif
...
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_WMV_DecStart(UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T * prDecPrm	/* /< [IN] Pointer to WMV decode Information */
    );


/* / Set video decoder hardware registers to decode */
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_WMV_VPStart(UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T * prDecPrm	/* /< [IN] Pointer to WMV decode Information */
    );


/* / Read current decoded mbx and mby */
/* / \return None */
void vVDEC_HAL_WMV_GetMbxMby(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_WMV_GetErrInfo(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_WMV_GetErrType(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
