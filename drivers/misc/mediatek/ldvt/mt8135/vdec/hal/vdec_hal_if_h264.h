...
INT32 i4VDEC_HAL_H264_InitVDecHW(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_H264_ShiftGetBitStream(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
...
UINT32 u4VDEC_HAL_H264_GetBitStreamShift(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
					 UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					 UINT32 u4ShiftBits	/* /< [IN] Shift bits number */
    );
...
UINT32 u4VDEC_HAL_H264_GetRealBitStream(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
					UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					UINT32 u4ShiftBits	/* /< [IN] Shift bits number */
    );
...
BOOL bVDEC_HAL_H264_GetBitStreamFlg(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				    UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
UINT32 u4VDEC_HAL_H264_UeCodeNum(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				 UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
INT32 i4VDEC_HAL_H264_SeCodeNum(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
UINT32 u4VDEC_HAL_H264_GetStartCode(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				    UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );

/* / Get next start code */
/* / \return Current input window of vld while finding start code */
UINT32 u4VDEC_HAL_H264_GetStartCode_8530(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
					 UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_H264_InitBarrelShifter(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
					UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_H264_ReadRdPtr(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				 UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
				 UINT32 u4VFIFOSa, UINT32 * pu4Bits	/* /< [OUT] Read pointer with remained bits */
    );


/* / Align read pointer to byte,word or double word */
/* / \return None */
void vVDEC_HAL_H264_AlignRdPtr(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
			       UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_H264_GetBitcount(UINT32 u4BSID,	/* /< [IN] Barrel shifter ID */
				   UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
/* / Decode scaling list */
/* / \return None */
void vVDEC_HAL_H264_ScalingList(UINT32 u4BSID,	/* /< [IN] Barrel shifter ID */
				UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_H264_WriteScalingList(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_H264_Reording(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );


/* / Decode prediction weighting table */
/* / \return None */
void vVDEC_HAL_H264_PredWeightTable(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );


/* / Remove traling bits to byte align */
/* / \return None */
void vVDEC_HAL_H264_TrailingBits(UINT32 u4BSID,	/* /< [IN] Barrel shifter ID */
				 UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
BOOL bVDEC_HAL_H264_IsMoreRbspData(UINT32 u4BSID,	/* /< [IN] Barrel shifter ID */
				   UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
/* / \return None */
void vVDEC_HAL_H264_InitPRefList(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
				 BOOL fgPicFrm, UINT32 u4MaxFrameNum,	/* /< [IN] Maximium frame number */
				 UINT32 u4CurrPicNum);


/* / Set HW registers related with P reference list */
/* / \return None */
void vVDEC_HAL_H264_SetPRefPicListReg(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_H264_SetPOC(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_H264_InitBRefList(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );


/* / Set HW registers related with B reference list */
/* / \return B0 list and B1 list are equal or not */
BOOL bVDEC_HAL_H264_SetBRefPicListReg(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_H264_B1ListSwap(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / Set SPS data to HW */
/* / \return None */
void vVDEC_HAL_H264_SetSPSAVLD(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / Set PPS data to HW */
/* / \return None */
void vVDEC_HAL_H264_SetPPSAVLD(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
			       BOOL fgUserScalingMatrixPresentFlag, BOOL * pfgUserScalingListPresentFlag, VDEC_INFO_H264_PPS_T * prPPS	/* /< [IN] Pointer to struct of picutre parameter set */
    );


/* / Set part of slice header data to HW */
/* / \return None */
void vVDEC_HAL_H264_SetSHDRAVLD1(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_H264_FGTSetting(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4VDEC_HAL_H264_DecStart(UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T * prDecPrm	/* /< [IN] Pointer to H264 decode Information */
    );


/* / Read current decoded mbx and mby */
/* / \return None */
void vVDEC_HAL_H264_GetMbxMby(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
BOOL fgVDEC_HAL_H264_DecPicComplete(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
UINT32 u4VDEC_HAL_H264_GetErrMsg(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );


/* / Check h264 error info */
/* / \return h264 decode error check result */
BOOL fgVDEC_HAL_H264_ChkErrInfo(UINT32 u4BSID,	/* /< [IN] Barrel shifter ID */
				UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_H264_MVC_Switch(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / \return None */
void vVDEC_HAL_H264_SetInterViewPRefPicListReg(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
					       VDEC_INFO_H264_P_REF_PRM_T * prPRefPicListInfo	/* /< [IN] Pointer to struct of P reference picutre list information */
    );

/* / Set HW registers related with InterVire reference list */
/* / \return None */
void vVDEC_HAL_H264_SetInterViewB0RefPicListReg(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
						VDEC_INFO_H264_P_REF_PRM_T * prPRefPicListInfo	/* /< [IN] Pointer to struct of P reference picutre list information */
    );

/* / Set HW registers related with InterVire reference list */
/* / \return None */
void vVDEC_HAL_H264_SetInterViewB1RefPicListReg(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
						VDEC_INFO_H264_P_REF_PRM_T * prPRefPicListInfo	/* /< [IN] Pointer to struct of P reference picutre list information */
    );
...
void vVDEC_HAL_H264_VDec_ReadCheckSum1(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
/* / Compare decode checksum with golden, only for verification */
/* / \return True for match, false for mismatch */
void vVDEC_HAL_H264_VDec_ReadCheckSum2(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
#endif
