...
/* #define VDEC_IO_BASE (VDEC_BASE + 0x20000) ///TODO: */

#define VDEC_IO_BASE VDEC_BASE

/* ********************************************************************* */
/* Video Decoder Macros */
/* ********************************************************************* */
#define vWriteVDecReg(dAddr, dVal) mt65xx_reg_sync_writel(dVal, (VDEC_BASE + dAddr))
#define u4ReadVDecReg(dAddr) *(volatile UINT32 * )(VDEC_BASE + dAddr)
...
#define vWriteReg(dAddr, dVal)  mt65xx_reg_sync_writel(dVal, VDEC_IO_BASE + dAddr)	/* *(volatile UINT32 *)(IO_BASE + dAddr) = dVal */
#define u4ReadReg(dAddr)        *(volatile UINT32 * )(VDEC_IO_BASE + dAddr)
...
extern UINT32 u4VDecReadVldRPtrEx(UINT32 u4BSID, UINT32 u4VDecID, UINT32 *pu4Bits,
				  UINT32 u4VFIFOSa, const char *szFunction, INT32 i4Line);
...
extern void vVDecSimWDump(const char *szFunction, UINT32 u4VDecID, const char *szOffset,
			  UINT32 u4Addr, UINT32 u4Val, UINT32 u4BaseReg);
extern void vVDecSimRDump(const char *szFunction, UINT32 u4VDecID, const char *szOffset,
			  UINT32 u4Addr, UINT32 u4Val, UINT32 u4BaseReg);
