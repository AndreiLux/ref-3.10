...
void vRM_Hal_InitVDecHW(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
			VDEC_INFO_RM_VFIFO_PRM_T * prRMVFifoPrm	/* /< [IN] VFIFO Information */
    );

/* / Initialize Barrel Shifter HW */
/* / \return If return value < 0, it's failed. Please reference hal_vdec_errcode.h. */
INT32 i4RM_HAL_InitBarrelShifter(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
...
UINT32 u4VDEC_HAL_RM_ShiftGetBitStream(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
				       UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / Trigger RM Decoder */
/* / \return None */
void vVDEC_HAL_RM_TriggerDecode(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / VLD Soft Reset */
/* / \return None */
void vRM_Hal_VldSoftReset(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );
...
/* / MV HW Init */
/* / \return None */
void vRM_Hal_MvInit(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
/* / MC HW Init */
/* / \return None */
void vRM_Hal_McInit(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );


/* / PP HW Init */
/* / \return None */
void vRM_Hal_PpInit(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );


/* / VLD Init */
/* / \return None */
void vRM_Hal_VldInit(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
UINT32 u4VDEC_HAL_RM_VDec_ReadFinishFlag(UINT32 u4VDecID	/* /< [IN] Video decoder hardware ID */
    );


/* / Get MB X,Y */
/* / \return None */
void vVDEC_HAL_RM_GetMbxMby(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
...
void vVDEC_HAL_RM_GetRefQpMb0(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
			      UINT32 * pu4RefQpMb0	/* /< [OUT] RefQpMb0 HW Result */
    );

/* / Get RM HW Erro Info */
void vVDEC_HAL_RM_GetErrInfo(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
			     VDEC_INFO_RM_ERR_INFO_T * prRMErrInfo	/* /< [OUT] HW Error Info */
    );


/* / Get VLD HW Real Read Pointer */
UINT32 u4VDEC_HAL_RM_ReadRdPtr(UINT32 u4BSID,	/* /< [IN] Barrel shifter hardware ID of one video decoder */
			       UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
