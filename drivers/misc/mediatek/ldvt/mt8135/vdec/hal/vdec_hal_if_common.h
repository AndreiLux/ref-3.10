...
INT32 i4VDEC_HAL_Common_Init(UINT32 u4ChipID	/* /< [IN] Chip ID */
    );
...
/* / \return None */
void u4VDEC_HAL_Common_GetHWResourceNum(UINT32 *pu4BSNum,	/* /< [OUT] Pointer to barrel shifter number of every VLD */
...
/* / \return None */
void vDEC_HAL_COMMON_SetVLDPower(UINT32 u4VDecID,	/* /< [IN] Video decoder hardware ID */
				 BOOL fgOn	/* /< [IN] Turn on or off VLD */
    );


#if ((CONFIG_CHIP_VER_CURR >= CONFIG_CHIP_VER_MT8560) && CONFIG_DRV_FTS_SUPPORT)
INT32 vDEC_HAL_COMMON_ReadLBDResult(UINT32 ucMpvId,
				    UINT32 *u4YUpbound,
				    UINT32 *u4YLowbound,
				    UINT32 *u4CUpbound, UINT32 *u4CLowbound);
#endif
...
INT32 i4VDEC_HAL_Dram_Busy(UINT32 u4ChipID,	/* /< [IN] Chip ID */
			   UINT32 u4StartAddr, UINT32 u4Offset);

INT32 i4VDEC_HAL_Dram_Busy_Off(UINT32 u4ChipID,	/* /< [IN] Chip ID */
			       UINT32 u4StartAddr, UINT32 u4Offset);
