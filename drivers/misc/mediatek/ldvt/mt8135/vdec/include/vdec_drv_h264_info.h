...
extern UCHAR ucH264GetMaxFBufNum(VDEC_INFO_H264_DEC_PRM_T *prVDecH264DecPrm, UINT32 u4PicWidth,
				 UINT32 u4PicHeight, BOOL fgIsBDDisc);
...
extern void vSetPicRefType(UCHAR ucPicStruct, UCHAR ucRefType,
...
void vDec_Ref_Pic_Marking(UINT32 u4VDecID, VDEC_INFO_H264_SLICE_HDR_T *prSliceHdr,
			  BOOL fgIsIDRPic);
...
void vH264SetSampleAsp(H264_DRV_INFO_T *prH264DrvDecInfo, UINT32 u4H264Asp, UINT32 u4SarWidth,
		       UINT32 u4SarHeight);
void vH264SetFrameTimingInfo(H264_DRV_INFO_T *prH264DrvDecInfo, UINT32 u4NumUnitsInTick,
			     UINT32 u4TimeScale, BOOL fgIsFixFrm);
...
extern void vH264UpdDFBListIdxInfo(H264_DRV_INFO_T *prH264DrvInfo, UCHAR ucDPBFbId,
				   UCHAR ucH264FBUFListIdx);
...
extern void vPrefix_Nal_Unit_Rbsp(UINT32 u4BSID, UINT32 u4VDecID,
				  H264_DRV_INFO_T *prH264DrvDecInfo);
extern void vSubset_Seq_Parameter_Set_Rbsp(UINT32 u4BSID, UINT32 u4VDecID,
					   H264_DRV_INFO_T *prH264DrvDecInfo);
