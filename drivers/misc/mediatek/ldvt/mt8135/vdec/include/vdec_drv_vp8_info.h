...
/* / . */
/* / \return None. */
extern void vVP8InitProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern INT32 i4VP8VParseProc(UCHAR ucEsId,	/* /< [IN] the ID of the elementary stream */
...
extern BOOL fgVP8VParseChkProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern INT32 i4VP8UpdInfoToFbg(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function triggers Video decoder hardware */
/* /\ return None. */
extern void vVP8StartToDecProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function is interrrupt service routine */
/* /\ return None. */
extern void vVP8ISR(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsVP8DecEnd(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsVP8DecErr(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function checks is there any error code happened in HW */
/* /\ return TRUE: decode OK, FALSE: decoding failed, drop it */
extern BOOL fgVP8ResultChk(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsVP8InsToDispQ(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsVP8GetFrmToDispQ(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function does ending procedure */
/* /\ return None. */
extern void vVP8EndProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
/* / This function flushes all decoded picture in DPB Buffer */
/* /\ return TRUE: flush OK, FALSE: cannot get buffer for display */
extern BOOL fgVP8FlushDPB(UCHAR ucEsId,	/* /< [IN] the ID of the elementary stream */
			  BOOL fgWithOutput	/* /< [IN] '1' indicates to output decoded frame */
    );
/* / This function will release resources accupied by decoder */
/* /\ return None. */
extern void vVP8ReleaseProc(UCHAR ucEsId,	/* /< [IN] the ID of the elementary stream */
			    BOOL fgResetHW);
