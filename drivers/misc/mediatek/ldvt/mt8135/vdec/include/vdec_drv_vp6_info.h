...
/* / . */
/* / \return None. */
extern void vVP6InitProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern INT32 i4VP6VParseProc(UCHAR ucEsId,	/* /< [IN] the ID of the elementary stream */
...
extern BOOL fgVP6VParseChkProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern INT32 i4VP6UpdInfoToFbg(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function triggers Video decoder hardware */
/* /\ return None. */
extern void vVP6StartToDecProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function is interrrupt service routine */
/* /\ return None. */
extern void vVP6ISR(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsVP6DecEnd(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsVP6DecErr(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function checks is there any error code happened in HW */
/* /\ return TRUE: decode OK, FALSE: decoding failed, drop it */
extern BOOL fgVP6ResultChk(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsVP6InsToDispQ(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsVP6GetFrmToDispQ(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function does ending procedure */
/* /\ return None. */
extern void vVP6EndProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
/* / This function flushes all decoded picture in DPB Buffer */
/* /\ return TRUE: flush OK, FALSE: cannot get buffer for display */
extern BOOL fgVP6FlushDPB(UCHAR ucEsId,	/* /< [IN] the ID of the elementary stream */
			  BOOL fgWithOutput	/* /< [IN] '1' indicates to output decoded frame */
    );
/* / This function will release resources accupied by decoder */
/* /\ return None. */
extern void vVP6ReleaseProc(UCHAR ucEsId,	/* /< [IN] the ID of the elementary stream */
			    BOOL fgResetHW);
