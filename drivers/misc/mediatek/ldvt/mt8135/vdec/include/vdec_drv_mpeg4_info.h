...
/* / . */
/* / \return None. */
extern void vMPEG4InitProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern INT32 i4MPEG4VParseProc(UCHAR ucEsId,	/* /< [IN] the ID of the elementary stream */
...
extern BOOL fgMPEG4VParseChkProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern INT32 i4MPEG4UpdInfoToFbg(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function triggers Video decoder hardware */
/* /\ return None. */
extern void vMPEG4StartToDecProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function is interrrupt service routine */
/* /\ return None. */
extern void vMPEG4ISR(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsMPEG4DecEnd(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsMPEG4DecErr(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function checks is there any error code happened in HW */
/* /\ return TRUE: decode OK, FALSE: decoding failed, drop it */
extern BOOL fgMPEG4ResultChk(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsMPEG4InsToDispQ(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
...
extern BOOL fgIsMPEG4GetFrmToDispQ(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );

/* / This function does ending procedure */
/* /\ return None. */
extern void vMPEG4EndProc(UCHAR ucEsId	/* /< [IN] the ID of the elementary stream */
    );
/* / This function flushes all decoded picture in DPB Buffer */
/* /\ return TRUE: flush OK, FALSE: cannot get buffer for display */
extern BOOL fgMPEG4FlushDPB(UCHAR ucEsId,	/* /< [IN] the ID of the elementary stream */
			    BOOL fgWithOutput	/* /< [IN] '1' indicates to output decoded frame */
    );
/* / This function will release resources accupied by decoder */
/* /\ return None. */
extern void vMPEG4ReleaseProc(UCHAR ucEsId,	/* /< [IN] the ID of the elementary stream */
			      BOOL fgResetHW);

extern void vMPEG4SetMcBufAddr(UCHAR ucFbgId, VDEC_ES_INFO_T *prVDecEsInfo);
extern void vMPEG4DpbBufCopy(MPEG4_DRV_INFO_T *prMpeg4DrvInfo, UCHAR ucTarDpbBuf,
			     UCHAR ucSrcDpbBuf);
...
#ifdef MPV_DUMP_FBUF
extern void VDec_Dump_Data(UINT32 u4StartAddr, UINT32 u4FileSize, UINT32 u4FileCnt,
			   UCHAR *pucAddStr);
#endif
