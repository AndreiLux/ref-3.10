...
#define MHL_MSCDDC_ERR_2S (2000/MHL_LINK_TIME)
/************************************************
	DDC cmd
************************************************/
...
typedef struct {
	...
	unsigned short u2TXLen;
	unsigned short u2TXRetry;
} stCbusTX_st;
...
extern unsigned int u1CbusHwStatus;

extern void vSetMHLUSBMode(bool fgUse);
...
extern bool fgCbusReqMscMsgCmd(unsigned char u1Cmd, unsigned char u1Val);
