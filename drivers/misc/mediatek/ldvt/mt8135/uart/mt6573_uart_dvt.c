...
static unsigned int uart_base[] =
    { UART1_BASE_ADDR, UART2_BASE_ADDR, UART3_BASE_ADDR, UART4_BASE_ADDR };
static unsigned int vff_tx_base[] =
    { VFF_TX1_BASE_ADDR, VFF_TX2_BASE_ADDR, VFF_TX3_BASE_ADDR, VFF_TX4_BASE_ADDR };
static unsigned int vff_rx_base[] =
    { VFF_RX1_BASE_ADDR, VFF_RX2_BASE_ADDR, VFF_RX3_BASE_ADDR, VFF_RX4_BASE_ADDR };
