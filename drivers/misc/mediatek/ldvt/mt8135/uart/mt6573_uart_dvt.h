...
/* UART 1 Pin ID*/
#define UART1_TX_GPIO_PIN           (78)
#define UART1_RX_GPIO_PIN           (77)
#if 1				/* 8135 */
#define UART1_CTS_GPIO_PIN          (71)
#define UART1_RTS_GPIO_PIN          (72)
#else
#define UART1_CTS_GPIO_PIN          (79)
#define UART1_RTS_GPIO_PIN          (80)
#endif

/* UART 1 Pin mode */
#define UART1_TX_GPIO_PIN_M         (1)
#define UART1_RX_GPIO_PIN_M         (1)
#define UART1_CTS_GPIO_PIN_M        (1)
#define UART1_RTS_GPIO_PIN_M        (1)

/* UART 2 Pin ID*/
#define UART2_TX_GPIO_PIN           (70)
#define UART2_RX_GPIO_PIN           (69)
#if 1				/* 8135 */
#define UART2_CTS_GPIO_PIN          (55)
#define UART2_RTS_GPIO_PIN          (56)
#else
#define UART2_CTS_GPIO_PIN          (71)
#define UART2_RTS_GPIO_PIN          (72)
#endif
/* UART 2 Pin mode */
#define UART2_TX_GPIO_PIN_M         (1)
#define UART2_RX_GPIO_PIN_M         (1)
#define UART2_CTS_GPIO_PIN_M        (1)
#define UART2_RTS_GPIO_PIN_M        (1)

/* UART 3 Pin ID*/
#define UART3_TX_GPIO_PIN           (220)
#define UART3_RX_GPIO_PIN           (219)
...
/* UART IRQ ID Section */
#define UART1_IRQ_ID                (83)
#define UART2_IRQ_ID                (84)
#define UART3_IRQ_ID                (85)
#define UART4_IRQ_ID                (86)
...
#define UART1_BASE_ADDR     (0xF1006000)
#define UART2_BASE_ADDR     (0xF1007000)
#define UART3_BASE_ADDR     (0xF1008000)
#define UART4_BASE_ADDR     (0xF1009000)

#define VFF_TX1_BASE_ADDR   (0xF1000000 + 0x680)
#define VFF_TX2_BASE_ADDR   (0xF1000000 + 0x780)
#define VFF_TX3_BASE_ADDR   (0xF1000000 + 0x880)
#define VFF_TX4_BASE_ADDR   (0xF1000000 + 0x980)

#define VFF_RX1_BASE_ADDR   (0xF1000000 + 0x700)
#define VFF_RX2_BASE_ADDR   (0xF1000000 + 0x800)
#define VFF_RX3_BASE_ADDR   (0xF1000000 + 0x900)
#define VFF_RX4_BASE_ADDR   (0xF1000000 + 0xA00)
