...
U32 pmic_wrap_reg_tbl[][4] = {
	...
	,
	{0x04, 0x00000000, 0x00000001, REG_TYP_RW}
	,
	{0x08, 0x00000000, 0x00000001, REG_TYP_RW}
	,
	{0x0C, 0x00000000, 0x00000003, REG_TYP_RW}
	,
...
U32 PERI_PWRAP_BRIDGE_reg_tbl[][4] = {
	{PERI_PWRAP_BRIDGE_BASE + 0x00, 0x00000000, 0x00000001, REG_TYP_RW}
	,
	{PERI_PWRAP_BRIDGE_BASE + 0x04, 0x00000000, 0x0000007F, REG_TYP_RW}
	,
	{PERI_PWRAP_BRIDGE_BASE + 0x08, 0x00000000, 0xFFFFFFFF, REG_TYP_RW}
	,
	{PERI_PWRAP_BRIDGE_BASE + 0x0C, 0x00000000, 0x03FFFFFF, REG_TYP_RW}
	,
...
U32 DEW_reg_tbl[][4] = {
	{DEW_BASE + 0x00, 0x0000, 0x0001, REG_TYP_RW}
	,
	{DEW_BASE + 0x02, 0x0000, 0x0001, REG_TYP_RW}
	,
	{DEW_BASE + 0x04, 0xFFFF, 0xFFFF, REG_TYP_RW}
	,
	{DEW_BASE + 0x06, 0x0000, 0xFFFF, REG_TYP_RU}
	,
	{DEW_BASE + 0x08, 0x0000, 0xFFFF, REG_TYP_RC}
	,
	{DEW_BASE + 0x0A, 0x5AA5, 0xFFFF, REG_TYP_RU}
	,
	{DEW_BASE + 0x0C, 0x0000, 0xFFFF, REG_TYP_RW}
	,
	{DEW_BASE + 0x0E, 0x0000, 0x0001, REG_TYP_RW}
	,
	{DEW_BASE + 0x10, 0x0083, 0x00FF, REG_TYP_RU}
	,
	{DEW_BASE + 0x12, 0x0000, 0x000F, REG_TYP_RW}
	,
	{DEW_BASE + 0x14, 0x0000, 0x000F, REG_TYP_RW}
	,
	{DEW_BASE + 0x16, 0x0000, 0x0001, REG_TYP_WO}
	,
	{DEW_BASE + 0x18, 0x0000, 0x0003, REG_TYP_RW}
	,
	{DEW_BASE + 0x1A, 0x0000, 0x0003, REG_TYP_RW}
	,
	{DEW_BASE + 0x1C, 0x0000, 0x0001, REG_TYP_WO}
	,
	{DEW_BASE + 0x1E, 0x0000, 0x0001, REG_TYP_RW}
	,
	{DEW_BASE + 0x20, 0x0000, 0x0001, REG_TYP_RU}
	,
	{DEW_BASE + 0x22, 0x0000, 0x0001, REG_TYP_RW}
	,
	{DEW_BASE + 0x24, 0x0000, 0x0001, REG_TYP_RW}
	,
	/* {DEW_BASE+ 0x26, 0x0000, 0xFFFF, REG_TYP_RW}, skip from reg rw test */
	/* {DEW_BASE+ 0x28, 0x0000, 0xFFFF, REG_TYP_RW}, */
	/* {DEW_BASE+ 0x2A, 0x0000, 0xFFFF, REG_TYP_RW}, */
	/* {DEW_BASE+ 0x2C, 0x0000, 0xFFFF, REG_TYP_RW}, */
	/* {DEW_BASE+ 0x2E, 0x0000, 0xFFFF, REG_TYP_RW}, */
	/* {DEW_BASE+ 0x30, 0x0000, 0xFFFF, REG_TYP_RW}, */
};
