...
#define HDMIDRV_BASE  (0xF400f800)
...
/* ////////////////////////////////////////////////// */
#define HDMICLK_CFG_9	0x168
#define CLK_DPI1_SEL (0x3<<0)
#define DPI1_MUX_CK 0x0
#define DPI1_H_CK 0x1
#define DPI1_D2  0x2
#define DPI1_D4  0x3
#define CLK_APLL_SEL (0x7<<16)
#define AD_APLL_CK (0x1<<16)
#define APLL_D4 (0x2<<16)
#define APLL_D8 (0x3<<16)
#define APLL_D16 (0x4<<16)
#define APLL_D24 (0x5<<16)

#define CLK_HDMIPLL_SEL (0x3<<24)
#define HDMIPLL_MUX_CK (0x0<<24)
#define HDMIPLL_CTS (0x1<<24)
#define HDMIPLL_D2  (0x2<<24)
#define HDMIPLL_D4  (0x3<<24)
/* /////////////////////////////////////////////////// */
#define HDMI_SYS_CFG110   0x110
#define DISABLE_DPICLK  (1<<7)
#define ENABLE_DPICLK  (0<<7)
#define DISABLE_IDCLK   (1<<12)
#define ENABLE_IDCLK   (0<<12)
#define DISABLE_PLLCLK  (1<<13)
#define ENABLE_PLLCLK  (0<<13)
#define DISABLE_SPDIFCLK (1<<14)
#define ENABLE_SPDIFCLK   (0<<14)
#define DISABLE_BCLK   (1<<15)
#define ENABLE_BCLK  (0<<15)
