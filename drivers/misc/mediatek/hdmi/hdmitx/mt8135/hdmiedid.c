...
void vAnalyzeVGA_DTD(unsigned short ui2HActive, unsigned short ui2VActive, unsigned short ui2Rate,
		 unsigned short ui2Frequency, unsigned short fgFirstDTD)
{
	unsigned int ui4NTSC = 0;

	if (ui2Frequency == 0)
		ui4NTSC = _HdmiSinkAvCap.ui4_sink_dtd_ntsc_resolution;
	else if ((ui2Rate == 0) && fgFirstDTD)
		ui4NTSC = _HdmiSinkAvCap.ui4_sink_1st_dtd_ntsc_resolution;
	else if ((ui2Rate == 0) && (!fgFirstDTD))
		ui4NTSC = _HdmiSinkAvCap.ui4_sink_dtd_pal_resolution;

	switch (ui2HActive) {
	case 1680:
		if ((ui2Frequency == 11900) && (ui2VActive == 1050))
			ui4NTSC |= SINK_1680x1050_60RB;
		else if (((ui2Frequency == 14625) || (ui2Rate == 60)) && (ui2VActive == 1050))
			ui4NTSC |= SINK_1680x1050_60;
		break;
	case 1440:
		if ((ui2Frequency == 8875) && (ui2VActive == 900))
			ui4NTSC |= SINK_1440x900_60RB;
		else if (((ui2Frequency == 10650) || (ui2Rate == 60)) && (ui2VActive == 900))
			ui4NTSC |= SINK_1440x900_60;
		else if (((ui2Frequency == 13675) || (ui2Rate == 75)) && (ui2VActive == 900))
			ui4NTSC |= SINK_1440x900_75;
		else if ((ui2Frequency == 10100) && (ui2VActive == 1050))
			ui4NTSC |= SINK_1440x1050_60RB;
		else if (((ui2Frequency == 12175) || (ui2Rate == 60)) && (ui2VActive == 1050))
			ui4NTSC |= SINK_1440x1050_60;
		break;
	case 1360:
		if (((ui2Frequency == 8550) || (ui2Rate == 60)) && (ui2VActive == 768))
			ui4NTSC |= SINK_1360x768_60;
		break;
	case 1366:
		if (((ui2Frequency == 8550) || (ui2Rate == 60)) && (ui2VActive == 768))
			ui4NTSC |= SINK_1366x768_60;
		break;
	case 1280:
		if (((ui2Frequency == 10800) || (ui2Rate == 60)) && (ui2VActive == 1024))
			ui4NTSC |= SINK_1280x1024_60;
		else if (((ui2Frequency == 13500) || (ui2Rate == 75)) && (ui2VActive == 1024))
			ui4NTSC |= SINK_1280x1024_75;
		else if (((ui2Frequency == 10800) || (ui2Rate == 60)) && (ui2VActive == 960))
			ui4NTSC |= SINK_1280x960_60;
		else if (((ui2Frequency == 14850) || (ui2Rate == 85)) && (ui2VActive == 960))
			ui4NTSC |= SINK_1280x960_85;
		else if (((ui2Frequency == 14625) || (ui2Rate == 120)) && (ui2VActive == 800))
			ui4NTSC |= SINK_1280x800_120;
		else if (((ui2Frequency == 12250) || (ui2Rate == 85)) && (ui2VActive == 800))
			ui4NTSC |= SINK_1280x800_85;
		else if (((ui2Frequency == 10650) || (ui2Rate == 75)) && (ui2VActive == 800))
			ui4NTSC |= SINK_1280x800_75;
		else if (((ui2Frequency == 8350) || (ui2Rate == 60)) && (ui2VActive == 800))
			ui4NTSC |= SINK_1280x800_60;
		else if ((ui2Frequency == 7100) && (ui2VActive == 800))
			ui4NTSC |= SINK_1280x800_60RB;
		else if (((ui2Frequency == 14025) || (ui2Rate == 120)) && (ui2VActive == 768))
			ui4NTSC |= SINK_1280x768_120;
		else if (((ui2Frequency == 11750) || (ui2Rate == 85)) && (ui2VActive == 768))
			ui4NTSC |= SINK_1280x768_85;
		else if (((ui2Frequency == 10225) || (ui2Rate == 75)) && (ui2VActive == 768))
			ui4NTSC |= SINK_1280x768_75;
		else if (((ui2Frequency == 7950) || (ui2Rate == 60)) && (ui2VActive == 768))
			ui4NTSC |= SINK_1280x768_60;
		else if ((ui2Frequency == 6825) && (ui2VActive == 768))
			ui4NTSC |= SINK_1280x768_60RB;
		break;
	case 1152:
		if (((ui2Frequency == 10800) || (ui2Rate == 75)) && (ui2VActive == 864))
			ui4NTSC |= SINK_1152x864_75;
		break;
	case 1024:
		if (((ui2Frequency == 11550) || (ui2Rate == 120)) && (ui2VActive == 768))
			ui4NTSC |= SINK_1024x768_120;
		else if (((ui2Frequency == 9450) || (ui2Rate == 85)) && (ui2VActive == 768))
			ui4NTSC |= SINK_1024x768_85;
		else if (((ui2Frequency == 7875) || (ui2Rate == 75)) && (ui2VActive == 768))
			ui4NTSC |= SINK_1024x768_75;
		else if (((ui2Frequency == 7500) || (ui2Rate == 70)) && (ui2VActive == 768))
			ui4NTSC |= SINK_1024x768_70;
		else if (((ui2Frequency == 6500) || (ui2Rate == 60)) && (ui2VActive == 768))
			ui4NTSC |= SINK_1024x768_60;
		break;
	case 848:
		if (((ui2Frequency == 3375) || (ui2Rate == 60)) && (ui2VActive == 480))
			ui4NTSC |= SINK_848x480_60;
		break;
	case 800:
		if (((ui2Frequency == 4000) || (ui2Rate == 60)) && (ui2VActive == 600))
			ui4NTSC |= SINK_800x600_60;
		break;
	default:
		ui4NTSC |= SINK_640x480_60;
		break;
	}
	...
	if (ui2Frequency == 0)
		...
		_HdmiSinkAvCap.ui4_sink_1st_dtd_ntsc_resolution = ui4NTSC;
	else if ((ui2Rate == 0) && (!fgFirstDTD))
		_HdmiSinkAvCap.ui4_sink_dtd_pal_resolution = ui4NTSC;
	...
	switch (ui2HActive) {
	case 1920:
		if ((ui2Frequency == 14850) && (ui2VActive == 1080))
			ui4NTSC |= SINK_1080P60;
		break;
	case 1280:
		if ((ui2Frequency == 7425) && (ui2VActive == 720))
			ui4NTSC |= SINK_720P60;
		break;
	default:
		break;
	...
	/*the 1<<31 indicate hdmi spec for vga*/
	if ((ui2Rate == 0) && fgFirstDTD)
		_HdmiSinkAvCap.ui4_sink_1st_dtd_ntsc_resolution = ui4NTSC + (1 << 31);
	else if ((ui2Rate == 0) && (!fgFirstDTD))
		_HdmiSinkAvCap.ui4_sink_dtd_pal_resolution = ui4NTSC + (1 << 31);
}
...
unsigned char fgParserEDID(unsigned char *prbData)
{
	...
	unsigned short ui2HActive = 0, ui2HBlanking = 0;
	unsigned short ui2VActive = 0, ui2Rate = 0, ui2Frequency = 0;
	HDMI_EDID_FUNC();
	...
	if (!_HdmiSinkAvCap.ui1_Video_Input_Definitation) {
		/*established timing from address 23 to address 25*/
		_HdmiSinkAvCap.ui4_sink_native_ntsc_resolution =
			*(prbData + EDID_ADDR_ESTABLISHED_TIMING) +
			((*(prbData + EDID_ADDR_ESTABLISHED_TIMING + 1)) << 8) +
			((*(prbData + EDID_ADDR_ESTABLISHED_TIMING + 2)) << 16);
		/*standard timing from address 26 to address 35*/
		for (bIdx = 0; bIdx < 8; bIdx++) {
			ui2HActive = (*(prbData + EDID_ADDR_STANDARD_TIMING + bIdx * 2) + 31) * 8;
			if (((*(prbData + EDID_ADDR_STANDARD_TIMING + bIdx * 2 + 1)) >> 6) == 0)
				ui2VActive = (ui2HActive * 10) / 16;
			else if (((*(prbData + EDID_ADDR_STANDARD_TIMING + bIdx * 2 + 1)) >> 6) == 1)
				ui2VActive = (ui2HActive * 3) / 4;
			else if (((*(prbData + EDID_ADDR_STANDARD_TIMING + bIdx * 2 + 1)) >> 6) == 2)
				ui2VActive = (ui2HActive * 4) / 5;
			else if (((*(prbData + EDID_ADDR_STANDARD_TIMING + bIdx * 2 + 1)) >> 6) == 3)
				ui2VActive = (ui2HActive * 9) / 16;

			ui2Rate = ((*(prbData + EDID_ADDR_STANDARD_TIMING + bIdx * 2 + 1)) & 0x3F) + 60;
			vAnalyzeVGA_DTD(ui2HActive, ui2VActive, ui2Rate, 0, 0);
		}
		/*detailed timing definition from address 36 to address 7D*/
		for (bIdx = 0; bIdx < 4; bIdx++) {
			ui2Frequency = *(prbData + EDID_ADDR_TIMING_DSPR_1 + bIdx * 18) +
				((*(prbData + EDID_ADDR_TIMING_DSPR_1 + bIdx * 18 + 1)) << 8);
			ui2HActive = *(prbData + EDID_ADDR_TIMING_DSPR_1 + bIdx * 18 + 2) +
				(((*(prbData + EDID_ADDR_TIMING_DSPR_1 + bIdx * 18 + 4)) >> 4) << 8);
			ui2VActive = *(prbData + EDID_ADDR_TIMING_DSPR_1 + bIdx * 18 + 5) +
				(((*(prbData + EDID_ADDR_TIMING_DSPR_1 + bIdx * 18 + 7)) >> 4) << 8);
			if (bIdx == 0)
				vAnalyzeVGA_DTD(ui2HActive, ui2VActive, 0, ui2Frequency, 1);
			else
				vAnalyzeVGA_DTD(ui2HActive, ui2VActive, 0, ui2Frequency, 0);
		}
		return TRUE;
	}
...
void vVGATimingInformation_EST(unsigned int u4Res)
{
	if (u4Res & SINK_800x600_60E)
		pr_info("[HDMI]SINK_800x600_60E\n");
	if (u4Res & SINK_800x600_56E)
		pr_info("[HDMI]SINK_800x600_56E\n");
	if (u4Res & SINK_640x480_75E)
		pr_info("[HDMI]SINK_640x480_75E\n");
	if (u4Res & SINK_640x480_72E)
		pr_info("[HDMI]SINK_640x480_72E\n");
	if (u4Res & SINK_640x480_67E)
		pr_info("[HDMI]SINK_640x480_67E\n");
	if (u4Res & SINK_640x480_60E)
		pr_info("[HDMI]SINK_640x480_60E\n");
	if (u4Res & SINK_720x400_88E)
		pr_info("[HDMI]SINK_720x400_88E\n");
	if (u4Res & SINK_800x600_72E)
		pr_info("[HDMI]SINK_800x600_72E\n");
	if (u4Res & SINK_800x600_75E)
		pr_info("[HDMI]SINK_800x600_75E\n");
	if (u4Res & SINK_832x624_75E)
		pr_info("[HDMI]SINK_832x624_75E\n");
	if (u4Res & SINK_1024x768_87E)
		pr_info("[HDMI]SINK_1024x768_87E\n");
	if (u4Res & SINK_1024x768_60E)
		pr_info("[HDMI]SINK_1024x768_60E\n");
	if (u4Res & SINK_1024x768_70E)
		pr_info("[HDMI]SINK_1024x768_70E\n");
	if (u4Res & SINK_1024x768_75E)
		pr_info("[HDMI]SINK_1024x768_75E\n");
	if (u4Res & SINK_1280x1024_75E)
		pr_info("[HDMI]SINK_1280x1024_75E\n");
	if (u4Res & SINK_1152x870_75E)
		pr_info("[HDMI]SINK_1152x870_75E\n");

}
void vVGATimingInformation_STA(unsigned int u4Res)
{
	if (u4Res & SINK_640x480_60)
		pr_info("[HDMI]SINK_640x480_60\n");
	if (u4Res & SINK_848x480_60)
		pr_info("[HDMI]SINK_848x480_60\n");
	if (u4Res & SINK_1024x768_60)
		pr_info("[HDMI]SINK_1024x768_60\n");
	if (u4Res & SINK_1024x768_70)
		pr_info("[HDMI]SINK_1024x768_70\n");
	if (u4Res & SINK_1024x768_75)
		pr_info("[HDMI]SINK_1024x768_75\n");
	if (u4Res & SINK_1024x768_85)
		pr_info("[HDMI]SINK_1024x768_85\n");
	if (u4Res & SINK_1024x768_120)
		pr_info("[HDMI]SINK_1024x768_120\n");
	if (u4Res & SINK_1152x864_75)
		pr_info("[HDMI]SINK_1152x864_75\n");
	if (u4Res & SINK_1280x768_60RB)
		pr_info("[HDMI]SINK_1280x768_60RB\n");
	if (u4Res & SINK_1280x768_60)
		pr_info("[HDMI]SINK_1280x768_60\n");
	if (u4Res & SINK_1280x768_75)
		pr_info("[HDMI]SINK_1280x768_75\n");
	if (u4Res & SINK_1280x768_85)
		pr_info("[HDMI]SINK_1280x768_85\n");
	if (u4Res & SINK_1280x768_120)
		pr_info("[HDMI]SINK_1280x768_120\n");
	if (u4Res & SINK_1280x800_60RB)
		pr_info("[HDMI]SINK_1280x800_60RB\n");
	if (u4Res & SINK_1280x800_60)
		pr_info("[HDMI]SINK_1280x800_60\n");
	if (u4Res & SINK_1280x800_75)
		pr_info("[HDMI]SINK_1280x800_75\n");
	if (u4Res & SINK_1280x800_85)
		pr_info("[HDMI]SINK_1280x800_85\n");
	if (u4Res & SINK_1280x800_120)
		pr_info("[HDMI]SINK_1280x800_120\n");
	if (u4Res & SINK_1280x960_60)
		pr_info("[HDMI]SINK_1280x960_60\n");
	if (u4Res & SINK_1280x960_85)
		pr_info("[HDMI]SINK_1280x960_85\n");
	if (u4Res & SINK_800x600_60)
		pr_info("[HDMI]SINK_800x600_60\n");
	if (u4Res & SINK_1280x1024_60)
		pr_info("[HDMI]SINK_1280x1024_60\n");
	if (u4Res & SINK_1280x1024_75)
		pr_info("[HDMI]SINK_1280x1024_75\n");
	if (u4Res & SINK_1360x768_60)
		pr_info("[HDMI]SINK_1360x768_60\n");
	if (u4Res & SINK_1366x768_60)
		pr_info("[HDMI]SINK_1360x768_120\n");
	if (u4Res & SINK_1440x1050_60RB)
		pr_info("[HDMI]SINK_1440x1050_60RB\n");
	if (u4Res & SINK_1440x1050_60)
		pr_info("[HDMI]SINK_1440x1050_60\n");
	if (u4Res & SINK_1440x900_60RB)
		pr_info("[HDMI]SINK_1440x900_60RB\n");
	if (u4Res & SINK_1440x900_60)
		pr_info("[HDMI]SINK_1440x900_60\n");
	if (u4Res & SINK_1440x900_75)
		pr_info("[HDMI]SINK_1440x900_75\n");
	if (u4Res & SINK_1680x1050_60RB)
		pr_info("[HDMI]SINK_1680x1050_60RB\n");
	if (u4Res & SINK_1680x1050_60)
		pr_info("[HDMI]SINK_1680x1050_60\n");

}
void vVGATimingInformation_DET(unsigned int u4Res)
{
	if (u4Res & SINK_640x480_60)
		pr_info("[HDMI]SINK_640x480_60\n");
	if (u4Res & SINK_848x480_60)
...
void vShowEdidInformation(void)
{
	...
	if (!_HdmiSinkAvCap.b_sink_support_hdmi_mode) {
		u4Res =  _HdmiSinkAvCap.ui4_sink_native_ntsc_resolution;
		pr_info("[HDMI]established timing =%x\n", u4Res);
		vVGATimingInformation_EST(u4Res);
		u4Res =  _HdmiSinkAvCap.ui4_sink_dtd_ntsc_resolution;
		pr_info("[HDMI]standard timing =%x\n", u4Res);
		vVGATimingInformation_STA(u4Res);
		u4Res =  _HdmiSinkAvCap.ui4_sink_1st_dtd_ntsc_resolution;
		pr_info("[HDMI]detailed first timing =%x\n", u4Res);
		if (!(u4Res & 0x80000000))
			vVGATimingInformation_DET(u4Res);
		u4Res =  _HdmiSinkAvCap.ui4_sink_dtd_pal_resolution;
		pr_info("[HDMI]detailed other timing =%x\n", u4Res);
		if (!(u4Res & 0x80000000))
			vVGATimingInformation_DET(u4Res);

		u4Res = 0;

		if (_HdmiSinkAvCap.ui4_sink_1st_dtd_ntsc_resolution & 0x80000000)
			u4Res = _HdmiSinkAvCap.ui4_sink_1st_dtd_ntsc_resolution;
		if (_HdmiSinkAvCap.ui4_sink_dtd_pal_resolution & 0x80000000)
			u4Res |= _HdmiSinkAvCap.ui4_sink_dtd_pal_resolution;
	} else {
		pr_info("[HDMI]NTSC dtd  =%x\n", _HdmiSinkAvCap.ui4_sink_dtd_ntsc_resolution);
