...
/*VGA detailed timing as below*/
#define SINK_640x480_60    (1 << 0)
#define SINK_848x480_60    (1 << 1)
#define SINK_1024x768_60   (1 << 2)
#define SINK_1024x768_70   (1 << 3)
#define SINK_1024x768_75   (1 << 4)
#define SINK_1024x768_85   (1 << 5)
#define SINK_1024x768_120  (1 << 6)
#define SINK_1152x864_75   (1 << 7)
#define SINK_1280x768_60RB (1 << 8)
#define SINK_1280x768_60   (1 << 9)
#define SINK_1280x768_75   (1 << 10)
#define SINK_1280x768_85   (1 << 11)
#define SINK_1280x768_120  (1 << 12)
#define SINK_1280x800_60RB (1 << 13)
#define SINK_1280x800_60   (1 << 14)
#define SINK_1280x800_75   (1 << 15)
#define SINK_1280x800_85   (1 << 16)
#define SINK_1280x800_120  (1 << 17)
#define SINK_1280x960_60   (1 << 18)
#define SINK_1280x960_85   (1 << 19)
#define SINK_800x600_60  (1 << 20)
#define SINK_1280x1024_60  (1 << 21)
#define SINK_1280x1024_75  (1 << 22)
#define SINK_1360x768_60   (1 << 23)
#define SINK_1366x768_60  (1 << 24)
#define SINK_1440x1050_60RB (1 << 25)
#define SINK_1440x1050_60   (1 << 26)
#define SINK_1440x900_60RB  (1 << 27)
#define SINK_1440x900_60    (1 << 28)
#define SINK_1440x900_75    (1 << 29)
#define SINK_1680x1050_60RB (1 << 30)
#define SINK_1680x1050_60   (1 << 31)
/*VGA established timings as below*/
#define SINK_800x600_60E    (1 << 0)
#define SINK_800x600_56E    (1 << 1)
#define SINK_640x480_75E    (1 << 2)
#define SINK_640x480_72E    (1 << 3)
#define SINK_640x480_67E    (1 << 4)
#define SINK_640x480_60E    (1 << 5)
#define SINK_720x400_88E    (1 << 6)
#define SINK_720x400_70E    (1 << 7)
#define SINK_800x600_72E    (1 << 15)
#define SINK_800x600_75E    (1 << 14)
#define SINK_832x624_75E    (1 << 13)
#define SINK_1024x768_87E   (1 << 12)
#define SINK_1024x768_60E   (1 << 11)
#define SINK_1024x768_70E   (1 << 10)
#define SINK_1024x768_75E   (1 << 9)
#define SINK_1280x1024_75E  (1 << 8)
#define SINK_1152x870_75E   (1 << 23)
...
#define EDID_ADDR_ESTABLISHED_TIMING          0x23
#define EDID_ADDR_STANDARD_TIMING             0x26
