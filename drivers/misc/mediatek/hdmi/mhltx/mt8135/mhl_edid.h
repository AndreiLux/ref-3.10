...
extern void mhl_checedid(unsigned char i1noedid);
extern unsigned char fgMhlReadEdid(unsigned char i1noedid);
extern void vShowEdidInformation(void);
extern void vShowEdidRawData(void);
extern void vClearEdidInfo(void);
extern void mhl_AppGetEdidInfo(HDMI_EDID_INFO_T *pv_get_info);
