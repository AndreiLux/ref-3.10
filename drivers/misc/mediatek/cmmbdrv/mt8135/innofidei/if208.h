...
#if 0
#define inno_msg(fmt, arg...)	pr_err("[inno]"fmt"\n", ##arg)
#define inno_dbg(fmt, arg...)	pr_err("[inno]"fmt"\n", ##arg)
#define inno_err(fmt, arg...)	pr_err("[inno:ERROR!!!]"fmt"\n", ##arg)
#else
#define inno_msg(fmt, arg...)	pr_err("[cmmb-drv]%s: " fmt "\n", __func__, ##arg)
#define inno_dbg(fmt, arg...)	/* pr_err("[cmmb-drv]%s: "fmt "\n", __func__, ##arg) */
#define inno_err(fmt, arg...)	pr_err("[cmmb-drv]ERROR!!! %s: "fmt "\n", __func__, ##arg)
#endif
/* //// **************** ///////////////////////////// */
