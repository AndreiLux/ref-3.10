...
int bq24156_write_byte(kal_uint8 cmd, kal_uint8 writeData)
{
	...
	ret = mt_i2c_master_send(new_client, write_data, 2, new_client->ext_flag);
	if (ret < 0) {
...
/**********************************************************
  ...
  *
  *********************************************************/
kal_uint32 bq24156_read_interface(kal_uint8 RegNum, kal_uint8 *val, kal_uint8 MASK,
				  kal_uint8 SHIFT)
{
	...
	/* pr_info("[bq24156_read_interface] Reg[%x]=0x%x\n", RegNum, bq24156_reg); */

	bq24156_reg &= (MASK << SHIFT);
	*val = (bq24156_reg >> SHIFT);
	/* pr_info("[bq24156_read_interface] val=0x%x\n", *val); */

	return ret;
}

kal_uint32 bq24156_config_interface(kal_uint8 RegNum, kal_uint8 val, kal_uint8 MASK,
				    kal_uint8 SHIFT)
{
	kal_uint8 bq24156_reg = 0;
	int ret = 0;
	...
	ret = bq24156_read_byte(RegNum, &bq24156_reg);
	/* pr_info("[bq24156_config_interface] Reg[%x]=0x%x\n", RegNum, bq24156_reg); */

	bq24156_reg &= ~(MASK << SHIFT);
	bq24156_reg |= (val << SHIFT);

	ret = bq24156_write_byte(RegNum, bq24156_reg);
	/* pr_info("[bq24156_config_interface] write Reg[%x]=0x%x\n", RegNum, bq24156_reg); */

	/* Check */
	/* bq24156_read_byte(RegNum, &bq24156_reg); */
	/* pr_info("[bq24156_config_interface] Check Reg[%x]=0x%x\n", RegNum, bq24156_reg); */
...
kal_uint32 bq24156_get_slrst_status(void)
{
	...
	ret = bq24156_read_interface((kal_uint8) (bq24156_CON0),
				     (&val),
				     (kal_uint8) (CON0_SLRST_MASK), (kal_uint8) (CON0_SLRST_SHIFT)
	    );
	return val;
}
...
kal_uint32 bq24156_get_boost_status(void)
{
	...
	ret = bq24156_read_interface((kal_uint8) (bq24156_CON0),
				     (&val),
				     (kal_uint8) (CON0_BOOST_MASK), (kal_uint8) (CON0_BOOST_SHIFT)
	    );
	return val;
}
#endif
...
void bq24156_set_v_low(kal_uint32 val)
{
	...
	ret = bq24156_config_interface((kal_uint8) (bq24156_CON1),
				       (kal_uint8) (val),
				       (kal_uint8) (CON1_LOW_V_MASK), (kal_uint8) (CON1_LOW_V_SHIFT)
	    );
}
...
void bq24156_set_ce(kal_uint32 val)
{
	...
	ret = bq24156_config_interface((kal_uint8) (bq24156_CON1),
				       (kal_uint8) (val),
				       (kal_uint8) (CON1_CE_MASK), (kal_uint8) (CON1_CE_SHIFT)
	    );
}
...
void bq24156_set_oreg(kal_uint32 val)
{
	...
	ret = bq24156_config_interface((kal_uint8) (bq24156_CON2),
				       (kal_uint8) (val),
				       (kal_uint8) (CON2_OREG_MASK), (kal_uint8) (CON2_OREG_SHIFT)
	    );
}
...
kal_uint32 bq24156_get_pn(void)
{
	...
	ret = bq24156_read_interface((kal_uint8) (bq24156_CON3),
				     (&val),
				     (kal_uint8) (CON3_PIN_MASK), (kal_uint8) (CON3_PIN_SHIFT)
	    );
	return val;
}
...
void bq24156_set_reset(kal_uint32 val)
{
	...
	ret = bq24156_config_interface((kal_uint8) (bq24156_CON4),
				       (kal_uint8) (val),
				       (kal_uint8) (CON4_RESET_MASK), (kal_uint8) (CON4_RESET_SHIFT)
	    );
}
...
void bq24156_set_icharge(kal_uint32 val)
{
	...
	ret = bq24156_config_interface((kal_uint8) (bq24156_CON4),
				       (kal_uint8) (val),
				       (kal_uint8) (CON4_I_CHR_MASK), (kal_uint8) (CON4_I_CHR_SHIFT)
	    );
}
...
void bq24156_set_vsreg(kal_uint32 val)
{
	...
	ret = bq24156_config_interface((kal_uint8) (bq24156_CON5),
				       (kal_uint8) (val),
				       (kal_uint8) (CON5_VSREG_MASK), (kal_uint8) (CON5_VSREG_SHIFT)
	    );
}
...
void bq24156_set_i_safe(kal_uint32 val)
{
	...
	ret = bq24156_config_interface((kal_uint8) (bq24156_CON6),
				       (kal_uint8) (val),
				       (kal_uint8) (CON6_ISAFE_MASK), (kal_uint8) (CON6_ISAFE_SHIFT)
	    );
}
...
void bq24156_set_v_safe(kal_uint32 val)
{
	...
	ret = bq24156_config_interface((kal_uint8) (bq24156_CON6),
				       (kal_uint8) (val),
				       (kal_uint8) (CON6_VSAFE_MASK), (kal_uint8) (CON6_VSAFE_SHIFT)
	    );
}
...
void bq24156_dump_register(void)
{
	...
	for (i = 0; i < bq24156_REG_NUM; i++) {
		...
		pr_info("[bq24156_dump_register] Reg[0x%X]=0x%02X\n", i, bq24156_reg[i]);
	}
}
...
{
	pr_info("[show_bq24156_access] 0x%x\n", g_reg_value_bq24156);
	return sprintf(buf, "%u\n", g_reg_value_bq24156);
}

static ssize_t store_bq24156_access(struct device *dev, struct device_attribute *attr,
				    const char *buf, size_t size)
{
	...
	pr_info("[store_bq24156_access]\n");

	if (buf != NULL && size != 0) {
		pr_info("[store_bq24156_access] buf is %s and size is %d\n", buf, size);
		reg_address = simple_strtoul(buf, &pvalue, 16);

		if (size > 3) {
			reg_value = simple_strtoul((pvalue + 1), NULL, 16);
			pr_info("[store_bq24156_access] write bq24156 reg 0x%x with value 0x%x !\n",
			...
			pr_info("[store_bq24156_access] read bq24156 reg 0x%x with value 0x%x !\n",
				reg_address, g_reg_value_bq24156);
			pr_info
			    ("[store_bq24156_access] Please use \"cat bq24156_access\" to get value\r\n");
		}
	}
	return size;
}
...
static int bq24156_user_space_probe(struct platform_device *dev)
{
	...
	pr_info("******** bq24156_user_space_probe!! ********\n");
...
#ifndef BQ24156_BUSNUM
#define BQ24156_BUSNUM 4
#endif

#if 0				/* move to board-proj-battery.c */
static struct i2c_board_info i2c_bq24156 __initdata = { I2C_BOARD_INFO("bq24156", (bq24156_SLAVE_ADDR_WRITE >> 1)) };
#endif
...
static int __init bq24156_init(void)
{
	...
	pr_info("[bq24156_init] init start\n");
	...
	if (i2c_add_driver(&bq24156_driver) != 0)
		pr_info("[bq24156_init] failed to register bq24156 i2c driver.\n");
	else
		pr_info("[bq24156_init] Success to register bq24156 i2c driver.\n");

	/* bq24156 user space access interface */
	ret = platform_device_register(&bq24156_user_space_device);
	if (ret) {
		pr_info("****[bq24156_init] Unable to device register(%d)\n", ret);
		return ret;
	}

	ret = platform_driver_register(&bq24156_user_space_driver);
	if (ret) {
		pr_info("****[bq24156_init] Unable to register driver (%d)\n", ret);
		return ret;
	}
