...
int bq27541_set_cmd_read(kal_uint8 cmd, int *returnData)
{
	...
	new_client->ext_flag =
	    ((new_client->
	      ext_flag) & I2C_MASK_FLAG) | I2C_WR_FLAG | I2C_DIRECTION_FLAG | I2C_RS_FLAG;
...
{
	pr_info("[bq27541_init] init start\n");
	...
	if (i2c_add_driver(&bq27541_driver) != 0)
		pr_info("[bq27541_init] failed to register bq27541 i2c driver.\n");
	else
		pr_info("[bq27541_init] Success to register bq27541 i2c driver.\n");
