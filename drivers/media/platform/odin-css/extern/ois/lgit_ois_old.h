...
#define		GYROFF_HIGH		0x4000 //250 DPS
#define		GYROFF_LOW		0xC000 //-250 DPS
...
//OISINI__ void			E2pRed(struct i2c_client *client, unsigned short, unsigned char, unsigned char *) ;	// E2P ROM Data Read
//OISINI__ void			E2pWrt(struct i2c_client *client, unsigned short, unsigned char, unsigned char *) ;	// E2P ROM Data Write
