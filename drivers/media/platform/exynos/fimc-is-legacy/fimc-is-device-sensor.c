...
#else
	is_writel(val | S5PCSIS_CTRL_UPDATE_SHADOW, mipi_reg_base + S5PCSIS_CTRL);
#endif
}
	...
	u32 flite_channel)
{
	...
	/* S5K8B1 */
	enum_sensor[SENSOR_NAME_S5K8B1].sensor = SENSOR_NAME_S5K8B1;
	enum_sensor[SENSOR_NAME_S5K8B1].pixel_width = 1920 + 16;
	enum_sensor[SENSOR_NAME_S5K8B1].pixel_height = 1080 + 10;
	enum_sensor[SENSOR_NAME_S5K8B1].active_width = 1920;
	enum_sensor[SENSOR_NAME_S5K8B1].active_height = 1080;
	enum_sensor[SENSOR_NAME_S5K8B1].max_framerate = 30;
	enum_sensor[SENSOR_NAME_S5K8B1].csi_ch = 1;
	enum_sensor[SENSOR_NAME_S5K8B1].flite_ch = FLITE_ID_B;
	enum_sensor[SENSOR_NAME_S5K8B1].i2c_ch = 2;
	enum_sensor[SENSOR_NAME_S5K8B1].setfile_name = "setfile_6b2.bin";

	ext = &enum_sensor[SENSOR_NAME_S5K8B1].ext;
	memset(ext, 0x0, sizeof(struct sensor_open_extended));

	ext->I2CChannel = enum_sensor[SENSOR_NAME_S5K8B1].i2c_ch;
	ext->I2CSclk = I2C_L0;
