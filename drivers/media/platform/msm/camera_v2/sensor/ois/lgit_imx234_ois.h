...
#define LAST_UPDATE  "14-12-01"	//LC898122A FW
...
#ifdef	CATCHMODE
#define	GXGAIN_INI		0x3F147AE1	// Gyro X Zoom Value	+0.58
#define	GYGAIN_INI		0x3F147AE1	// Gyro Y Zoom Value	+0.58
#else	//CATCHMODE
...
uint8_t InitGainControl( unsigned char );
#endif	//CATCHMODE
...
void	SelectPtRange( unsigned char ) ;
