...
int32_t lgit2_ois_mode(struct msm_ois_ctrl_t *o_ctrl,
...
int32_t lgit2_init_set_ois(struct msm_ois_ctrl_t *o_ctrl,
						   struct msm_ois_set_info_t *set_info)
{
...
int32_t	lgit2_ois_on(struct msm_ois_ctrl_t *o_ctrl,
					 struct msm_ois_set_info_t *set_info)
{
	int32_t rc = OIS_SUCCESS;
	CDBG("%s Enter\n", __func__);
...
int32_t	lgit2_ois_off(struct msm_ois_ctrl_t *o_ctrl,
					  struct msm_ois_set_info_t *set_info)
{
...
int32_t lgit2_ois_stat(struct msm_ois_ctrl_t *o_ctrl,
					   struct msm_ois_set_info_t *set_info)
{
	...
	int16_t val_gyro_y;
	/* Hall Fail Spec. */
	int16_t spec_hall_x_lower = 1467;/* +-0.65deg확보하기 위하여 45.0um 필요함.(실제 Spec.은 +-0.5deg이므로 충분한 마진 포함됨) */
...
int32_t lgit2_ois_move_lens(struct msm_ois_ctrl_t *o_ctrl,
							struct msm_ois_set_info_t *set_info)
{
...
void lgit_imx135_ois_init(struct msm_ois_ctrl_t *msm_ois_t)
{
	lgit2_ois_func_tbl.ini_set_ois = lgit2_init_set_ois;
	lgit2_ois_func_tbl.enable_ois = lgit2_ois_on;
	lgit2_ois_func_tbl.disable_ois = lgit2_ois_off;
