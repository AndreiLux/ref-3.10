#ifndef	LGIT_IMX214_OIS_H
#define	LGIT_IMX214_OIS_H

#define LAST_UPDATE  "14-06-20"	/* LC898122A FW */
#define	OISFW_RELEASE_VER (0xB1B1)	/* LC898122A FW */

//void lgit_imx214_ois_init(struct msm_ois_ctrl_t *msm_ois_t);

extern uint8_t spigyrocheck;
...
/* Actuator Select */
/* MITSUMI Actuator for S3 */
#define	BIAS_CUR_OIS	0x33	/* 2.0mA/2.0mA*//*20140514 Komori */
#define	AMP_GAIN_X		0x04	/* x100 */
#define	AMP_GAIN_Y		0x04	/* x100 */
#define	OSC_INI			0x2E	/* OSC Init, VDD=2.8V */

/* AF Open parameter */
#define	RWEXD1_L_AF		0x34BF	/*0x0DDA*//*0x7FFF*//* */
#define	RWEXD2_L_AF		0x7FFF  /*0x3e4e*//*0x5A00 */
#define	RWEXD3_L_AF		0x3ED5	/*0x1762*//*0x7FFF*//*0x7000 */
#define	FSTCTIME_AF		0xF8	/*0xd6*/ /*0xd4*//*0x5F */
#define	FSTMODE_AF		0x00	/* */
#define	LTHDHL_AF		0x00C0
...
#ifdef	CORRECT_10DEG
#define	GYRLMT4_S1		0x40AA8D66	/* 5.330F  pm 1.5  [deg] */
#define	GYRLMT4_S2		0x40AA8D66	/* 5.330F  pm 1.5  [deg] */

#define	GYRA12_HGH		0x40A4DE05	/* 5.152F  pm 1.45 [deg] */
...
#define	GYRA12_HGH		0x400CCCCD	/* 2.20F */
...
#define	GYRA12_HGH		0x40200000	/* 2.50F */
#define	GYRA12_MID		0x3F800000	/* 1.0F */
#define	GYRA34_HGH		0x3F000000	/* 0.5F */
#define	GYRA34_MID		0x3DCCCCCD	/* 0.1F */
...
int32_t	lc898122a_init(void);		/* Initial Top Function */
void lc898122a_e2p_data_read(void);	/* Read calibration data from E2PROM */
...
void lc898122a_init_af(void);					/* Open AF Initial Setting */
void lc898122a_af_driver_mode(uint8_t);		/* AF Driver Mode setting function */
void lc898122a_af_vcm_code(uint16_t);	/* AF Code Write */
...
#define	CHGCOEF		0xB9400000	/* -0.0001831 */
#endif	/*CORRECT_105DEG */

#ifdef	CORRECT_12DEG
#define	MAXLMT		0x40400000	/* 3.0 */
#define	MINLMT		0x4019999A	/* 2.4 */
#define	CHGCOEF		0xBA995555	/* */
#endif	/*CORRECT_12DEG */
...
#ifdef	STANDBY_MODE
void lc898122a_set_stand_by(uint8_t);	/* Select Gyro Mode Function */
void lc898122a_select_gyro_mode(uint8_t);		/* Standby control */
void lc898122a_select_gyro_sig(void);				/* Slect Gyro Output signal Function */
