...
# define PL08X_LLI_TSFR_SIZE	0x400

/* Maximum times we call dma_pool_alloc on this pool without freeing */
#define MAX_NUM_TSFR_LLIS	(PL08X_LLI_TSFR_SIZE/sizeof(struct pl08x_lli))
#define PL08X_ALIGN		2

/* dmac device registration */
static struct pl08x_channel_data pdma_dma_info[] = {
        {
                .bus_id = "spi0_tx",
                .min_signal = 0,
                .max_signal = 0,
...
struct pl08x_platform_data pl080_pdma_data = {
        .memcpy_channel = {
                .bus_id = "memcpy",
                .cctl_memcpy =
        ...
        .odin_get_signal = pl080_get_signal,
        .odin_put_signal = pl080_put_signal,
        .slave_channels = pdma_dma_info,
        .num_slave_channels = ARRAY_SIZE(pdma_dma_info),
};
...
static const struct of_device_id odin_pdma_ids[] __initconst = {
	{ .compatible = "odin-pdma", .data = &pl080_pdma_data, },
	{ /* Sentinel */ }
};
...
static int pl08x_probe(struct amba_device *adev, const struct amba_id *id)
{
	...
	of_id = of_match_device(odin_pdma_ids, &adev->dev);
	if (of_id)
