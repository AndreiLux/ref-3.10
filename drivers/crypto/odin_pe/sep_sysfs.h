...
/* Enumerate packet drop causes in ipsec_q_tg() */
enum ipsec_drop_cause {
	IPSEC_DROP_DEFRAG,  /* Failed defragmentation */
	IPSEC_DROP_SKB_MEM, /* SKB re-allocation (expand/linearize) failed */
	IPSEC_DROP_Q_FULL,  /* Packet queue is full */
	IPSEC_DROP_DMA_MAP, /* DMA mapping error */
	IPSEC_DROP_CAUSE_NUM
};
#endif
