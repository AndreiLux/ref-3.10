...
/* Number of available context cache entries */
#define DX_SEP_INIT_CACHE_CTX_SIZE_BIT_OFFSET	16
#define DX_SEP_INIT_CACHE_CTX_SIZE_BIT_SIZE     8
/* Number of availabel packet context cache entries */
#define DX_SEP_INIT_IPSEC_Q_SIZE_BIT_OFFSET     24
#define DX_SEP_INIT_IPSEC_Q_SIZE_BIT_SIZE       4

/* Size of random seed */
#define DX_SEP_INIT_IPSEC_RND_SEED_BIT_OFFSET   28
#define DX_SEP_INIT_IPSEC_RND_SEED_SBIT_SIZE    4
...
enum dx_fw_init_tlv_params {
	...
	/* packet queues param (buffer addr. & size to satisfy both Tx/Rx Qs) */
	DX_FW_INIT_PARAM_IPSEC_QS_BASE          = 0x106,
	/* random seed param (buffer & size) */
	DX_FW_INIT_PARAM_RANDOM_SEED               = 0x107,
	/* kernel uptime */
	DX_FW_INIT_PARAM_HOST_UPTIME               = 0x108,
