...
#else
#error Define either DX_CC_SEP or DX_CC_HOST or DX_CC_HOST_VIRT or DX_CC_TEE
#endif
...
#else
#error Execution domain is not DX_CC_SEP/DX_CC_HOST/DX_CC_HOST_VIRT/DX_CC_TEE
#endif
