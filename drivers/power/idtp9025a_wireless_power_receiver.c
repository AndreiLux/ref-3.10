...
#define DEBUG
#define pr_fmt(fmt)	"Alignment: %s: " fmt, __func__
...
#define FREQ_MIN	100
static struct i2c_client *idtp9025_client;
...
static int idtp9025_probe(struct i2c_client *client,
