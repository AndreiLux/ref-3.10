...
extern int (*api_inputhub_mcu_recv)(const char *buf,unsigned long length/*buf length*/);
extern int (*api_mculog_process)(const char * buf,unsigned long length/*buf length*/);
...
int inputhub_mcu_send(const char *buf, unsigned long length/*buf length*/);
