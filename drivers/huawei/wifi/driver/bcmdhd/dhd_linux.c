...
**********************************************/
#define        HUAWEI_VERSION_STR ", HUAWEI-2014.002"
...
static int dhd_set_suspend(int value, dhd_pub_t *dhd)
{
	...
	int power_mode = PM_FAST; //merge from DTS2012021605733
...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
	...
	if(dhd_wl_ioctl_cmd(dhd, WLC_SET_VAR, buf, sizeof(buf), TRUE, 0) < 0)
		DHD_ERROR(("%s ampdu host recorder failed\n", __FUNCTION__));
#endif 
#endif /* DISABLE_11N */
