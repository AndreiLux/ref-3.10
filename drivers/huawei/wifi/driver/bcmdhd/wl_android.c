...
char g_fw_name[FIRMWARE_NAME_LEN] = {0}; //get name from dts
char g_nvram_name[NVRAM_NAME_LEN] = {0}; //get name from dts
...
static int wifi_probe(struct platform_device *pdev)
{
	...
	wifi_control_data->get_nvram_fw_name(g_nvram_name, g_fw_name);
	DHD_ERROR(("get nvram name:%s, firmware name:%s\n", g_nvram_name, g_fw_name));
