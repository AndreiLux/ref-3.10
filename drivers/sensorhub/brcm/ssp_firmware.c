...
#define SSP_FIRMWARE_REVISION_BCM	15051900
#elif defined (CONFIG_SENSORS_SSP_ZENLTE)
#undef SSP_FIRMWARE_REVISION_BCM
#define SSP_FIRMWARE_REVISION_BCM	15051100
#elif defined (CONFIG_SENSORS_SSP_K6DS3TR)
#define SSP_FIRMWARE_REVISION_BCM	15052100
#elif defined (CONFIG_SENSORS_SSP_VLTE)
#undef SSP_FIRMWARE_REVISION_BCM
#define SSP_FIRMWARE_REVISION_BCM	15052000
#else // ZERO
