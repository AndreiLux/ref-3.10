...
#define cfgdev_to_prmry_cfgdev(cfgdev, wl) wl_to_prmry_wdev(wl)
#elif defined(WL_ENABLE_P2P_IF)
#define cfgdev_to_wlc_ndev(cfgdev, wl)	ndev_to_wlc_ndev(cfgdev, wl)
#define cfgdev_to_prmry_cfgdev(cfgdev, wl) wl_to_prmry_ndev(wl)
#else
#define cfgdev_to_wlc_ndev(cfgdev, wl)	(cfgdev)
#define cfgdev_to_prmry_cfgdev(cfgdev, wl) (cfgdev)
#endif /* WL_CFG80211_P2P_DEV_IF */

#if defined(WL_CFG80211_P2P_DEV_IF)
#define ndev_to_cfgdev(ndev)	ndev_to_wdev(ndev)
#define cfgdev_to_ndev(cfgdev)	(cfgdev->netdev)
#define discover_cfgdev(cfgdev, wl) (cfgdev->iftype == NL80211_IFTYPE_P2P_DEVICE)
#else
#define ndev_to_cfgdev(ndev)	(ndev)
#define cfgdev_to_ndev(cfgdev)	(cfgdev)
#define discover_cfgdev(cfgdev, wl) (cfgdev == cfg->p2p_net)
#endif /* WL_CFG80211_P2P_DEV_IF */
