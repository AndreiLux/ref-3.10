...
/*                                                                                   */
#if defined(CUSTOMER_LGE_ODIN) || (!defined(CONFIG_HAS_WAKELOCK) && (LINUX_VERSION_CODE > KERNEL_VERSION(2, 6, 36)))
...
#if CUSTOMER_LGE_ODIN	/*                                                                           */
		error = odin_gpio_sms_request_irq(sdhcinfo->oob_irq, wlan_oob_irq, sdhcinfo->oob_flags,
			"bcmsdh_sdmmc", NULL);
#else	/*                    */
