...
static int adc_send_ipc_to_lpm3(int channel)
{
	...
	adc_tx_task = hisi_mbox_task_alloc(hisi_adc_dev->mbox, HI3630_MAILBOX_RP_LPM3, hisi_adc_dev->tx_msg,
...
static int __init hisi_adc_driver_init(void)
{
	...
	hisi_adc_dev->mbox = hisi_mbox_get(HI3630_MAILBOX_RP_LPM3, hisi_adc_dev->nb);
