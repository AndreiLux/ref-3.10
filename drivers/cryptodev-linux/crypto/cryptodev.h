...
#define CRYPTO_RNG_MAX_KEY_LEN		CRYPTO_CIPHER_MAX_KEY_LEN
...
enum cryptodev_crypto_op_t {
	...
	CRYPTO_3DES_CTR,
	CRYPTO_X9_31_AES128,
	CRYPTO_ANSI_CPRNG = CRYPTO_X9_31_AES128,
	CRYPTO_STDRNG,
...
struct session_op {
	/* Specify cipher, mac, or rng
	 */
	__u32	cipher;		/* cryptodev_crypto_op_t */
	__u32	mac;		/* cryptodev_crypto_op_t */
	__u32	rng;		/* cryptodev_crypto_op_t */
...
struct session_info_op {
	...
	} cipher_info, hash_info, rng_info;

	__u16	alignmask;	/* alignment constraints */
	__u32   flags;          /* SIOP_FLAG_* */
};
