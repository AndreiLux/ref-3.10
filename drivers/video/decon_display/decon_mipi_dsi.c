...
static int decon_mipi_dsi_set_dphy_timing_value(struct mipi_dsim_device *dsim)
{
	...
	/* should be fixed */
#if defined(CONFIG_SOC_EXYNOS5422) && defined(CONFIG_DECON_LCD_S6E3HA0)
	s5p_mipi_dsi_set_b_dphyctrl(dsim, 0x0AF);
	s5p_mipi_dsi_set_timing_register0(dsim, 0x06, 0x0b);
	s5p_mipi_dsi_set_timing_register1(dsim, 0x07, 0x27, 0x0d, 0x08);
	s5p_mipi_dsi_set_timing_register2(dsim, 0x09, 0x0d, 0x0b);
#endif
	return 1;
}
