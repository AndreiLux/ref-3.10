...
#if defined(CONFIG_MACH_MSM8994_G4_KR) && defined(CONFIG_SLIMPORT_DYNAMIC_HPD)
			slimport_set_hdmi_hpd(0);
			vbus_power_ctrl(SP_POWER_DOWN);
			slimport_block_power_ctrl(SP_TX_PWR_REG, SP_POWER_DOWN);
			slimport_block_power_ctrl(SP_TX_PWR_TOTAL, SP_POWER_DOWN);
