...
#elif defined(CONFIG_MFD_MAX77823)
#define MFD_MAX778XX_COMMON
...
static int of_sii8240_parse_dt(void)
{
	...
	pdata->ddcline_connected = of_property_read_bool(np,
			"mhl,ddcline_connected");
	pr_info("ddcline_connected = %s\n",
			pdata->ddcline_connected ? "true" : "false");
