...
typedef struct {
	...
	ovl0_cfg3                     	ovl0_cfg3;			/* 0x4C */
	unsigned int			reserved_[44];
	ovl1_cfg0                     	ovl1_cfg0;			/* 0x100 */
	...
	ovl1_cfg3                     	ovl1_cfg3;			/* 0x14c */
	unsigned int			reserved_1[44];
	ovl2_cfg0                     	ovl2_cfg0;			/* 0x200 */
	...
	ovl2_cfg3                     	ovl2_cfg3;			/* 0x24C */
	unsigned int			reserved_2[48];
	ovl_cfg_g0                    	cfg_g0;				/* 0x310 */
	...
	ovl2_status                   	ovl2_status;			/* 0x35C */
	unsigned int			reserved_4;
	ovl0_save_pip_pos             	ovl0_save_pip_pos;		/* 0x364 */
	ovl1_save_pip_pos             	ovl1_save_pip_pos;
	ovl2_save_pip_pos             	ovl2_save_pip_pos;		/* 0x36C */
	unsigned int			reserved_5[10];
	ovl_se_src_secure_enable      	se_src_secure_enable;		/* 0x398 */
} DSS_DU_OVL_REG_T;
#endif
