...
typedef struct {
	sync_cfg0                     	sync_cfg0;		/* 0x0 */
	sync_cfg1                     	sync_cfg1;
	sync_cfg2                     	sync_cfg2;		/* 0x8 */
	unsigned int			reserved_[7];
	sync_raster_size0             	sync_raster_size0;	/* 0x28 */
	sync_raster_size1             	sync_raster_size1;
	sync_raster_size2             	sync_raster_size2;	/* 0x30 */
	unsigned int			reserved_1;
	sync_ovl0_st_dly              	sync_ovl0_st_dly;	/* 0x38 */
