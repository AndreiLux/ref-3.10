...
typedef struct {
	gscl_rd_cfg0                  	rd_cfg0;		/* 0x0 */
	gscl_rd_cfg1                  	rd_cfg1;		/* 0x4 */
	unsigned int			reserved_[8];
	gscl_rd_width_height          	rd_width_height;	/* 0x28 */
	gscl_rd_startxy               	rd_startxy;
	gscl_rd_sizexy                	rd_sizexy;		/* 0x30 */
	unsigned int			reserved_1[3];
	gscl_rd_dss_base_y_addr0      	rd_dss_base_y_addr0;	/* 0x40 */
	unsigned int			reserved_2[2];
	gscl_rd_dss_base_y_addr1      	rd_dss_base_y_addr1;	/* 0x4C */
	unsigned int			reserved_3[2];
	gscl_rd_dss_base_y_addr2      	rd_dss_base_y_addr2;	/* 0x58 */
	unsigned int			reserved_4[2];
	gscl_rd_status                	rd_status;		/* 0x64 */
	unsigned int			reserved_5[74];
	gscl_wb_cfg0                  	wb_cfg0;		/* 0x190 */
	gscl_wb_cfg1                  	wb_cfg1;		/* 0x194 */
	unsigned int			reserved_6[8];
	gscl_wb_alpha_value           	wb_alpha_value;		/* 0x1B8 */
	...
	gscl_wb_dss_base_u_addr1      	wb_dss_base_u_addr1;	/* 0x1DC */
	unsigned int			reserved_7;
	gscl_wb_status                	wb_status;		/* 0x1E4 */
} DSS_DU_GSCL_REG_T;
#endif
