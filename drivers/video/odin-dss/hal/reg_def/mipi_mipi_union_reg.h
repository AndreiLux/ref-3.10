...
typedef struct {
    ...
    u32                             reserved1; //DSS_DIP_LCD_MIPI_BASE + 0x5C
    interrupt_source2               interrupt_source2;
    interrupt_mask2                 interrupt_mask2;
    interrupt_clear2                interrupt_clear2;
    u32                             reserved2; // DSS_DIP_LCD_MIPI_BASE + 0x6C
    test_clear                      test_clear;
    test_clock                      test_clock;
    test_data_in                    test_data_in;
    test_data_enable                test_data_enable;
    test_data_out                   test_data_out;
    u32                             reserved3; // DSS_DIP_LCD_MIPI_BASE + 0x84
    u32                             reserved4; // DSS_DIP_LCD_MIPI_BASE + 0x88
    u32                             reserved5; // DSS_DIP_LCD_MIPI_BASE + 0x8C
...
//    u32                           reserved; // DSS_DIP_LCD_MIPI_BASE + 0x100 - 0xfff
//    tx_cfg_fifo                   tx_cfg_fifo; // DSS_DIP_LCD_MIPI_BASE + 0x1000 - 0x1fff
//    rx_packet_payload_fifo        rx_packet_payload_fifo; //DSS_DIP_LCD_MIPI_BASE + 0x2000 - 0x2fff
