...
*
*/
#ifndef K3_DSS_REGS_H
#define K3_DSS_REGS_H
...
typedef struct dss_rdma_bridge {
	u32 rbrg_rdma_ctl[RDMA_NUM];
	u32 rbrg_outstanding_dep[RDMA_NUM];
...
typedef struct dss_rdma {
	...
	u32 rdma_oft_x0;
	u32 rdma_oft_y0;
	u32 rdma_rot_qos_lev;
	u32 rdma_stride;
	u32 rdma_oft_x1;
	u32 rdma_oft_y1;
	u32 rdma_mask0;
	u32 rdma_mask1;
	u32 rdma_stretch_size_vrt;
	u32 rdma_stretch_line_num;
	u32 rdma_ctrl;
	u32 rdma_data_num;
	u32 rdma_tile_scram;
	u32 rdma_core_gt;
...
typedef struct dss_fbdc {
	u32 fbdc_data_addr;
	u32 fbdc_data_stride;
	u32 fbdc_head_addr;
	u32 fbdc_head_stride;
	u32 fbdc_size;
	u32 fbdc_crop_s;
	u32 fbdc_ctrl;
	u32 fbdc_pm_ctrl;
...
typedef struct dss_wdma {
	...
	u32 wdma_tile_scram;
	u32 wdma_sw_mask_en;
	u32 wdma_hdr_start_addr;
	u32 wdma_hdr_stride;
	u32 wdma_start_mask;
	u32 wdma_end_mask;
	u32 wdma_wbrg_credit_ctl;
...
typedef struct dss_mmu_rptb {
	u32 mmu_rptb_ctl;
	u32 mmu_rtlb_sel;
	u32 mmu_rptb_load[DSS_ROT_MAX];
	u32 mmu_rptb_ba[DSS_ROT_MAX];
	u32 mmu_rptb_idx_used[DSS_ROT_MAX];
...
typedef struct dss_global_reg {
	...
	u32 ovl_mux_val;
	u32 ovl_scene_val;
	u32 rot_tlb_scene_val[ROT_TLB_SCENE_NUM];
	u32 dpe0_cross_switch_val;
	u32 dpe2_cross_switch_val;
	u32 chn_ctl_val[DSS_CHN_MAX];
	u32 chn_mux_val[DSS_CHN_MAX];
	u32 rot_mux_val[DSS_CHN_MAX];
	u32 scf_mux_val[DSS_CHN_MAX];
	u32 rot_pm_ctl_val[DSS_CHN_MAX];
	u32 sdp_mux_val;

	u8 ovl_mux_used;
	u8 ovl_scene_used;
	u8 rot_tlb_scene_used[ROT_TLB_SCENE_NUM];
	u8 dpe0_cross_switch_used;
	u8 dpe2_cross_switch_used;
	u8 chn_ctl_used[DSS_CHN_MAX];
	u8 chn_mux_used[DSS_CHN_MAX];
	u8 rot_mux_used[DSS_CHN_MAX];
	u8 scf_mux_used[DSS_CHN_MAX];
	u8 rot_pm_ctl_used[DSS_CHN_MAX];
	u8 sdp_mux_used;
...
typedef struct dss_module_reg {
	...
	u8 rdma_bridge_used[DSS_ENG_MAX];
	u8 rdma0_used[DSS_CHN_MAX];
	u8 rdma1_used[DSS_CHN_MAX];
	u8 fbdc_used[DSS_CHN_MAX];
	u8 dfc_used[DSS_CHN_MAX];
	u8 scf_used[DSS_SCF_MAX];
	u8 scp_used[DSS_CHN_MAX];
	u8 csc_used[DSS_CHN_MAX];
	u8 ov_used[DSS_OVL_MAX];
	u8 fbc_used[DSS_CHN_MAX];
	u8 wdma_used[DSS_CHN_MAX];
	u8 wdma_bridge_used[DSS_ENG_MAX];
	u8 mmu_dma0_used[DSS_CHN_MAX];
	u8 mmu_dma1_used[DSS_CHN_MAX];
	u8 mmu_rptb_used;
...
typedef struct dss_exception {
	u8 chn_used[DSS_CHN_MAX];
	u32 chn_format_used[DSS_CHN_MAX];
	u8 underflow_exception;
	u8 underflow_handler;
