#ifndef GRA1_BASE_ADDR
#define GRA1_BASE_ADDR 0x31210000


#define ADDR_GRA1_RD_CFG0                              ( 0x0000 )
#define ADDR_GRA1_RD_CFG1                              ( 0x0004 )
#define ADDR_GRA1_RD_WIDTH_HEIGHT                      ( 0x0028 )
#define ADDR_GRA1_RD_STARTXY                           ( 0x002C )
#define ADDR_GRA1_RD_SIZEXY                            ( 0x0030 )
#define ADDR_GRA1_RD_DSS_BASE_Y_ADDR0                  ( 0x0040 )
#define ADDR_GRA1_RD_DSS_BASE_Y_ADDR1                  ( 0x004C )
#define ADDR_GRA1_RD_DSS_BASE_Y_ADDR2                  ( 0x0058 )
#define ADDR_GRA1_RD_STATUS                            ( 0x0064 )
