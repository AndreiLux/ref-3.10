#ifndef __GRA2_UNION_REG_H
#define __GRA2_UNION_REG_H


/*----------------------------------------------------------------
	0x31220000 gra2_rd_cfg0
----------------------------------------------------------------*/
typedef union {
	struct {
		u32 src_en                               : 1; /* 0 */
		...
		u32 reserved9                            :10; /* 31:22 */
	} af;
	u32 a32;
} gra2_rd_cfg0;

/*----------------------------------------------------------------
	0x31220004 gra2_rd_cfg1
----------------------------------------------------------------*/
typedef union {
	struct {
		...
		u32 reserved10                           :17; /* 31:15 */
	} af;
	u32 a32;
} gra2_rd_cfg1;

/*----------------------------------------------------------------
	0x31220028 gra2_rd_width_height
----------------------------------------------------------------*/
typedef union {
	struct {
...
/*----------------------------------------------------------------
	0x31220040 gra2_rd_dss_base_y_addr0
----------------------------------------------------------------*/
typedef union {
	struct {
...
/*----------------------------------------------------------------
	0x3122004c gra2_rd_dss_base_y_addr1
----------------------------------------------------------------*/
typedef union {
	struct {
...
/*----------------------------------------------------------------
	0x31220058 gra2_rd_dss_base_y_addr2
----------------------------------------------------------------*/
typedef union {
	struct {
...
typedef struct {
	gra2_rd_cfg0                  	i2_rd_cfg0;
	gra2_rd_cfg1                  	i2_rd_cfg1;
	gra2_rd_width_height          	i2_rd_width_height;
	gra2_rd_startxy               	i2_rd_startxy;
	gra2_rd_sizexy                	i2_rd_sizexy;
	gra2_rd_dss_base_y_addr0      	i2_rd_dss_base_y_addr0;
	gra2_rd_dss_base_y_addr1      	i2_rd_dss_base_y_addr1;
	gra2_rd_dss_base_y_addr2      	i2_rd_dss_base_y_addr2;
	gra2_rd_status                	i2_rd_status;
} DSS_DU_GRA2_REG_T;
#endif
