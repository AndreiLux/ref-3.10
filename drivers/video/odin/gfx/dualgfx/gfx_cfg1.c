 ...
 *	@see gfx_initcfg1
 */
LX_MEMCFG_T gfx_mem_desc_table1[] =
{
 ...
 *
 */
LX_GFX_REG_CFG_T gfx_reg_cfg_desc_table1[] =
{
	/* L9 */
    [0] = {
		.chip		= LX_CHIP_L9,
    ...
    [1] = {
		.chip		= LX_CHIP_ODIN,
        .chip_name	= "ODIN-GFX1",
        .reg_base_addr	= 0x31310000, /* ODIN_GFX1_BASE, */
        .reg_size	= 0x200,	/* real size is '0x1EC' */
        .irq_num	= (32/*H13_IRQ_GIC_START*/ + 55),/* H13_IRQ_GPU_GFX */
    },
};

LX_GFX_REG_CFG_T *gpgfxregcfg1 = NULL;
LX_GFX_MEM_CFG_T gmemcfggfx1;
...
--------------------------------------------------------------------*/
void gfx_initcfg1 ( void )
{
	/* get chip configuration */
	memcpy( &g_gfx_cfg1, g_gfx_hal1.getcfg(), sizeof(LX_GFX_CFG_T));

	/*-------------------------------------------------------------------
	 * [H13] configuration
	--------------------------------------------------------------------*/
	gpgfxregcfg1 = &gfx_reg_cfg_desc_table1[1];
	memcpy( &gmemcfggfx1.surface, &gfx_mem_desc_table1[2], sizeof(LX_MEMCFG_T));
}
