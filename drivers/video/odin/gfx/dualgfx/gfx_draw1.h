...
-----------------------------------------------------------------*/
extern void gfx_lockdevice1(void);
extern void gfx_unlockdevice1(void);
...
extern int gfx_setsurfacepalette1( int dst_fd, int size , UINT32 *data);
extern int gfx_freesurface1( int dst_fd );
