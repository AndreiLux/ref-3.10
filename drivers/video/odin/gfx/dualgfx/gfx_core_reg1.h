 ...
 * g_gfx_reg1 : real register of GFX.
 * g_gfx_reg_cache1     : shadow register.
 *
 * @def GFX_RdFL: Read  FLushing : Shadow <- Real.
 * @def GFX_WrFL: Write FLushing : Shadow -> Real.
 * @def GFX_Rd1  : Read  whole register(u32) from Shadow register.
 * @def GFX_Wr1  : Write whole register(u32) from Shadow register.
 * @def GFX_Rd011 ~ GFX_Rdnn: Read  given '01~nn' fields from Shadow register.
 * @def GFX_Wr011 ~ GFX_Wrnn: Write given '01~nn' fields to   Shadow register.
 * */
#define GFX_RdFL1(_r)			((g_gfx_reg_cache1->_r)=(g_gfx_reg1->_r))
#define GFX_WrFL1(_r)			((g_gfx_reg1->_r)=(g_gfx_reg_cache1->_r))

#define GFX_Rd1(_r)				*((u32*)(&(g_gfx_reg_cache1->_r)))
#define GFX_Wr1(_r,_v)			((GFX_Rd1(_r))=((u32)(_v)))

#define GFX_Rd001(_r,_v01)								\
								do { 						\
									(_v01) = (GFX_Rd1(_r));	\
								} while (0)
#define GFX_Wr001(_r,_v01)		GFX_Wr1(_r,_v01)

#define GFX_Rd011(_r,_f01,_v01)								\
								do { 						\
									(_v01) = (g_gfx_reg_cache1->_r._f01);	\
								} while (0)

#define GFX_Rd021(_r,_f01,_v01,_f02,_v02)									\
								do { 										\
									(_v01) = (g_gfx_reg_cache1->_r._f01);	\
									(_v02) = (g_gfx_reg_cache1->_r._f02);	\
								} while (0)

#define GFX_Rd031(_r,_f01,_v01,_f02,_v02,_f03,_v03)							\
								do { 										\
									(_v01) = (g_gfx_reg_cache1->_r._f01);	\
									(_v02) = (g_gfx_reg_cache1->_r._f02);	\
									(_v03) = (g_gfx_reg_cache1->_r._f03);	\
								} while (0)

#define GFX_Rd041(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)				\
								do { 										\
									(_v01) = (g_gfx_reg_cache1->_r._f01);	\
									(_v02) = (g_gfx_reg_cache1->_r._f02);	\
									(_v03) = (g_gfx_reg_cache1->_r._f03);	\
									(_v04) = (g_gfx_reg_cache1->_r._f04);	\
								} while (0)

#define GFX_Rd051(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05)												\
								do { 										\
									(_v01) = (g_gfx_reg_cache1->_r._f01);	\
									(_v02) = (g_gfx_reg_cache1->_r._f02);	\
									(_v03) = (g_gfx_reg_cache1->_r._f03);	\
									(_v04) = (g_gfx_reg_cache1->_r._f04);	\
									(_v05) = (g_gfx_reg_cache1->_r._f05);	\
								} while (0)

#define GFX_Rd061(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06)									\
								do { 										\
									(_v01) = (g_gfx_reg_cache1->_r._f01);	\
									(_v02) = (g_gfx_reg_cache1->_r._f02);	\
									...
									(_v04) = (g_gfx_reg_cache1->_r._f04);	\
									(_v05) = (g_gfx_reg_cache1->_r._f05);	\
									(_v06) = (g_gfx_reg_cache1->_r._f06);	\
								} while (0)

#define GFX_Rd071(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07)							\
								do { 										\
									...
									(_v05) = (g_gfx_reg_cache1->_r._f05);	\
									(_v06) = (g_gfx_reg_cache1->_r._f06);	\
									(_v07) = (g_gfx_reg_cache1->_r._f07);	\
								} while (0)

#define GFX_Rd081(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)				\
								do { 										\
									...
									(_v06) = (g_gfx_reg_cache1->_r._f06);	\
									(_v07) = (g_gfx_reg_cache1->_r._f07);	\
									(_v08) = (g_gfx_reg_cache1->_r._f08);	\
								} while (0)

#define GFX_Rd091(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09)												\
								do { 										\
									(_v01) = (g_gfx_reg_cache1->_r._f01);	\
									...
									(_v07) = (g_gfx_reg_cache1->_r._f07);	\
									(_v08) = (g_gfx_reg_cache1->_r._f08);	\
									(_v09) = (g_gfx_reg_cache1->_r._f09);	\
								} while (0)

#define GFX_Rd101(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10)									\
								do { 										\
									(_v01) = (g_gfx_reg_cache1->_r._f01);	\
									...
									(_v08) = (g_gfx_reg_cache1->_r._f08);	\
									(_v09) = (g_gfx_reg_cache1->_r._f09);	\
									(_v10) = (g_gfx_reg_cache1->_r._f10);	\
								} while (0)

#define GFX_Rd111(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11)							\
								do { 										\
									...
									(_v09) = (g_gfx_reg_cache1->_r._f09);	\
									(_v10) = (g_gfx_reg_cache1->_r._f10);	\
									(_v11) = (g_gfx_reg_cache1->_r._f11);	\
								} while (0)

#define GFX_Rd121(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)				\
								do { 										\
									...
									(_v10) = (g_gfx_reg_cache1->_r._f10);	\
									(_v11) = (g_gfx_reg_cache1->_r._f11);	\
									(_v12) = (g_gfx_reg_cache1->_r._f12);	\
								} while (0)

#define GFX_Rd131(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,				\
					_f13,_v13)												\
								do { 										\
									...
									(_v11) = (g_gfx_reg_cache1->_r._f11);	\
									(_v12) = (g_gfx_reg_cache1->_r._f12);	\
									(_v13) = (g_gfx_reg_cache1->_r._f13);	\
								} while (0)

#define GFX_Rd141(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,				\
					_f13,_v13,_f14,_v14)									\
								do { 										\
									...
									(_v12) = (g_gfx_reg_cache1->_r._f12);	\
									(_v13) = (g_gfx_reg_cache1->_r._f13);	\
									(_v14) = (g_gfx_reg_cache1->_r._f14);	\
								}while (0)

#define GFX_Rd151(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,				\
					_f13,_v13,_f14,_v14,_f15,_v15)							\
								do { 										\
									...
									(_v13) = (g_gfx_reg_cache1->_r._f13);	\
									(_v14) = (g_gfx_reg_cache1->_r._f14);	\
									(_v15) = (g_gfx_reg_cache1->_r._f15);	\
								}while (0)

#define GFX_Rd161(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,				\
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)				\
								do { 										\
									...
									(_v14) = (g_gfx_reg_cache1->_r._f14);	\
									(_v15) = (g_gfx_reg_cache1->_r._f15);	\
									(_v16) = (g_gfx_reg_cache1->_r._f16);	\
								}while (0)



#define GFX_Wr011(_r,_f01,_v01)												\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
								} while (0)

#define GFX_Wr021(_r,_f01,_v01,_f02,_v02)									\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
									(g_gfx_reg_cache1->_r._f02) = (_v02);	\
								} while (0)

#define GFX_Wr031(_r,_f01,_v01,_f02,_v02,_f03,_v03)							\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
									(g_gfx_reg_cache1->_r._f02) = (_v02);	\
									(g_gfx_reg_cache1->_r._f03) = (_v03);	\
								} while (0)

#define GFX_Wr041(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)				\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
									(g_gfx_reg_cache1->_r._f02) = (_v02);	\
									(g_gfx_reg_cache1->_r._f03) = (_v03);	\
									(g_gfx_reg_cache1->_r._f04) = (_v04);	\
								} while (0)

#define GFX_Wr051(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05)												\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
									(g_gfx_reg_cache1->_r._f02) = (_v02);	\
									(g_gfx_reg_cache1->_r._f03) = (_v03);	\
									(g_gfx_reg_cache1->_r._f04) = (_v04);	\
									(g_gfx_reg_cache1->_r._f05) = (_v05);	\
								} while (0)

#define GFX_Wr061(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06)									\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
									(g_gfx_reg_cache1->_r._f02) = (_v02);	\
									...
									(g_gfx_reg_cache1->_r._f04) = (_v04);	\
									(g_gfx_reg_cache1->_r._f05) = (_v05);	\
									(g_gfx_reg_cache1->_r._f06) = (_v06);	\
								} while (0)

#define GFX_Wr071(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07)							\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
									(g_gfx_reg_cache1->_r._f02) = (_v02);	\
									...
									(g_gfx_reg_cache1->_r._f05) = (_v05);	\
									(g_gfx_reg_cache1->_r._f06) = (_v06);	\
									(g_gfx_reg_cache1->_r._f07) = (_v07);	\
								} while (0)

#define GFX_Wr081(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)				\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
									(g_gfx_reg_cache1->_r._f02) = (_v02);	\
									...
									(g_gfx_reg_cache1->_r._f06) = (_v06);	\
									(g_gfx_reg_cache1->_r._f07) = (_v07);	\
									(g_gfx_reg_cache1->_r._f08) = (_v08);	\
								} while (0)

#define GFX_Wr091(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09)												\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
									...
									(g_gfx_reg_cache1->_r._f07) = (_v07);	\
									(g_gfx_reg_cache1->_r._f08) = (_v08);	\
									(g_gfx_reg_cache1->_r._f09) = (_v09);	\
								} while (0)

#define GFX_Wr101(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10)									\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
									...
									(g_gfx_reg_cache1->_r._f08) = (_v08);	\
									(g_gfx_reg_cache1->_r._f09) = (_v09);	\
									(g_gfx_reg_cache1->_r._f10) = (_v10);	\
								} while (0)

#define GFX_Wr111(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11)							\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
									...
									(g_gfx_reg_cache1->_r._f09) = (_v09);	\
									(g_gfx_reg_cache1->_r._f10) = (_v10);	\
									(g_gfx_reg_cache1->_r._f11) = (_v11);	\
								} while (0)

#define GFX_Wr121(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)				\
								do { 										\
									(g_gfx_reg_cache1->_r._f01) = (_v01);	\
									...
									(g_gfx_reg_cache1->_r._f10) = (_v10);	\
									(g_gfx_reg_cache1->_r._f11) = (_v11);	\
									(g_gfx_reg_cache1->_r._f12) = (_v12);	\
								} while (0)

#define GFX_Wr131(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,				\
					_f13,_v13)												\
								do { 										\
									...
									(g_gfx_reg_cache1->_r._f11) = (_v11);	\
									(g_gfx_reg_cache1->_r._f12) = (_v12);	\
									(g_gfx_reg_cache1->_r._f13) = (_v13);	\
								} while (0)

#define GFX_Wr141(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,				\
					_f13,_v13,_f14,_v14)									\
								do { 										\
									...
									(g_gfx_reg_cache1->_r._f12) = (_v12);	\
									(g_gfx_reg_cache1->_r._f13) = (_v13);	\
									(g_gfx_reg_cache1->_r._f14) = (_v14);	\
								}while (0)

#define GFX_Wr151(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,				\
					_f13,_v13,_f14,_v14,_f15,_v15)							\
								do { 										\
									...
									(g_gfx_reg_cache1->_r._f13) = (_v13);	\
									(g_gfx_reg_cache1->_r._f14) = (_v14);	\
									(g_gfx_reg_cache1->_r._f15) = (_v15);	\
								}while (0)

#define GFX_Wr161(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,				\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,				\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,				\
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)				\
								do { 										\
