/* drivers/video/decon_ext_display/decon1_display_driver.h
 *
...
extern struct decon_lcd *decon_get_lcd_info_ext(void);
...
struct display_dt_ops {
	int (*parse_display_driver_dt_ext)(struct platform_device *np,
