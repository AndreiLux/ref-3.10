...
static void decon_ext_dump_underrun_exynos5430(struct display_driver *pdispdrv)
{
	void __iomem *regs;
	u32 val;
#ifdef CONFIG_SOC_EXYNOS543x
...
static void decon_ext_dump_registers_exynos5430(struct display_driver *pdispdrv)
{
	u32 val;
...
/* decon_ext_dump_registers - debug feature for analysing like as memory fault.
 * Dump all main registers in the DECON. */
void decon_ext_dump_registers(struct display_driver *pdispdrv)
{
#ifdef CONFIG_SOC_EXYNOS543x
	decon_ext_dump_registers_exynos5430(pdispdrv);
#endif
}

/* decon_ext_dump_underrun - dump values when underrun is occured */
void decon_ext_dump_underrun(struct display_driver *pdispdrv)
{
#ifdef CONFIG_SOC_EXYNOS543x
	decon_ext_dump_underrun_exynos5430(pdispdrv);
#endif
}

void dump_s3c_fb2_variant(struct s3c_fb_variant *p_fb_variant)
{
...
void dump_s3c_fb2_win_variant(struct s3c_fb_win_variant *p_fb_win_variant)
{
