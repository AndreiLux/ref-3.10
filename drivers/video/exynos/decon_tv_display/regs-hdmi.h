...
/* OTP registers */
#define OTP_HDCP_KEY_ENABLE		(0x1 << 5)
#define OTP_HDCP_KEY_ENABLE_MASK	(0x1 << 5)
...
#define HDMI_TG_DECON_EN		HDMI_TG_BASE(0x1E0)
...
#define HDMI_OTP_BASE_ADDRESS_H		HDMI_EFUSE_BASE(0x618)
#define HDMI_OTP_BASE_ADDRESS_L		HDMI_EFUSE_BASE(0x61C)

/* HDMI PHY registers */
#define HDMI_PHY_REG00		HDMI_PHY_BASE(0x000)
#define HDMI_PHY_REG84		HDMI_PHY_BASE(0x084)
...
/* HDMI_OTP_BASE_ADDRESS_H */
#define HDMI_OTP_OFFSET_H			(0x34)
/* HDMI_OTP_BASE_ADDRESS_L */
#define HDMI_OTP_OFFSET_L			(0x0)
