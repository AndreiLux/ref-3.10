...
#define TUNING_LUT_SCALE                 97
#define TUNING_PCT_RED                  100
#define TUNING_PCT_GREEN                100
#define TUNING_PCT_BLUE                  40
#elif defined(CONFIG_MACH_MSM8992_P1_KDDI_JP)
#define TUNING_LUT_SCALE                 58
...
/* The brightness scale value should be in [0, BRIGHTNESS_BASE_LUT].
 *
 ...
 * and BRIGHTNESS_BASE_LUT is defined as (2^9)-1 = 511
 *
 ...
 *     set the qpnp_brightness_scale to TUNING_LUT_SCALE
 */
