...
static ssize_t led_pattern_input(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t size)
{
...
static ssize_t led_pattern_blink(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t size)
{
...
static ssize_t led_pattern_onoff(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t size)
{
...
static ssize_t led_pattern_scale(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t size)
{
...
static int __init leds_pattern_init(void)
{
	...
	led_pattern_device = device_create(led_pattern_class,
			NULL, 0, NULL, LED_PATTERN_DEVICE);
